...
var $author$project$MiniLatex$Render$NoDelay = {$: 'NoDelay'};
...
var $author$project$Internal$Parser$ExpectingBeginAndRightBrace = {$: 'ExpectingBeginAndRightBrace'};
...
var $author$project$Internal$Parser$envName = A2(
	...
	A2(
		...
		$elm$parser$Parser$Advanced$symbol(
			A2($elm$parser$Parser$Advanced$Token, '\\begin{', $author$project$Internal$Parser$ExpectingBeginAndRightBrace))),
...
var $author$project$Internal$Parser$endWord = A2(
	...
	A2(
		...
		A2(
			...
			$author$project$Internal$Parser$spaces),
		$elm$parser$Parser$Advanced$symbol(
			A2($elm$parser$Parser$Advanced$Token, '\\end{', $author$project$Internal$Parser$ExpectingEndAndRightBrace))),
	A2(
		$elm$parser$Parser$Advanced$ignorer,
...
var $author$project$Internal$MathMacro$makeEntry_ = F3(
	function (name, nargs, args) {
		var n = A2(
			$elm$core$Maybe$withDefault,
			0,
		...
		return _Utils_Tuple2(
			name,
			A2($author$project$Internal$MathMacro$transform, n, args));
	});
var $author$project$Internal$MathMacro$makeEntry = function (expr) {
	if (expr.$ === 'NewCommand') {
		var name = expr.a;
		var nargs = expr.b;
		var args = expr.c;
		return $elm$core$Maybe$Just(
			A3($author$project$Internal$MathMacro$makeEntry_, name, nargs, args));
	} else {
		return $elm$core$Maybe$Nothing;
	}
};
...
var $author$project$Internal$MathMacro$newMacroName = A2(
	...
	A2(
		...
		A2(
			...
			$elm$parser$Parser$Advanced$symbol(
				A2($elm$parser$Parser$Advanced$Token, '}', $author$project$Internal$MathMacro$ExpectingRightBrace)))));
var $author$project$Internal$MathMacro$newCommand = A2(
	$elm$parser$Parser$Advanced$keeper,
	A2(
		$elm$parser$Parser$Advanced$keeper,
		A2(
...
var $author$project$Internal$Parser$ExpectingEndWord = {$: 'ExpectingEndWord'};
...
var $author$project$Internal$Parser$ExpectingSpace = {$: 'ExpectingSpace'};
	...
	A2(
		...
		A2(
			...
			A2(
				...
				$elm$parser$Parser$Advanced$symbol(
					A2($elm$parser$Parser$Advanced$Token, ' ', $author$project$Internal$Parser$ExpectingSpace))),
			$author$project$Internal$Parser$spaces),
		A2(
			$elm$parser$Parser$Advanced$ignorer,
			$author$project$Internal$Parser$itemList(
		...
		return A2(
			...
			A2(
				...
				A2(
					...
					$elm$parser$Parser$Advanced$symbol(
						A2($elm$parser$Parser$Advanced$Token, endWoord, $author$project$Internal$Parser$ExpectingEndWord))),
				$author$project$Internal$Parser$ws));
	});
...
var $author$project$Internal$Parser$environmentOfType = function (envType) {
	...
	var envKind = A2(
		...
		envType,
		_List_fromArray(
			['equation', 'align', 'eqnarray', 'verbatim', 'mathmacro', 'textmacro', 'listing', 'verse'])) ? 'passThrough' : envType;
...
var $author$project$Internal$Accumulator$parseReducer = F2(
	function (inputString, _v0) {
		...
		var inputList = _v0.b;
		var parsedInput = $author$project$Internal$Parser$parse(inputString);
		var newLatexState = A2($author$project$Internal$Accumulator$latexStateReducer, parsedInput, latexState);
		return _Utils_Tuple2(
			newLatexState,
			_Utils_ap(
				inputList,
...
var $author$project$Internal$Accumulator$renderReducer = F3(
	function (renderer, listLatexExpression, _v0) {
		var state = _v0.a;
		var inputList = _v0.b;
		var newState = A2($author$project$Internal$Accumulator$latexStateReducer, listLatexExpression, state);
...
var $author$project$Internal$Render$mathTextDelayed = function (content) {
	return A3(
		$elm$html$Html$node,
		'math-text-delayed',
		_List_fromArray(
...
var $author$project$Internal$Render$displayMathText = F3(
	function (latexState, mathJaxRenderOption, str) {
		var str2 = $elm$core$String$trim(str);
		if (mathJaxRenderOption.$ === 'Delay') {
			return $author$project$Internal$Render$mathTextDelayed(str2);
		} else {
			return A2($author$project$Internal$Render$mathText, 'display', str2);
		}
	});
...
var $author$project$Internal$Render$inlineMathText = F3(
	function (latexState, mathJaxRenderOption, str_) {
		...
		if (mathJaxRenderOption.$ === 'Delay') {
			return $author$project$Internal$Render$mathTextDelayed(
				$elm$core$String$trim(str));
		} else {
			return A2(
...
var $author$project$Internal$Render$renderAlignEnvironment = F4(
	function (mathJaxRenderOption, source, latexState, body) {
		...
		var innerContents = function () {
			if (body.$ === 'LXString') {
				...
				return 'Parser error in render align environment';
			}
		}();
		var eqno = A2($author$project$Internal$LatexState$getCounter, 'eqno', latexState);
		var addendum = (eqno > 0) ? ((s1 > 0) ? ('\\tag{' + ($elm$core$String$fromInt(s1) + ('.' + ($elm$core$String$fromInt(eqno) + '}')))) : ('\\tag{' + ($elm$core$String$fromInt(eqno) + '}'))) : '';
		var content = '\n\\begin{align*}\n' + (addendum + (innerContents + '\n\\end{align*}\n'));
		return A3($author$project$Internal$Render$displayMathText, latexState, mathJaxRenderOption, content);
	});
...
var $author$project$Internal$Render$renderEqnArray = F4(
	function (mathJaxRenderOption, source, latexState, body) {
		return A3(
...
var $author$project$Internal$Render$renderEquationEnvironment = F4(
	function (mathJaxRenderOption, source, latexState, body) {
		var s1 = A2($author$project$Internal$LatexState$getCounter, 's1', latexState);
		var eqno = A2($author$project$Internal$LatexState$getCounter, 'eqno', latexState);
		...
		var addendum = (eqno > 0) ? ((s1 > 0) ? ('\\tag{' + ($elm$core$String$fromInt(s1) + ('.' + ($elm$core$String$fromInt(eqno) + '}')))) : ('\\tag{' + ($elm$core$String$fromInt(eqno) + '}'))) : '';
		return A3($author$project$Internal$Render$displayMathText, latexState, mathJaxRenderOption, '\\begin{equation}' + (contents + (addendum + '\\end{equation}')));
	});
...
var $author$project$Internal$ErrorMessages2$getLines = F2(
	function (lineNumber, str) {
		return A2(
			$elm$core$List$filter,
			function (line) {
			...
			A2(
				$elm$core$List$map,
				function (i) {
					return A2($author$project$Internal$ErrorMessages2$getLine, i, str);
				},
...
var $author$project$Internal$ErrorMessages2$renderErrors = F2(
	function (source, errs) {
		...
		if (_v0.$ === 'Nothing') {
			...
			return {
				errorText: A2($author$project$Internal$ErrorMessages2$getLines, firstErr.row, source),
				explanation: $author$project$Internal$ErrorMessages2$displayExpected(firstErr.problem),
...
var $author$project$Internal$Render$renderMacros = F4(
	function (mathJaxRenderOption, source, latexState, body) {
		return A3(
			$author$project$Internal$Render$displayMathText,
			latexState,
...
var $author$project$Internal$Render$renderMathMacros = F4(
	function (mathJaxRenderOption, source, latexState, body) {
		return A2($elm$html$Html$div, _List_Nil, _List_Nil);
	});
...
var $author$project$Internal$Render$renderSection = F3(
	function (_v0, latexState, args) {
		var sectionName = A3($author$project$Internal$RenderToString$renderArg, 0, latexState, args);
		var s1 = A2($author$project$Internal$LatexState$getCounter, 's1', latexState);
		var ref = A2($author$project$Internal$Render$idPhrase, 'section', sectionName);
...
var $author$project$Internal$Render$renderSubSubsection = F3(
	function (_v0, latexState, args) {
		...
		var s1 = A2($author$project$Internal$LatexState$getCounter, 's1', latexState);
		var ref = A2($author$project$Internal$Render$idPhrase, 'subsubsection', sectionName);
...
var $author$project$Internal$Render$renderSubheading = F3(
	function (_v0, latexState, args) {
		var title = A3($author$project$Internal$RenderToString$renderArg, 0, latexState, args);
		return A2(
			$elm$html$Html$p,
			_List_fromArray(
				[
...
var $author$project$Internal$Render$renderSubsection = F3(
	function (_v0, latexState, args) {
		...
		var s2 = A2($author$project$Internal$LatexState$getCounter, 's2', latexState);
		var s1 = A2($author$project$Internal$LatexState$getCounter, 's1', latexState);
		var ref = A2($author$project$Internal$Render$idPhrase, 'subsection', sectionName);
...
var $author$project$Internal$Render$renderSvg = F4(
	function (mathJaxRenderOption, source, latexState, body) {
...
var $author$project$Internal$Render$renderTextMacros = F4(
	function (mathJaxRenderOption, source, latexState, body) {
		return A2($elm$html$Html$div, _List_Nil, _List_Nil);
	});
...
var $author$project$Internal$Render$renderUseForWeb = F4(
	function (mathJaxRenderOption, source, latexState, body) {
		return A3(
			$author$project$Internal$Render$displayMathText,
			latexState,
...
var $author$project$Internal$Render$environmentRenderer = F3(
	function (mathJaxRenderOption, source, name) {
		...
		if (_v8.$ === 'Just') {
			...
			return A3($author$project$Internal$Render$renderDefaultEnvironment, mathJaxRenderOption, source, name);
		}
	});
var $author$project$Internal$Render$render = F4(
	function (mathJaxRenderOption, source, latexState, latexExpression) {
		switch (latexExpression.$) {
			...
			case 'Macro':
				...
				var optArgs = latexExpression.b;
				var args = latexExpression.c;
				return A6($author$project$Internal$Render$renderMacro, mathJaxRenderOption, source, latexState, name, optArgs, args);
			case 'SMacro':
				var name = latexExpression.a;
				var optArgs = latexExpression.b;
				var args = latexExpression.c;
				var le = latexExpression.d;
				return A7($author$project$Internal$Render$renderSMacro, mathJaxRenderOption, source, latexState, name, optArgs, args, le);
			case 'Item':
				var level = latexExpression.a;
				var latexExpr = latexExpression.b;
				return A5($author$project$Internal$Render$renderItem, mathJaxRenderOption, source, latexState, level, latexExpr);
			case 'InlineMath':
				var str = latexExpression.a;
				return A2(
					$elm$html$Html$span,
			...
			case 'Environment':
				...
				var args = latexExpression.b;
				var body = latexExpression.c;
				return A6($author$project$Internal$Render$renderEnvironment, mathJaxRenderOption, source, latexState, name, args, body);
			case 'LatexList':
				var latexList = latexExpression.a;
				return A4($author$project$Internal$Render$renderLatexList, mathJaxRenderOption, source, latexState, latexList);
			case 'LXString':
				var str = latexExpression.a;
...
var $author$project$Internal$Render$renderArg = F5(
...
var $author$project$Internal$Render$renderArgList = F4(
	function (mathJaxRenderOption, source, latexState, args) {
		return A2(
			$elm$core$List$map,
			A3($author$project$Internal$Render$render, mathJaxRenderOption, source, latexState),
			args);
	});
var $author$project$Internal$Render$renderBackslash = F4(
	function (mathJaxRenderOption, source, latexState, args) {
		return A2(
			$elm$html$Html$span,
			_List_Nil,
			_List_fromArray(
				[
					$elm$html$Html$text('\\'),
					A5($author$project$Internal$Render$renderArg, mathJaxRenderOption, source, 0, latexState, args)
				]));
	});
var $author$project$Internal$Render$renderBibItem = F6(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							A4($author$project$Internal$Render$render, mathJaxRenderOption, source, latexState, body)
						]))
				]));
	});
var $author$project$Internal$Render$renderCell = F4(
		...
		switch (cell.$) {
			...
			case 'InlineMath':
				...
				return A2(
					...
					_List_fromArray(
						[
							A3($author$project$Internal$Render$inlineMathText, latexState, mathJaxRenderOption, s)
						]));
			case 'Macro':
				var s = cell.a;
				var x = cell.b;
				...
				return A2(
					...
					_List_fromArray(
						[
							A6($author$project$Internal$Render$renderMacro, mathJaxRenderOption, source, $author$project$Internal$LatexState$emptyLatexState, s, x, y)
						]));
			default:
				return A2($elm$html$Html$td, _List_Nil, _List_Nil);
		}
	});
var $author$project$Internal$Render$renderCenterEnvironment = F4(
	function (mathJaxRenderOption, source, latexState, body) {
		var r = A4($author$project$Internal$Render$render, mathJaxRenderOption, source, latexState, body);
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
...
var $author$project$Internal$Render$renderCode = F4(
	function (mathJaxRenderOption, source, latexState, args) {
		var arg = A5($author$project$Internal$Render$renderArg, mathJaxRenderOption, source, 0, latexState, args);
		return A2(
			$elm$html$Html$code,
			_List_Nil,
			_List_fromArray(
...
var $author$project$Internal$Render$renderDefItemEnvironment = F5(
...
var $author$project$Internal$Render$renderDefaultEnvironment = F6(
	function (mathJaxRenderOption, source, name, latexState, args, body) {
		return A2($elm$core$List$member, name, $author$project$Internal$Render$theoremLikeEnvironments) ? A6($author$project$Internal$Render$renderTheoremLikeEnvironment, mathJaxRenderOption, source, latexState, name, args, body) : A6(
...
var $author$project$Internal$Render$renderDefaultEnvironment2 = F6(
...
var $author$project$Internal$Render$renderEnumerate = F4(
	function (mathJaxRenderOption, source, latexState, body) {
		return A2(
			$elm$html$Html$ol,
			_List_fromArray(
...
var $author$project$Internal$Render$renderEnvironment = F6(
	function (mathJaxRenderOption, source, latexState, name, args, body) {
		return A6($author$project$Internal$Render$environmentRenderer, mathJaxRenderOption, source, name, latexState, args, body);
	});
var $author$project$Internal$Render$renderIndentEnvironment = F4(
	function (mathJaxRenderOption, source, latexState, body) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
...
var $author$project$Internal$Render$renderItalic = F4(
	function (mathJaxRenderOption, source, latexState, args) {
		return A2(
			$elm$html$Html$i,
			_List_Nil,
...
var $author$project$Internal$Render$renderItem = F5(
	function (mathJaxRenderOption, source, latexState, level, latexExpression) {
		return A2(
			...
			_List_fromArray(
				[
					A4($author$project$Internal$Render$render, mathJaxRenderOption, source, latexState, latexExpression)
				]));
	});
var $author$project$Internal$Render$renderItemize = F4(
	function (mathJaxRenderOption, source, latexState, body) {
		return A2(
			$elm$html$Html$ul,
			_List_fromArray(
...
var $author$project$Internal$Render$renderLatexList = F4(
...
var $author$project$Internal$Render$renderMacro = F6(
	function (mathJaxRenderOption, source, latexState, name, optArgs, args) {
		...
		if (_v3.$ === 'Just') {
			...
			if (_v4.$ === 'Nothing') {
				return A6($author$project$Internal$Render$reproduceMacro, mathJaxRenderOption, source, name, latexState, optArgs, args);
			} else {
				...
				return A4($author$project$Internal$Render$render, mathJaxRenderOption, source, latexState, expr);
			}
		}
	});
var $author$project$Internal$Render$renderQuotation = F4(
	function (mathJaxRenderOption, source, latexState, body) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
...
var $author$project$Internal$Render$renderRow = F4(
	function (mathJaxRenderOption, source, latexState, row) {
		if (row.$ === 'LatexList') {
			...
			return A2(
				...
				A2(
					$elm$core$List$map,
					A3($author$project$Internal$Render$renderCell, mathJaxRenderOption, source, latexState),
					row_));
		} else {
			return A2($elm$html$Html$tr, _List_Nil, _List_Nil);
		}
	});
var $author$project$Internal$Render$renderSMacro = F7(
	function (mathJaxRenderOption, source, latexState, name, optArgs, args, le) {
		...
		if (_v1.$ === 'Just') {
			...
			return A7($author$project$Internal$Render$reproduceSMacro, mathJaxRenderOption, source, name, latexState, optArgs, args, le);
		}
	});
var $author$project$Internal$Render$renderStrong = F4(
	function (mathJaxRenderOption, source, latexState, args) {
		return A2(
			$elm$html$Html$strong,
			_List_Nil,
...
var $author$project$Internal$Render$renderTableBody = F4(
	function (mathJaxRenderOption, source, latexState, body) {
		if (body.$ === 'LatexList') {
			var body_ = body.a;
			return A2(
				...
				A2(
					$elm$core$List$map,
					A3($author$project$Internal$Render$renderRow, mathJaxRenderOption, source, latexState),
					body_));
		} else {
			return A2($elm$html$Html$tbody, _List_Nil, _List_Nil);
		}
	});
var $author$project$Internal$Render$renderTabular = F4(
	function (mathJaxRenderOption, source, latexState, body) {
		return A2(
			$elm$html$Html$table,
			_List_fromArray(
			...
			_List_fromArray(
				[
					A4($author$project$Internal$Render$renderTableBody, mathJaxRenderOption, source, latexState, body)
				]));
	});
var $author$project$Internal$Render$renderTexArg = F4(
	function (mathJaxRenderOption, source, latexState, args) {
		return A2(
			$elm$html$Html$span,
			_List_Nil,
...
var $author$project$Internal$Render$renderTheBibliography = F4(
	function (mathJaxRenderOption, source, latexState, body) {
		return A2(
			$elm$html$Html$div,
			_List_Nil,
...
var $author$project$Internal$Render$renderTheoremLikeEnvironment = F6(
	function (mathJaxRenderOption, source, latexState, name, args, body) {
		var tno = A2($author$project$Internal$LatexState$getCounter, 'tno', latexState);
		var s1 = A2($author$project$Internal$LatexState$getCounter, 's1', latexState);
		var tnoString = (s1 > 0) ? (' ' + ($elm$core$String$fromInt(s1) + ('.' + $elm$core$String$fromInt(tno)))) : (' ' + $elm$core$String$fromInt(tno));
...
var $author$project$Internal$Render$reproduceMacro = F6(
	function (mathJaxRenderOption, source, name, latexState, optArgs, args) {
		var renderedArgs = A2(
			$elm$core$List$map,
			$author$project$Internal$Render$enclose,
			A4($author$project$Internal$Render$renderArgList, mathJaxRenderOption, source, latexState, args));
		return A2(
			$elm$html$Html$span,
			_List_fromArray(
				[
...
var $author$project$Internal$Render$reproduceSMacro = F7(
	function (mathJaxRenderOption, source, name, latexState, optArgs, args, le) {
		var renderedOptArgs = A2(
			$elm$core$List$map,
			$author$project$Internal$Render$enclose,
			A4($author$project$Internal$Render$renderArgList, mathJaxRenderOption, source, latexState, optArgs));
		var renderedLe = $author$project$Internal$Render$enclose(
			A4($author$project$Internal$Render$render, mathJaxRenderOption, source, latexState, le));
		var renderedArgs = A2(
			$elm$core$List$map,
			$author$project$Internal$Render$enclose,
			A4($author$project$Internal$Render$renderArgList, mathJaxRenderOption, source, latexState, args));
	...
	return $elm$core$Dict$fromList(
		_List_fromArray(
			[
				...
				F5(
					function (d, s, x, a, y) {
						return A4($author$project$Internal$Render$renderAlignEnvironment, d, s, x, y);
					})),
				_Utils_Tuple2(
				'center',
				F5(
					function (d, s, x, a, y) {
						return A4($author$project$Internal$Render$renderCenterEnvironment, d, s, x, y);
					})),
				_Utils_Tuple2(
				'comment',
				F5(
				...
				F5(
					function (d, s, x, a, y) {
						return A5($author$project$Internal$Render$renderDefItemEnvironment, d, s, x, a, y);
					})),
				_Utils_Tuple2(
				'enumerate',
				F5(
					function (d, s, x, a, y) {
						return A4($author$project$Internal$Render$renderEnumerate, d, s, x, y);
					})),
				_Utils_Tuple2(
				'eqnarray',
				F5(
					function (d, s, x, a, y) {
						return A4($author$project$Internal$Render$renderEqnArray, d, s, x, y);
					})),
				_Utils_Tuple2(
				'equation',
				F5(
					function (d, s, x, a, y) {
						return A4($author$project$Internal$Render$renderEquationEnvironment, d, s, x, y);
					})),
				_Utils_Tuple2(
				'indent',
				F5(
					function (d, s, x, a, y) {
						return A4($author$project$Internal$Render$renderIndentEnvironment, d, s, x, y);
					})),
				_Utils_Tuple2(
				'itemize',
				F5(
					function (d, s, x, a, y) {
						return A4($author$project$Internal$Render$renderItemize, d, s, x, y);
					})),
				_Utils_Tuple2(
				'listing',
				F5(
				...
				F5(
					function (d, s, x, a, y) {
						return A4($author$project$Internal$Render$renderMacros, d, s, x, y);
					})),
				_Utils_Tuple2(
				'maskforweb',
				F5(
				...
				F5(
					function (d, s, x, a, y) {
						return A4($author$project$Internal$Render$renderQuotation, d, s, x, y);
					})),
				_Utils_Tuple2(
				'tabular',
				F5(
					function (d, s, x, a, y) {
						return A4($author$project$Internal$Render$renderTabular, d, s, x, y);
					})),
				_Utils_Tuple2(
				'thebibliography',
				F5(
					function (d, s, x, a, y) {
						return A4($author$project$Internal$Render$renderTheBibliography, d, s, x, y);
					})),
				_Utils_Tuple2(
				'useforweb',
				F5(
					function (d, s, x, a, y) {
						return A4($author$project$Internal$Render$renderUseForWeb, d, s, x, y);
					})),
				_Utils_Tuple2(
				'verbatim',
				F5(
				...
				F5(
					function (d, s, x, a, y) {
						return A4($author$project$Internal$Render$renderMathMacros, d, s, x, y);
					})),
				_Utils_Tuple2(
				'textmacro',
				F5(
					function (d, s, x, a, y) {
						return A4($author$project$Internal$Render$renderTextMacros, d, s, x, y);
					})),
				_Utils_Tuple2(
				'svg',
				F5(
					function (d, s, x, a, y) {
						return A4($author$project$Internal$Render$renderSvg, d, s, x, y);
					}))
			]));
}
	...
	return $elm$core$Dict$fromList(
		_List_fromArray(
			[
				...
				F5(
					function (d, s, x, y, z) {
						return A4($author$project$Internal$Render$renderCode, d, s, x, z);
					})),
				_Utils_Tuple2(
				'ellie',
				F5(
				...
				F5(
					function (d, s, x, y, z) {
						return A4($author$project$Internal$Render$renderItalic, d, s, x, z);
					})),
				_Utils_Tuple2(
				'eqref',
				F5(
				...
				F5(
					function (d, s, x, y, z) {
						return A4($author$project$Internal$Render$renderBackslash, d, s, x, z);
					})),
				_Utils_Tuple2(
				'texarg',
				F5(
					function (d, s, x, y, z) {
						return A4($author$project$Internal$Render$renderTexArg, d, s, x, z);
					})),
				_Utils_Tuple2(
				'ref',
				F5(
				...
				F5(
					function (d, s, x, y, z) {
						return A4($author$project$Internal$Render$renderStrong, d, s, x, z);
					}))
			]));
}
	...
	return $elm$core$Dict$fromList(
		_List_fromArray(
			[
				...
				F6(
					function (mathJaxRenderOption, source, latexState, optArgs, args, body) {
						return A6($author$project$Internal$Render$renderBibItem, mathJaxRenderOption, source, latexState, optArgs, args, body);
					}))
			]));
}
try {
...
var $author$project$MiniLatex$render = F3(
	function (selectedId, mathJaxRenderOption, source) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
			...
			A2(
				...
				A4(
					...
					A2($author$project$Internal$Render$renderLatexList, mathJaxRenderOption, source),
					$author$project$MiniLatex$emptyLatexState,
					source)));
	});
var $author$project$Main$sourceText = '\nPythagoras said: $a^2 + b^2 = c^2$\n\nWe learned this in Calculus class:\n\n$$\n\\int_0^1 x^n dx \\frac{1}{n+1}\n$$\n\n';
			...
			[
				...
				_List_fromArray(
					[
						...
						A3($author$project$MiniLatex$render, 'noSelectedId', $author$project$MiniLatex$Render$NoDelay, $author$project$Main$sourceText))
					]))
			]));
};
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"args":[],"tags":{"NoOp":[],"LatexMsg":["MiniLatex.Edit.LaTeXMsg"]}},"MiniLatex.Edit.LaTeXMsg":{"args":[],"tags":{"IDClicked":["String.String"]}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});}(this));