...
var $author$project$Main$init = function (flags) {
	return _Utils_Tuple2(
		{count: 0, docIdentifier: 'examples', sourceText: $author$project$Main$initialText, windowHeight: flags.height, windowWidth: flags.width},
		A2(
			$elm$core$Task$perform,
...
var $author$project$L1$Parser$TextCursor$NormalScan = {$: 'NormalScan'};
var $author$project$L1$Parser$TextCursor$init = F2(
	function (generation, source) {
		return {
			...
			parsed: _List_Nil,
			scanPoint: 0,
			scannerType: $author$project$L1$Parser$TextCursor$NormalScan,
			source: source,
			sourceLength: $elm$core$String$length(source),
			stack: _List_Nil,
			verbatimPrefix: $elm$core$Maybe$Nothing
		};
	});
...
var $author$project$L1$Parser$TextCursor$add = F3(
	function (parse_, str, tc) {
		return _Utils_eq(tc.stack, _List_Nil) ? _Utils_update(
			tc,
			{
				complete: A2(
					$elm$core$List$cons,
					parse_(str),
					_Utils_ap(tc.parsed, tc.complete)),
				count: tc.count + 1,
				parsed: _List_Nil,
					...
					$author$project$L1$Parser$Stack$TextItem(
						{
							content: str,
							position: {
								end: $elm$core$String$length(str),
								start: 0
							}
						}),
					tc.stack)
...
var $author$project$L1$Parser$Config$AllDelimiters = {$: 'AllDelimiters'};
var $author$project$L1$Parser$Config$InteriorDelimiters = {$: 'InteriorDelimiters'};
var $author$project$L1$Parser$Config$Anywhere = {$: 'Anywhere'};
...
var $author$project$L1$Parser$Config$configure = function (configDef) {
	...
	var interiorEndSymbols = $elm_community$maybe_extra$Maybe$Extra$values(
		A2(
			...
			A2(
				$elm$core$List$filter,
				function (e) {
					return _Utils_eq(e.markPosition, $author$project$L1$Parser$Config$Anywhere);
				},
				configDef)));
	...
	return {
		...
		endChars: $elm_community$maybe_extra$Maybe$Extra$values(endChars),
		endSymbols: $elm_community$maybe_extra$Maybe$Extra$values(
			A2(
				$elm$core$List$map,
				function ($) {
					return $.endSymbol;
		...
		expectationsDict: $elm$core$Dict$fromList(
			A2(
				$elm$core$List$map,
				function (e) {
					return _Utils_Tuple2(e.beginSymbol, e);
				},
				configDef)),
		...
		interiorEndChars: $elm_community$maybe_extra$Maybe$Extra$values(interiorEndChars),
		interiorEndSymbols: interiorEndSymbols,
		verbatimChars: verbatimChars
	};
};
var $author$project$L1$Parser$Config$AtBeginning = {$: 'AtBeginning'};
var $author$project$L1$Parser$Config$CodeType = {$: 'CodeType'};
var $author$project$L1$Parser$Config$ElementType = {$: 'ElementType'};
var $author$project$L1$Parser$Config$InlineMathType = {$: 'InlineMathType'};
var $author$project$L1$Parser$Config$QuotedType = {$: 'QuotedType'};
var $author$project$L1$Parser$Configuration$expectations = _List_fromArray(
	[
		{
		beginSymbol: '[',
		endSymbol: $elm$core$Maybe$Just(']'),
		etype: $author$project$L1$Parser$Config$ElementType,
		isVerbatim: false,
		markPosition: $author$project$L1$Parser$Config$Anywhere
	},
		{
		beginSymbol: '`',
		endSymbol: $elm$core$Maybe$Just('`'),
		etype: $author$project$L1$Parser$Config$CodeType,
		isVerbatim: true,
		markPosition: $author$project$L1$Parser$Config$Anywhere
	},
		{
		beginSymbol: '$',
		endSymbol: $elm$core$Maybe$Just('$'),
		etype: $author$project$L1$Parser$Config$InlineMathType,
		isVerbatim: true,
		markPosition: $author$project$L1$Parser$Config$Anywhere
	},
		{beginSymbol: '#', endSymbol: $elm$core$Maybe$Nothing, etype: $author$project$L1$Parser$Config$ElementType, isVerbatim: false, markPosition: $author$project$L1$Parser$Config$AtBeginning},
		{beginSymbol: '##', endSymbol: $elm$core$Maybe$Nothing, etype: $author$project$L1$Parser$Config$ElementType, isVerbatim: false, markPosition: $author$project$L1$Parser$Config$AtBeginning},
		{beginSymbol: '###', endSymbol: $elm$core$Maybe$Nothing, etype: $author$project$L1$Parser$Config$ElementType, isVerbatim: false, markPosition: $author$project$L1$Parser$Config$AtBeginning},
		{beginSymbol: '####', endSymbol: $elm$core$Maybe$Nothing, etype: $author$project$L1$Parser$Config$ElementType, isVerbatim: false, markPosition: $author$project$L1$Parser$Config$AtBeginning},
		{beginSymbol: ':', endSymbol: $elm$core$Maybe$Nothing, etype: $author$project$L1$Parser$Config$ElementType, isVerbatim: false, markPosition: $author$project$L1$Parser$Config$AtBeginning},
		...
		beginSymbol: '\"',
		endSymbol: $elm$core$Maybe$Just('\"'),
		etype: $author$project$L1$Parser$Config$QuotedType,
		isVerbatim: true,
		markPosition: $author$project$L1$Parser$Config$Anywhere
	},
		{beginSymbol: '||', endSymbol: $elm$core$Maybe$Nothing, etype: $author$project$L1$Parser$Config$CodeType, isVerbatim: true, markPosition: $author$project$L1$Parser$Config$AtBeginning},
		{beginSymbol: '|', endSymbol: $elm$core$Maybe$Nothing, etype: $author$project$L1$Parser$Config$ElementType, isVerbatim: false, markPosition: $author$project$L1$Parser$Config$AtBeginning}
	]);
...
var $author$project$L1$Parser$Config$notDelimiter = F3(
	function (config, delimiterTypes, c) {
		if (delimiterTypes.$ === 'AllDelimiters') {
			...
			return !A2($elm$core$List$member, c, config.interiorDelimiters);
		}
	});
...
var $author$project$L1$Parser$TextCursor$advanceNormal = F3(
	function (config, position, str) {
		var delimiterTypes = A2(
			...
			_List_fromArray(
				['|', ':'])) ? $author$project$L1$Parser$Config$AllDelimiters : $author$project$L1$Parser$Config$InteriorDelimiters;
		var _v0 = A2(
...
var $author$project$L1$Parser$TextCursor$advance = F2(
	function (cursor, textToProcess) {
		...
		if (_v0.$ === 'NormalScan') {
			return A3($author$project$L1$Parser$TextCursor$advanceNormal, $author$project$L1$Parser$Configuration$configuration, cursor.scanPoint, textToProcess);
		} else {
			var c = _v0.a;
			return A2($author$project$L1$Parser$TextCursor$advanceVerbatim, c, textToProcess);
		}
	});
var $author$project$L1$Parser$Branch$ADD = {$: 'ADD'};
var $author$project$L1$Parser$Branch$COMMIT = {$: 'COMMIT'};
var $author$project$L1$Parser$Branch$POP = {$: 'POP'};
var $author$project$L1$Parser$Branch$PUSH = function (a) {
	return {$: 'PUSH', a: a};
};
var $author$project$L1$Parser$Branch$SHORTCIRCUIT = {$: 'SHORTCIRCUIT'};
var $author$project$L1$Parser$Stack$beginSymbol = function (si) {
	switch (si.$) {
		case 'Expect':
			var data = si.a;
			return data.expect.beginSymbol;
		case 'TextItem':
			var item = si.a;
			return '111';
		default:
			var content = si.a.content;
			return content;
	}
};
...
var $author$project$L1$Parser$Stack$mark = function (stackItem) {
	switch (stackItem.$) {
		...
		case 'TextItem':
			...
			return '000';
		default:
			var content = stackItem.a.content;
			return content;
	}
};
...
var $author$project$L1$Parser$Branch$canPop = F3(
	function (configuration_, tc, prefix) {
		return A2($author$project$L1$Parser$Stack$isReducibleWith, prefix, tc.stack);
	});
...
var $author$project$L1$Parser$Branch$canPush = F3(
	function (configuration_, tc, prefix) {
		return ($author$project$L1$Parser$Config$isVerbatimSymbol(prefix) && A2($author$project$L1$Parser$Branch$prefixMatchesTopOfStack, prefix, tc.stack)) ? {isMatch: true, prefix: prefix, value: true} : A3($author$project$L1$Parser$Branch$canPushNonVerbatim, configuration_, tc, prefix);
	});
var $author$project$L1$Parser$Branch$canPushNonVerbatim = F3(
	function (configuration_, tc, prefix) {
		return (prefix === '') ? {isMatch: false, prefix: '', value: false} : ((A3($author$project$L1$Parser$Config$isBeginSymbol, configuration_, tc.scanPoint, prefix) || (A3($author$project$L1$Parser$Config$isEndSymbol, configuration_, tc.scanPoint, prefix) && (A2($author$project$L1$Parser$Stack$isNotReducibleWith, prefix, tc.stack) && (!_Utils_eq(tc.stack, _List_Nil))))) ? {isMatch: false, prefix: prefix, value: true} : A3(
...
var $author$project$L1$Parser$Branch$branch = F4(
	function (configuration_, tc, firstChar, prefix_) {
		...
		return A2(
			...
			prefix,
			_List_fromArray(
				['|', '||', ':', '#', '##', '###', '####', '```'])) ? $author$project$L1$Parser$Branch$SHORTCIRCUIT : (($author$project$L1$Parser$Stack$isReducible(tc.stack) && _Utils_eq(
			A2(
				$elm$core$Maybe$map,
			...
			$elm$core$Maybe$Just(true))) ? $author$project$L1$Parser$Branch$POP : (A3($author$project$L1$Parser$Config$notDelimiter, $author$project$L1$Parser$Configuration$configuration, $author$project$L1$Parser$Config$AllDelimiters, firstChar) ? $author$project$L1$Parser$Branch$ADD : (value ? $author$project$L1$Parser$Branch$PUSH(
			{isMatch: isMatch, prefix: prefix}) : (A3($author$project$L1$Parser$Branch$canPop, configuration_, tc, prefix_) ? $author$project$L1$Parser$Branch$POP : $author$project$L1$Parser$Branch$COMMIT))));
	});
...
var $author$project$L1$Parser$Stack$show = function (item) {
	switch (item.$) {
		case 'Expect':
			var data = item.a;
			return _Utils_ap(data.expect.beginSymbol, data.content);
		case 'TextItem':
			var data = item.a;
			return data.content;
		default:
			var content = item.a.content;
			return content;
	}
};
...
var $author$project$L1$Parser$TextCursor$resolveError = function (tc) {
	var scanPointString = A2($author$project$L1$Library$Utility$characterAt, tc.scanPoint, tc.source);
	var _v0 = function () {
		if (scanPointString === ']') {
			return _Utils_Tuple2(tc.scanPoint, scanPointString);
		} else {
			var maybeBottomOfStack = A2(
				$elm$core$Maybe$map,
				$elm$core$Tuple$first,
				$elm_community$list_extra$List$Extra$unconsLast(tc.stack));
	...
	return _Utils_update(
		tc,
		{
			complete: _Utils_ap(
				tc.parsed,
				A2($elm$core$List$cons, errorElement, tc.complete)),
			count: 1 + tc.count,
			parsed: _List_Nil,
			scanPoint: errorPosition + $elm$core$String$length(badStackItemSymbol),
			scannerType: $author$project$L1$Parser$TextCursor$NormalScan,
			stack: _List_Nil
		});
};
var $author$project$L1$Parser$TextCursor$commit = F2(
	function (parse, tc) {
		return (_Utils_eq(tc.stack, _List_Nil) && (_Utils_cmp(tc.scanPoint, tc.sourceLength) > -1)) ? $author$project$L1$Parser$TextCursor$finishUp(tc) : (($author$project$L1$Parser$Stack$isStrictlyReducible(tc.stack) && (_Utils_cmp(tc.scanPoint, tc.sourceLength) > -1)) ? A2($author$project$L1$Parser$TextCursor$finishUpWithReducibleStack, parse, tc) : $author$project$L1$Parser$TextCursor$resolveError(tc));
	});
...
var $author$project$L1$Parser$TextCursor$pop = F3(
	function (parse, prefix, cursor) {
		...
		if (_v0.$ === 'Nothing') {
			return _Utils_update(
				cursor,
				{count: cursor.count + 1, scanPoint: cursor.scanPoint + 1, scannerType: $author$project$L1$Parser$TextCursor$NormalScan});
		} else {
			var stackTop_ = _v0.a;
			var data = _Utils_ap(
	...
	function (parser, prefix, cursor) {
		return $author$project$L1$Library$ParserTools$Loop(
			A3(
				...
				_Utils_update(
					cursor,
					{message: 'POP', scannerType: $author$project$L1$Parser$TextCursor$NormalScan})));
	});
	...
	function (prefixData, proto, tc) {
				...
				return (newContent === '') ? A2(
					...
					A2(
						...
						$author$project$L1$Parser$Stack$EndMark(
							{
								content: prefix_,
								position: {end: tc.scanPoint + 1, start: tc.scanPoint}
							}),
						tc.stack));
			}
		}();
		var _v0 = function () {
			...
			if (_v1.a) {
				...
				return _Utils_Tuple2(tc.verbatimPrefix, tc.scannerType);
			}
		}();
		...
		return _Utils_update(
			tc,
			{count: tc.count + 1, scanPoint: tc.scanPoint + scanPointIncrement, scannerType: scannerType, stack: newStack, verbatimPrefix: verbatimPrefix});
	});
	...
	function (cursor, prefixData) {
		...
		if (_v0.$ === 'Nothing') {
			...
			var scannerType = A2(
				...
				expectation.etype,
				_List_fromArray(
					[$author$project$L1$Parser$Config$CodeType, $author$project$L1$Parser$Config$InlineMathType, $author$project$L1$Parser$Config$QuotedType])) ? $author$project$L1$Parser$TextCursor$VerbatimScan(
				A2(
					$elm$core$Maybe$withDefault,
					_Utils_chr('0'),
					$author$project$L1$Parser$Config$firstChar(expectation.beginSymbol))) : $author$project$L1$Parser$TextCursor$NormalScan;
			return $author$project$L1$Library$ParserTools$Loop(
				A3(
					$author$project$L1$Parser$TextCursor$push,
					prefixData,
...
var $author$project$L1$Parser$Handle$doublePipe = function (tc) {
	...
	if (_v0.$ === 'Nothing') {
		...
		return _Utils_update(
			tc,
			{
				complete: A2($elm$core$List$cons, element, tc.complete)
			});
	}
};
...
var $author$project$L1$Parser$Error$CElement = {$: 'CElement'};
var $author$project$L1$Parser$Error$ExpectingSpace = {$: 'ExpectingSpace'};
var $author$project$L1$Parser$Error$ExpectingHashMark = {$: 'ExpectingHashMark'};
...
var $author$project$L1$Parser$Error$EndOfInput = {$: 'EndOfInput'};
...
var $author$project$L1$Parser$Error$CArgsAndBody = {$: 'CArgsAndBody'};
var $author$project$L1$Parser$Error$CBody = {$: 'CBody'};
var $author$project$L1$Parser$AST$Undefined = {$: 'Undefined'};
var $author$project$L1$Parser$AST$Code = {$: 'Code'};
var $author$project$L1$Parser$AST$Verbatim = F3(
	function (a, b, c) {
		return {$: 'Verbatim', a: a, b: b, c: c};
	});
var $author$project$L1$Parser$Error$ExpectingBackTick = {$: 'ExpectingBackTick'};
...
var $author$project$L1$Parser$Parser$meta = F3(
	function (generation, start, finish) {
		return {
			generation: generation,
			position: {end: finish, start: start}
		};
	});
				...
				$elm$parser$Parser$Advanced$succeed(
					F3(
						function (begin, end, content) {
							return {
								content: A3($elm$core$String$slice, begin, end, content),
								length: end - begin,
								start: begin
							};
						})),
...
var $author$project$L1$Parser$Parser$codeElement = function (generation) {
	return A2(
		...
		$author$project$L1$Parser$Error$CElement,
		A2(
			$elm$parser$Parser$Advanced$keeper,
			A2(
				$elm$parser$Parser$Advanced$keeper,
							...
							F4(
								function (start, content, end, source) {
									return A3(
										...
										$author$project$L1$Parser$AST$Code,
										content,
...
var $author$project$L1$Parser$Error$ExpectingLeftBracket = {$: 'ExpectingLeftBracket'};
...
var $author$project$L1$Parser$AST$Math = {$: 'Math'};
var $author$project$L1$Parser$Error$ExpectingDollarSign = {$: 'ExpectingDollarSign'};
						...
						$elm$parser$Parser$Advanced$succeed(
							F4(
								function (start, content, end, source) {
									return A3(
										$author$project$L1$Parser$AST$Verbatim,
										$author$project$L1$Parser$AST$Math,
										content,
										A3($author$project$L1$Parser$Parser$meta, generation, start, end));
								})),
...
var $author$project$L1$Parser$Loc$dummy = {end: -1, start: -1};
...
var $author$project$L1$Parser$Parser$metaOfList = F2(
	function (generation, list) {
		return {
			generation: generation,
			position: $author$project$L1$Parser$Loc$positionOfList(
				A2(
					$elm$core$List$map,
					function (el) {
...
var $author$project$L1$Parser$Error$TextExpression = {$: 'TextExpression'};
...
var $author$project$L1$Parser$Error$ExpectingEscape = {$: 'ExpectingEscape'};
...
var $author$project$L1$Library$StringParser$escapedChar = A2(
	$elm$parser$Parser$Advanced$map,
	function (result) {
		return {content: '\\' + result.content, finish: result.finish, start: result.start - 1};
	},
	A2(
...
var $author$project$L1$Parser$Parser$plainText = function (generation) {
	return A2(
		$elm$parser$Parser$Advanced$inContext,
		$author$project$L1$Parser$Error$TextExpression,
		A2(
			$elm$parser$Parser$Advanced$map,
			function (data) {
				return A2(
					...
					data.content,
					A3($author$project$L1$Parser$Parser$meta, generation, data.start, data.finish));
			},
			$author$project$L1$Library$StringParser$textWithPredicate($author$project$L1$Library$StringParser$isNonLanguageChar)));
};
var $author$project$L1$Parser$AST$Quoted = {$: 'Quoted'};
var $author$project$L1$Parser$Error$ExpectingQuoteMark = {$: 'ExpectingQuoteMark'};
						...
						$elm$parser$Parser$Advanced$succeed(
							F4(
								function (start, content, end, source) {
									return A3(
										$author$project$L1$Parser$AST$Verbatim,
										$author$project$L1$Parser$AST$Quoted,
										content,
										A3($author$project$L1$Parser$Parser$meta, generation, start, end));
								})),
...
var $author$project$L1$Parser$Error$ExpectingRightBracket = {$: 'ExpectingRightBracket'};
...
var $author$project$L1$Parser$Parser$argsAndBody = function (generation) {
	return A2(
		$elm$parser$Parser$Advanced$inContext,
		$author$project$L1$Parser$Error$CArgsAndBody,
...
var $author$project$L1$Parser$Parser$elementBody = function (generation) {
	return A2(
		$elm$parser$Parser$Advanced$inContext,
		$author$project$L1$Parser$Error$CBody,
...
var $author$project$L1$Parser$Handle$heading2 = function (tc) {
	var parsed_ = function () {
		var _v0 = A2($author$project$L1$Parser$Parser$parseHeading, tc.generation, tc.source);
		if (_v0.$ === 'Ok') {
			var goodstuff = _v0.a;
			return goodstuff;
		} else {
			return $author$project$L1$Parser$Handle$errorElement(tc.source);
		}
	}();
	return _Utils_update(
		tc,
...
var $author$project$L1$Parser$Error$ExpectingColon = {$: 'ExpectingColon'};
...
var $author$project$L1$Parser$Handle$item = function (tc) {
	var parsed_ = function () {
		var _v0 = A2($author$project$L1$Parser$Parser$parseItem, tc.generation, tc.source);
		if (_v0.$ === 'Ok') {
			var goodstuff = _v0.a;
			return goodstuff;
		} else {
...
var $author$project$L1$Parser$Handle$pipe = function (tc) {
	var source_ = '[' + ($elm$core$String$trimLeft(
		A2($elm$core$String$dropLeft, 1, tc.source)) + ']');
	return _Utils_update(
		tc,
		{
			complete: A2(
				$elm$core$List$cons,
				A2($author$project$L1$Parser$Parser$parse, tc.generation, source_),
				tc.complete)
		});
};
...
var $author$project$L1$Parser$Loop$nextCursor = F2(
	function (parser, cursor) {
		if (cursor.count > 300) {
			...
			var _v0 = _Utils_Tuple3(maybeFirstChar, maybePrefix, cursor.stack);
			if (_v0.a.$ === 'Nothing') {
				if (!_v0.c.b) {
					var _v1 = _v0.a;
					return $author$project$L1$Library$ParserTools$Done(
						_Utils_update(
							cursor,
							{
								complete: _Utils_ap(cursor.parsed, cursor.complete),
								message: 'COMM0'
							}));
				} else {
					var _v2 = _v0.a;
					return $author$project$L1$Library$ParserTools$Loop(
						A2(
							...
							_Utils_update(
								cursor,
								{count: cursor.count + 1, message: 'COMM2'})));
				}
			} else {
				if (_v0.b.$ === 'Nothing') {
					var _v3 = _v0.b;
					return $author$project$L1$Library$ParserTools$Loop(
						A2(
							...
							_Utils_update(
								cursor,
								{count: cursor.count + 1, message: 'COMM3'})));
				} else {
	...
	function (parser, generation, str) {
		var result = function (tc_) {
			return _Utils_update(
				tc_,
				{
					complete: $elm$core$List$reverse(tc_.complete)
				});
		}(
			A2(
...
var $author$project$L1$Parser$Chunk$parse = F3(
	function (parser, generation, str) {
		return A3($author$project$L1$Parser$Chunk$parseLoop, parser, generation, str).complete;
	});
var $author$project$L1$Parser$Document$InParagraph = {$: 'InParagraph'};
				...
				if (_v1.b.$ === 'BlankLines') {
					...
					var $temp$state = _Utils_update(
						state,
						{
							...
							status: $author$project$L1$Parser$Document$BlankLines(n + 1)
						});
					state = $temp$state;
					...
					var $temp$state = _Utils_update(
						state,
						{
							...
							output: A2(
								...
								$elm$core$List$reverse(state.buffer),
								state.output),
							status: $author$project$L1$Parser$Document$BlankLines(1)
						});
					state = $temp$state;
					continue groupLinesAux;
				}
					...
					var $temp$state = _Utils_update(
						state,
						{
							buffer: _List_fromArray(
								[line]),
							input: A2($elm$core$List$drop, 1, state.input),
							status: $author$project$L1$Parser$Document$InParagraph
						});
					state = $temp$state;
					continue groupLinesAux;
				} else {
...
var $author$project$L1$Parser$Document$groupLines = function (lines) {
	return $elm$core$List$reverse(
		$author$project$L1$Parser$Document$groupLinesAux(
			{buffer: _List_Nil, input: lines, output: _List_Nil, status: $author$project$L1$Parser$Document$InParagraph}).output);
};
...
try {
	...
	throw 'Some top-level definitions from `L1.Render.Markdown` are causing infinite recursion:\n\n  ┌─────┐\n  │    renderElementDict\n  │     ↓\n  │    bold\n  │     ↓\n  │    code\n  │     ↓\n  │    heading1\n  │     ↓\n  │    heading2\n  │     ↓\n  │    heading3\n  │     ↓\n  │    heading4\n  │     ↓\n  │    italic\n  │     ↓\n  │    item\n  │     ↓\n  │    quoted\n  │     ↓\n  │    renderWithDictionary\n  │     ↓\n  │    strike\n  │     ↓\n  │    transform\n  └─────┘\n\nThese errors are very tricky, so read https://elm-lang.org/0.19.1/bad-recursion to learn how to fix it!';}
...
var $author$project$Main$exportMarkdown = F2(
	function (model, fileName) {
		var exportData = $author$project$Main$toMarkdown(model.sourceText);
		...
		switch (msg.$) {
			...
			case 'ClearText':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{count: model.count + 1, sourceText: ''}),
					$elm$core$Platform$Cmd$none);
			case 'LoadDocumentText':
				var docIdentifier = msg.a;
				var text = msg.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{count: model.count + 1, docIdentifier: docIdentifier, sourceText: text}),
					$elm$core$Platform$Cmd$none);
			case 'ExportMarkdown':
				return _Utils_Tuple2(
					model,
...
var $author$project$Main$ExportMarkdown = {$: 'ExportMarkdown'};
...
var $author$project$Main$exportToMarkdownButton = A2(
	...
	$author$project$Main$buttonStyle2,
	{
		...
		onPress: $elm$core$Maybe$Just($author$project$Main$ExportMarkdown)
	});
...
var $author$project$Main$inputText = function (model) {
	return A2(
		...
		{
			label: $mdgriffith$elm_ui$Element$Input$labelHidden('Enter source text here'),
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$Main$exampleDocButton(model.docIdentifier),
						$author$project$Main$articleButton(model.docIdentifier),
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					{description: description, src: url}),
					caption
				]));
	});
...
var $author$project$L1$Render$Elm$InlineMathMode = {$: 'InlineMathMode'};
		...
		return $mdgriffith$elm_ui$Element$html(
			A3(
				...
				_List_fromArray(
					[
						_Utils_Tuple2(
						$elm$core$String$fromInt(renderArgs.generation),
						A3($author$project$L1$Render$Elm$mathText_, displayMode, renderArgs.selectedId, content))
					])));
	});
var $author$project$L1$Render$Elm$math2 = F4(
	function (renderArgs, name, args, body) {
		return A3(
			...
			renderArgs,
			$author$project$L1$Render$Elm$InlineMathMode,
			$author$project$L1$Render$Elm$getText2(body));
	});
var $author$project$L1$Render$Elm$DisplayMathMode = {$: 'DisplayMathMode'};
...
var $author$project$L1$Render$Elm$mathblock = F4(
	function (rendArgs, name, args, body) {
		return A3(
			$author$project$L1$Render$Elm$mathText,
			rendArgs,
			$author$project$L1$Render$Elm$DisplayMathMode,
...
var $author$project$L1$Render$Elm$renderMath = F4(
	function (renderArgs, name, args, body) {
		...
		if (_v0.$ === 'Just') {
			var content = _v0.a;
			return A3($author$project$L1$Render$Elm$mathText, renderArgs, $author$project$L1$Render$Elm$InlineMathMode, content);
		} else {
			return A2(
				$mdgriffith$elm_ui$Element$el,
				_List_fromArray(
...
try {
	...
	throw 'Some top-level definitions from `L1.Render.Elm` are causing infinite recursion:\n\n  ┌─────┐\n  │    renderElementDict\n  │     ↓\n  │    blue\n  │     ↓\n  │    bluelight\n  │     ↓\n  │    bold\n  │     ↓\n  │    error\n  │     ↓\n  │    fontRGB\n  │     ↓\n  │    gray\n  │     ↓\n  │    heading1\n  │     ↓\n  │    heading2\n  │     ↓\n  │    heading3\n  │     ↓\n  │    heading4\n  │     ↓\n  │    highlight\n  │     ↓\n  │    indent\n  │     ↓\n  │    italic\n  │     ↓\n  │    item\n  │     ↓\n  │    quoted\n  │     ↓\n  │    red\n  │     ↓\n  │    redlight\n  │     ↓\n  │    render\n  │     ↓\n  │    renderWithDictionary\n  │     ↓\n  │    strike\n  │     ↓\n  │    underline\n  │     ↓\n  │    violet\n  └─────┘\n\nThese errors are very tricky, so read https://elm-lang.org/0.19.1/bad-recursion to learn how to fix it!';}
...
var $author$project$Main$renderedText = function (model) {
	return A2(
		...
		A2(
			...
			A3($author$project$L1$API$renderDocument, $author$project$Main$renderArgs, model.count, model.sourceText)));
};
