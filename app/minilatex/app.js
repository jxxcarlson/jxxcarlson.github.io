...
var _user$project$MiniLatex_ParserHelpers$smacroReservedWord = A2(
...
var _user$project$MiniLatex_ParserHelpers$reservedWord = A2(
	_elm_tools$parser$Parser$inContext,
	'reservedWord',
	A2(
		_elm_tools$parser$Parser_ops['|='],
		...
		_elm_tools$parser$Parser$oneOf(
			{
				...
				_1: {
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: _elm_tools$parser$Parser$keyword('\\bibitem'),
							_1: {ctor: '[]'}
						}
					}
				}
...
var _user$project$MiniLatex_ParserHelpers$allOrNothing = function (parser) {
	return A2(
		_elm_tools$parser$Parser$inContext,
		'allOrNothing',
		A3(
...
var _user$project$MiniLatex_ParserHelpers$parseUntil = function (marker) {
	return A2(
		_elm_tools$parser$Parser$inContext,
		'parseUntil',
		A2(
...
var _user$project$MiniLatex_ParserHelpers$ws = A2(
...
var _user$project$MiniLatex_ParserHelpers$spaces = A2(
	_elm_tools$parser$Parser$ignore,
	_elm_tools$parser$Parser$zeroOrMore,
	function (c) {
		return _elm_lang$core$Native_Utils.eq(
...
var _user$project$MiniLatex_ParserHelpers$word = A2(
	_elm_tools$parser$Parser$map,
	_user$project$MiniLatex_ParserHelpers$transformWords,
	A2(
		_elm_tools$parser$Parser$inContext,
		'word',
		A2(
			...
			A2(
				...
				A2(_elm_tools$parser$Parser$keep, _elm_tools$parser$Parser$oneOrMore, _user$project$MiniLatex_ParserHelpers$notSpecialCharacter)),
			_user$project$MiniLatex_ParserHelpers$ws)));
var _user$project$MiniLatex_ParserHelpers$specialWord = A2(
	_elm_tools$parser$Parser$inContext,
	'specialWord',
	A2(
		_elm_tools$parser$Parser_ops['|.'],
...
var _user$project$MiniLatex_Parser$endWord = A2(
	...
	A2(
		...
		_user$project$MiniLatex_ParserHelpers$parseUntil('}')));
...
var _user$project$MiniLatex_Parser$innerMacroName = A2(
	...
	A2(
		...
		A2(_elm_tools$parser$Parser$keep, _elm_tools$parser$Parser$oneOrMore, _user$project$MiniLatex_ParserHelpers$notMacroSpecialCharacter)));
var _user$project$MiniLatex_Parser$smacroName = A2(
	_elm_tools$parser$Parser$inContext,
	'macroName',
	_user$project$MiniLatex_ParserHelpers$allOrNothing(
		A2(
			_elm_tools$parser$Parser_ops['|='],
			A2(
				_elm_tools$parser$Parser_ops['|.'],
				_elm_tools$parser$Parser$succeed(_elm_lang$core$Basics$identity),
				_user$project$MiniLatex_ParserHelpers$mustFail(_user$project$MiniLatex_ParserHelpers$smacroReservedWord)),
...
var _user$project$MiniLatex_Parser$macroName = A2(
	...
	_user$project$MiniLatex_ParserHelpers$allOrNothing(
		A2(
			...
			_user$project$MiniLatex_Parser$innerMacroName)));
var _user$project$MiniLatex_Parser$errorMessage2 = function (error) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		'row: ',
		A2(
...
var _user$project$MiniLatex_Parser$errorDict2 = _elm_lang$core$Dict$fromList(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'ExpectingClosing', _1: 'I believe you didn\'t close your begin-end pair properly.'},
		_1: {ctor: '[]'}
	});
var _user$project$MiniLatex_Parser$explanation2 = function (error) {
	var errorWords = A2(
	...
	var headError = A2(
		...
		A2(
			_elm_lang$core$Maybe$withDefault,
			'XXXX',
			_elm_lang$core$List$head(errorWords)));
	var _p0 = A2(_elm_lang$core$Dict$get, headError, _user$project$MiniLatex_Parser$errorDict2);
	if (_p0.ctor === 'Just') {
		return _p0._0;
	} else {
		return A2(
...
var _user$project$MiniLatex_Parser$errorDict = _elm_lang$core$Dict$fromList(
	{
		ctor: '::',
...
var _user$project$MiniLatex_Parser$explanation = function (error) {
	var _p1 = A2(
		_elm_lang$core$Dict$get,
		_elm_lang$core$Basics$toString(error.problem),
		_user$project$MiniLatex_Parser$errorDict);
	if (_p1.ctor === 'Just') {
		return _p1._0;
	} else {
		return _user$project$MiniLatex_Parser$explanation2(error);
	}
};
var _user$project$MiniLatex_Parser$errorMessage1 = function (error) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		...
		A2(
			...
			A2(
				...
				A2(
					...
					A2(
						_elm_lang$core$Basics_ops['++'],
						_user$project$MiniLatex_Parser$explanation(error),
						'</div>')))));
};
	...
	A2(
		...
		A2(
			...
			A2(
				_elm_tools$parser$Parser_ops['|='],
				_elm_tools$parser$Parser$succeed(_elm_lang$core$Basics$identity),
				A2(_elm_tools$parser$Parser$repeat, _elm_tools$parser$Parser$oneOrMore, _user$project$MiniLatex_ParserHelpers$word)))));
				...
				A2(
					...
					A2(
						...
						A2(
							_elm_tools$parser$Parser_ops['|='],
							_elm_tools$parser$Parser$succeed(_elm_lang$core$Basics$identity),
							_user$project$MiniLatex_ParserHelpers$parseUntil(endWord)),
						_user$project$MiniLatex_ParserHelpers$ws))));
	});
...
var _user$project$MiniLatex_Parser$environmentParser = function (name) {
	var _p3 = A2(_elm_lang$core$Dict$get, name, _user$project$MiniLatex_Parser$parseEnvironmentDict);
	if (_p3.ctor === 'Just') {
		return _p3._0;
	} else {
		...
		_1: {
			...
			_1: {
				...
				_1: {
					...
					_1: {
						ctor: '::',
						_0: _user$project$MiniLatex_Parser$inlineMath(_user$project$MiniLatex_ParserHelpers$ws),
						_1: {
							ctor: '::',
							_0: _user$project$MiniLatex_Parser$macro(_user$project$MiniLatex_ParserHelpers$ws),
							_1: {
								ctor: '::',
								_0: _user$project$MiniLatex_Parser$smacro,
								_1: {
									ctor: '::',
									_0: _user$project$MiniLatex_Parser$words,
									_1: {ctor: '[]'}
	...
	if (_p6.ctor === 'Ok') {
		...
		return {
			...
			_0: A2(
				...
				_elm_lang$core$Basics$toString(_p7.source),
				_user$project$MiniLatex_Parser$explanation(_p7)),
			_1: {ctor: '[]'}
		};
	}
};
...
var _user$project$MiniLatex_Differ$differentialIdList = F3(
	function (seed, diffRecord, editRecord) {
		...
		return {idList: idList, newIdsStart: newIdsStart, newIdsEnd: newIdsEnd};
	});
...
var _user$project$MiniLatex_Differ$differentialRender = F3(
	function (renderer, diffRecord, editRecord) {
		...
		var it = _elm_lang$core$List$length(diffRecord.commonTerminalSegment);
		var terminalSegmentRendered = A2(_user$project$MiniLatex_Differ$takeLast, it, editRecord.renderedParagraphs);
		var ii = _elm_lang$core$List$length(diffRecord.commonInitialSegment);
		var initialSegmentRendered = A2(_elm_lang$core$List$take, ii, editRecord.renderedParagraphs);
		return A2(
			_elm_lang$core$Basics_ops['++'],
...
var _user$project$MiniLatex_Differ$diff = F2(
	function (u, v) {
		var b_ = A2(_user$project$MiniLatex_Differ$commonTerminalSegment, u, v);
		var lb = _elm_lang$core$List$length(b_);
		...
		var b = _elm_lang$core$Native_Utils.eq(
			la,
			_elm_lang$core$List$length(u)) ? {ctor: '[]'} : b_;
		return A4(_user$project$MiniLatex_Differ$DiffRecord, a, b, x, y);
	});
var _user$project$MiniLatex_Differ$IdListPacket = F3(
	function (a, b, c) {
		return {idList: a, newIdsStart: b, newIdsEnd: c};
	});
...
var _user$project$MiniLatex_Differ$emptyEditRecord = A6(
	...
	_elm_lang$core$Maybe$Nothing,
	_elm_lang$core$Maybe$Nothing);
var _user$project$MiniLatex_Differ$createEditRecord = F2(
...
var _user$project$MiniLatex_Differ$update = F4(
	function (seed, transformer, editRecord, text) {
		...
		var diffRecord = A2(_user$project$MiniLatex_Differ$diff, editRecord.paragraphs, newParagraphs);
		var newRenderedParagraphs = A3(_user$project$MiniLatex_Differ$differentialRender, transformer, diffRecord, editRecord);
		var p = A3(_user$project$MiniLatex_Differ$differentialIdList, seed, diffRecord, editRecord);
		return A6(_user$project$MiniLatex_Differ$EditRecord, newParagraphs, newRenderedParagraphs, _user$project$MiniLatex_LatexState$emptyLatexState, p.idList, p.newIdsStart, p.newIdsEnd);
	});
					...
					return function (f) {
						return function (g) {
							return function (h) {
								return function (i) {
									return function (j) {
										return {counter: a, sourceText: b, sourceText2: c, parseResult: d, inputString: e, hasMathResult: f, editRecord: g, seed: h, configuration: i, lineViewStyle: j};
									};
								};
							};
						};
...
var _user$project$App_Types$ShowRenderToLatexView = {ctor: 'ShowRenderToLatexView'};
...
var _user$project$App_Types$RenderToLatexView = {ctor: 'RenderToLatexView'};
...
var _user$project$MiniLatex_Html$h2 = function (arg) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		'<h2>',
		A2(_elm_lang$core$Basics_ops['++'], arg, '</h2>'));
};
var _user$project$MiniLatex_Html$h1 = function (arg) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		'<h1>',
		A2(_elm_lang$core$Basics_ops['++'], arg, '</h1>'));
};
var _user$project$MiniLatex_Html$a = F2(
	function (url, label) {
		return A2(
			_elm_lang$core$Basics_ops['++'],
			'<a href=\"',
...
var _user$project$MiniLatex_Html$img = F2(
...
var _user$project$MiniLatex_Html$div = F2(
...
var _user$project$MiniLatex_Image$imageAttributes = F2(
...
var _user$project$MiniLatex_Image$handleFloatedImageLeft = F3(
...
var _user$project$MiniLatex_Image$handleFloatedImageRight = F3(
	function (url, label, imageAttributes) {
...
var _user$project$MiniLatex_Image$imageFloatLeftStyle = function (imageAttributes) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
...
var _user$project$MiniLatex_Image$imageFloatRightStyle = function (imageAttributes) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
...
var _user$project$MiniLatex_Image$imageCenterStyle = function (imageAttributes) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
...
var _user$project$MiniLatex_Image$handleCenterImage = F3(
	function (url, label, imageAttributes) {
		var width = imageAttributes.width;
		return A2(
			_user$project$MiniLatex_Html$div,
			{
				ctor: '::',
				_0: _user$project$MiniLatex_Image$imageCenterStyle(imageAttributes),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A2(_user$project$MiniLatex_Html$img, url, imageAttributes),
				_1: {
					ctor: '::',
					_0: '<br>',
					_1: {
...
var _user$project$MiniLatex_Image$ImageAttributes = F3(
	function (a, b, c) {
		return {width: a, $float: b, align: c};
	});
var _user$project$MiniLatex_Image$parseImageAttributes = function (attributeString) {
	...
	return A3(_user$project$MiniLatex_Image$ImageAttributes, widthValue, floatValue, alignValue);
};

var _user$project$MiniLatex_JoinStrings$firstChar = _elm_lang$core$String$left(1);
var _user$project$MiniLatex_JoinStrings$lastChar = _elm_lang$core$String$right(1);
var _user$project$MiniLatex_JoinStrings$NoSpace = {ctor: 'NoSpace'};
var _user$project$MiniLatex_JoinStrings$Space = {ctor: 'Space'};
var _user$project$MiniLatex_JoinStrings$joinType = F2(
	function (l, r) {
		var firstCharRight = _user$project$MiniLatex_JoinStrings$firstChar(r);
		var lastCharLeft = _user$project$MiniLatex_JoinStrings$lastChar(l);
		return _elm_lang$core$Native_Utils.eq(l, '') ? _user$project$MiniLatex_JoinStrings$NoSpace : (A2(
			_elm_lang$core$List$member,
			lastCharLeft,
			{
				ctor: '::',
				_0: '(',
				_1: {ctor: '[]'}
			}) ? _user$project$MiniLatex_JoinStrings$NoSpace : (A2(
			_elm_lang$core$List$member,
			firstCharRight,
			{
				ctor: '::',
			...
			}) ? _user$project$MiniLatex_JoinStrings$NoSpace : _user$project$MiniLatex_JoinStrings$Space));
	});
var _user$project$MiniLatex_JoinStrings$joinDatum2String = F2(
	function (current, datum) {
		var _p0 = datum;
		var acc = _p0._0;
		var previous = _p0._1;
		var _p1 = A2(_user$project$MiniLatex_JoinStrings$joinType, previous, current);
		if (_p1.ctor === 'NoSpace') {
			return {
				ctor: '_Tuple2',
...
var _user$project$MiniLatex_JoinStrings$joinList = function (stringList) {
	var start = A2(
		_elm_lang$core$Maybe$withDefault,
		'',
	...
	return _elm_lang$core$Tuple$first(
		A3(
			_elm_lang$core$List$foldl,
			_user$project$MiniLatex_JoinStrings$joinDatum2String,
			{ctor: '_Tuple2', _0: '', _1: ''},
			stringList));
};

var _user$project$MiniLatex_Utility$numberedLine = F2(
	function (k, line) {
		return A2(
			_elm_lang$core$Basics_ops['++'],
			A3(
...
var _user$project$MiniLatex_Utility$addNumberedLine = F2(
	function (line, data) {
		var _p0 = data;
		var k = _p0._0;
		var lines = _p0._1;
		return {
			...
			_1: A2(
				...
				{
					ctor: '::',
					_0: A2(_user$project$MiniLatex_Utility$numberedLine, k + 1, line),
					_1: {ctor: '[]'}
				},
				lines)
		};
	});
var _user$project$MiniLatex_Utility$addLineNumbers = function (text) {
	return A2(
		_elm_lang$core$String$join,
		'\n',
		_elm_lang$core$List$reverse(
			_elm_lang$core$Tuple$second(
				A3(
					_elm_lang$core$List$foldl,
					_user$project$MiniLatex_Utility$addNumberedLine,
					{
						ctor: '_Tuple2',
						_0: 0,
						_1: {ctor: '[]'}
...
var _user$project$MiniLatex_Render$compress = F2(
	...
	function (prefix, name) {
		return A2(
			...
			':',
			{
				...
				_1: {
					ctor: '::',
					_0: A2(_user$project$MiniLatex_Render$compress, ':', name),
					_1: {ctor: '[]'}
				}
			});
	});
	...
	switch (_p2.ctor) {
		case 'LXString':
			return A2(
				_elm_lang$core$Basics_ops['++'],
				'<td>',
				A2(_elm_lang$core$Basics_ops['++'], _p2._0, '</td>'));
		case 'InlineMath':
			return A2(
				_elm_lang$core$Basics_ops['++'],
				'<td>$',
...
var _user$project$MiniLatex_Render$renderListing = F2(
	function (latexState, body) {
		...
		return A2(
			...
			A2(
				_elm_lang$core$Basics_ops['++'],
				_user$project$MiniLatex_Utility$addLineNumbers(text),
				'</pre>\n'));
	});
...
var _user$project$MiniLatex_Render$renderTheBibliography = F2(
	function (latexState, body) {
		return A2(
			_user$project$MiniLatex_Html$div,
			{
...
var _user$project$MiniLatex_Render$renderUseForWeb = F2(
	function (latexState, body) {
		return A2(
			_elm_lang$core$Basics_ops['++'],
			'\n$$\n',
		...
		return A2(
			...
			A2(
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					'\">',
					A2(_elm_lang$core$Basics_ops['++'], label, '</a>]</span>'))));
	});
...
var _user$project$MiniLatex_Render$renderImage = F2(
	function (latexState, args) {
		...
		return _elm_lang$core$Native_Utils.eq(imageAttrs.$float, 'left') ? A2(
			...
			{
				ctor: '::',
				_0: _user$project$MiniLatex_Image$imageFloatLeftStyle(imageAttrs),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A2(_user$project$MiniLatex_Html$img, url, imageAttrs),
				_1: {
					ctor: '::',
					_0: '<br>',
					_1: {
			...
			{
				ctor: '::',
				_0: _user$project$MiniLatex_Image$imageFloatRightStyle(imageAttrs),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
			...
			{
				ctor: '::',
				_0: _user$project$MiniLatex_Image$imageCenterStyle(imageAttrs),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
			...
			A2(
				...
				A2(
					...
					A2(
						_elm_lang$core$Basics_ops['++'],
						A2(_user$project$MiniLatex_Image$imageAttributes, imageAttrs, attributeString),
						' >'))))));
	});
var _user$project$MiniLatex_Render$renderImageRef = F2(
	function (latexState, args) {
		...
		var url = A3(_user$project$MiniLatex_Render$renderArg, 0, latexState, args);
		return _elm_lang$core$Native_Utils.eq(imageAttrs.$float, 'left') ? A2(
			_user$project$MiniLatex_Html$a,
			url,
			A2(
				_user$project$MiniLatex_Html$div,
				{
				...
				{
					ctor: '::',
					_0: A2(_user$project$MiniLatex_Html$img, imageUrl, imageAttrs),
					_1: {ctor: '[]'}
				})) : (_elm_lang$core$Native_Utils.eq(imageAttrs.$float, 'right') ? A2(
			_user$project$MiniLatex_Html$a,
			url,
...
var _user$project$MiniLatex_Render$renderSMacroDict = _elm_lang$core$Dict$fromList(
	{
		ctor: '::',
		_0: {
			ctor: '_Tuple2',
...
var _user$project$MiniLatex_StateReducerHelpers$getLabel = function (str) {
	var maybeMacro = A2(
		_elm_tools$parser$Parser$run,
		_user$project$MiniLatex_Parser$macro(_user$project$MiniLatex_ParserHelpers$ws),
...
var _user$project$MiniLatex_StateReducerHelpers$getElement = F2(
	function (k, list) {
		var lxString = A2(
			_elm_lang$core$Maybe$withDefault,
			_user$project$MiniLatex_Parser$LXString('xxx'),
...
var _user$project$MiniLatex_StateReducerHelpers$getAt = F2(
	function (k, list_) {
		return A2(
			_elm_lang$core$Maybe$withDefault,
			'xxx',
...
var _user$project$MiniLatex_StateReducerHelpers$setEquationNumber = F2(
	function (info, latexState) {
		...
		var label = function () {
			...
			if (_p2.ctor === 'LXString') {
				return _user$project$MiniLatex_StateReducerHelpers$getLabel(_p2._0);
			} else {
				return '';
			}
		}();
...
var _user$project$MiniLatex_StateReducerHelpers$setTheoremNumber = F2(
	function (info, latexState) {
...
var _user$project$MiniLatex_StateReducerHelpers$setDictionaryItemForMacro = F2(
	function (latexInfo, latexState) {
		...
		return A3(_user$project$MiniLatex_LatexState$setDictionaryItem, latexInfo.name, value, latexState);
	});
var _user$project$MiniLatex_StateReducerHelpers$updateSubsubsectionNumber = F2(
	function (info, latexState) {
		...
		return A4(
			...
			_user$project$MiniLatex_ParserTools$unpackString(info.value),
			label,
			2,
			A2(_user$project$MiniLatex_LatexState$incrementCounter, 's3', latexState));
	});
var _user$project$MiniLatex_StateReducerHelpers$updateSubsectionNumber = F2(
	function (info, latexState) {
		var s2 = _elm_lang$core$Basics$toString(
			function (x) {
				return x + 1;
...
var _user$project$MiniLatex_StateReducerHelpers$updateSectionNumber = F2(
	function (info, latexState) {
...
var _user$project$MiniLatex_StateReducerHelpers$setSectionCounters = F2(
	function (info, latexState) {
		var argList = A2(
			_elm_lang$core$List$map,
			_user$project$MiniLatex_ParserTools$list2LeadingString,
			A2(_elm_lang$core$List$map, _user$project$MiniLatex_ParserTools$latexList2List, info.value));
		var arg1 = A2(_user$project$MiniLatex_StateReducerHelpers$getAt, 0, argList);
		var arg2 = A2(_user$project$MiniLatex_StateReducerHelpers$getAt, 1, argList);
...
var _user$project$MiniLatex_Accumulator$latexStateReducerDict = _elm_lang$core$Dict$fromList(
	{
		...
		_0: {
			ctor: '_Tuple2',
			_0: {ctor: '_Tuple2', _0: 'macro', _1: 'setcounter'},
			_1: F2(
				function (x, y) {
					return A2(_user$project$MiniLatex_StateReducerHelpers$setSectionCounters, x, y);
				})
		},
		_1: {
			ctor: '::',
			_0: {
				ctor: '_Tuple2',
				_0: {ctor: '_Tuple2', _0: 'macro', _1: 'section'},
				_1: F2(
					function (x, y) {
						return A2(_user$project$MiniLatex_StateReducerHelpers$updateSectionNumber, x, y);
					})
			},
			_1: {
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: {ctor: '_Tuple2', _0: 'macro', _1: 'subsection'},
					_1: F2(
						function (x, y) {
							return A2(_user$project$MiniLatex_StateReducerHelpers$updateSubsectionNumber, x, y);
						})
				},
				_1: {
					ctor: '::',
					_0: {
						ctor: '_Tuple2',
						_0: {ctor: '_Tuple2', _0: 'macro', _1: 'subsubsection'},
						_1: F2(
							function (x, y) {
								return A2(_user$project$MiniLatex_StateReducerHelpers$updateSubsubsectionNumber, x, y);
							})
					},
					_1: {
						ctor: '::',
						_0: {
							ctor: '_Tuple2',
							_0: {ctor: '_Tuple2', _0: 'macro', _1: 'title'},
							_1: F2(
								function (x, y) {
									return A2(_user$project$MiniLatex_StateReducerHelpers$setDictionaryItemForMacro, x, y);
								})
						},
						_1: {
							ctor: '::',
							_0: {
								ctor: '_Tuple2',
								_0: {ctor: '_Tuple2', _0: 'macro', _1: 'author'},
								_1: F2(
									function (x, y) {
										return A2(_user$project$MiniLatex_StateReducerHelpers$setDictionaryItemForMacro, x, y);
									})
							...
							_1: {
								...
								_0: {
									ctor: '_Tuple2',
									_0: {ctor: '_Tuple2', _0: 'macro', _1: 'date'},
									_1: F2(
										function (x, y) {
											return A2(_user$project$MiniLatex_StateReducerHelpers$setDictionaryItemForMacro, x, y);
										})
								...
								_1: {
									...
									_0: {
										ctor: '_Tuple2',
										_0: {ctor: '_Tuple2', _0: 'macro', _1: 'email'},
										_1: F2(
											function (x, y) {
												return A2(_user$project$MiniLatex_StateReducerHelpers$setDictionaryItemForMacro, x, y);
											})
									...
									_1: {
										...
										_0: {
											ctor: '_Tuple2',
											_0: {ctor: '_Tuple2', _0: 'macro', _1: 'revision'},
											_1: F2(
												function (x, y) {
													return A2(_user$project$MiniLatex_StateReducerHelpers$setDictionaryItemForMacro, x, y);
												})
										...
										_1: {
											...
											_0: {
												ctor: '_Tuple2',
												_0: {ctor: '_Tuple2', _0: 'env', _1: 'theorem'},
												_1: F2(
													function (x, y) {
														return A2(_user$project$MiniLatex_StateReducerHelpers$setTheoremNumber, x, y);
													})
											},
											_1: {
												ctor: '::',
												_0: {
													ctor: '_Tuple2',
													_0: {ctor: '_Tuple2', _0: 'env', _1: 'proposition'},
													_1: F2(
														function (x, y) {
															return A2(_user$project$MiniLatex_StateReducerHelpers$setTheoremNumber, x, y);
														})
												...
												_1: {
													...
													_0: {
														ctor: '_Tuple2',
														_0: {ctor: '_Tuple2', _0: 'env', _1: 'lemma'},
														_1: F2(
															function (x, y) {
																return A2(_user$project$MiniLatex_StateReducerHelpers$setTheoremNumber, x, y);
															})
													...
													_1: {
														...
														_0: {
															ctor: '_Tuple2',
															_0: {ctor: '_Tuple2', _0: 'env', _1: 'definition'},
															_1: F2(
																function (x, y) {
																	return A2(_user$project$MiniLatex_StateReducerHelpers$setTheoremNumber, x, y);
																})
														...
														_1: {
															...
															_0: {
																ctor: '_Tuple2',
																_0: {ctor: '_Tuple2', _0: 'env', _1: 'corollary'},
																_1: F2(
																	function (x, y) {
																		return A2(_user$project$MiniLatex_StateReducerHelpers$setTheoremNumber, x, y);
																	})
															...
															_1: {
																...
																_0: {
																	ctor: '_Tuple2',
																	_0: {ctor: '_Tuple2', _0: 'env', _1: 'equation'},
																	_1: F2(
																		function (x, y) {
																...
																_1: {
																	...
																	_0: {
																		ctor: '_Tuple2',
																		_0: {ctor: '_Tuple2', _0: 'env', _1: 'align'},
																		_1: F2(
																			function (x, y) {
																				return A2(_user$project$MiniLatex_StateReducerHelpers$setEquationNumber, x, y);
																			})
...
var _user$project$MiniLatex_Accumulator$latexStateReducerDispatcher = function (_p0) {
	var _p1 = _p0;
	var _p2 = A2(
		_elm_lang$core$Dict$get,
		{ctor: '_Tuple2', _0: _p1._0, _1: _p1._1},
		_user$project$MiniLatex_Accumulator$latexStateReducerDict);
	if (_p2.ctor === 'Just') {
		return _p2._0;
	} else {
		return F2(
...
var _user$project$MiniLatex_Accumulator$renderTransformer = F4(
	function (render, latexStateReducer, input, acc) {
		var _p4 = acc;
		var outputList = _p4._0;
		var state = _p4._1;
		var newState = A2(latexStateReducer, input, state);
...
var _user$project$MiniLatex_Accumulator$parserReducerTransformer = F4(
	function (parse, latexStateReducer, input, acc) {
		var parsedInput = parse(input);
		var _p5 = acc;
		var outputList = _p5._0;
		var state = _p5._1;
		var newState = A2(latexStateReducer, parsedInput, state);
		return {
			ctor: '_Tuple2',
			_0: A2(
				_elm_lang$core$Basics_ops['++'],
...
var _user$project$MiniLatex_Accumulator$parserAccumulatorReducer = A2(_user$project$MiniLatex_Accumulator$parserReducerTransformer, _user$project$MiniLatex_Parser$parse, _user$project$MiniLatex_Accumulator$latexStateReducer);
var _user$project$MiniLatex_Accumulator$parseAccumulator = F2(
	function (latexState, inputList) {
		return A3(
			_elm_lang$core$List$foldl,
			_user$project$MiniLatex_Accumulator$parserAccumulatorReducer,
			{
				ctor: '_Tuple2',
				_0: {ctor: '[]'},
				_1: latexState
...
var _user$project$MiniLatex_Accumulator$parseParagraphs = F2(
	function (latexState, paragraphs) {
		return A2(_user$project$MiniLatex_Accumulator$parseAccumulator, latexState, paragraphs);
	});
var _user$project$MiniLatex_Accumulator$renderAccumulatorReducer = A2(_user$project$MiniLatex_Accumulator$renderTransformer, _user$project$MiniLatex_Render$renderLatexList, _user$project$MiniLatex_Accumulator$latexStateReducer);
var _user$project$MiniLatex_Accumulator$renderAccumulator = F2(
	function (latexState, inputList) {
		return A3(
			_elm_lang$core$List$foldl,
			_user$project$MiniLatex_Accumulator$renderAccumulatorReducer,
			{
				ctor: '_Tuple2',
				_0: {ctor: '[]'},
				_1: latexState
...
var _user$project$MiniLatex_Accumulator$renderParagraphs = F2(
	function (latexState, paragraphs) {
		return A2(_user$project$MiniLatex_Accumulator$renderAccumulator, latexState, paragraphs);
	});

var _user$project$MiniLatex_LatexDiffer$update_ = F3(
...
var _user$project$MiniLatex_LatexDiffer$makeIdList = function (paragraphs) {
	return A2(
		_elm_lang$core$List$map,
		_user$project$MiniLatex_Differ$prefixer(0),
		A2(
			_elm_lang$core$List$range,
			1,
			_elm_lang$core$List$length(paragraphs)));
};
var _user$project$MiniLatex_LatexDiffer$createEditRecord = F2(
	function (latexState, text) {
		var paragraphs = _user$project$MiniLatex_Paragraph$logicalParagraphify(text);
		...
		var idList = _user$project$MiniLatex_LatexDiffer$makeIdList(paragraphs);
		return A6(_user$project$MiniLatex_Differ$EditRecord, paragraphs, renderedParagraphs, latexState2, idList, _elm_lang$core$Maybe$Nothing, _elm_lang$core$Maybe$Nothing);
	});
var _user$project$MiniLatex_LatexDiffer$update = F3(
	function (seed, editRecord, content) {
		return _user$project$MiniLatex_Differ$isEmpty(editRecord) ? A2(_user$project$MiniLatex_LatexDiffer$createEditRecord, _user$project$MiniLatex_LatexState$emptyLatexState, content) : A3(_user$project$MiniLatex_LatexDiffer$update_, seed, editRecord, content);
	});

var _user$project$MiniLatex_Driver$update = F3(
	function (seed, editRecord, text) {
		return A3(_user$project$MiniLatex_LatexDiffer$update, seed, editRecord, text);
	});
...
var _user$project$MiniLatex_Driver$setup = F2(
	function (seed, text) {
		return A3(_user$project$MiniLatex_LatexDiffer$update, seed, _user$project$MiniLatex_Differ$emptyEditRecord, text);
	});
...
var _user$project$MiniLatex_Driver$parse = function (text) {
	return A2(
		...
		_user$project$MiniLatex_Paragraph$logicalParagraphify(text));
};
var _user$project$MiniLatex_Driver$render = F2(
	function (macroDefinitions, text) {
		return A2(
			...
			macroDefinitions,
			A2(_user$project$MiniLatex_LatexDiffer$createEditRecord, _user$project$MiniLatex_LatexState$emptyLatexState, text));
	});

var _user$project$MiniLatex_RenderToLatex$renderComment = function (str) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		'% ',
...
var _user$project$MiniLatex_RenderToLatex$renderItem = F2(
	function (level, latexExpression) {
		return A2(
			...
			A2(
				_elm_lang$core$Basics_ops['++'],
				_user$project$MiniLatex_RenderToLatex$render(latexExpression),
				'\n\n'));
	});
...
var _user$project$MiniLatex_RenderToLatex$renderBackToLatex = function (str) {
	return A3(
		...
		A2(
			_elm_lang$core$List$map,
			_user$project$MiniLatex_RenderToLatex$renderLatexList,
			A2(
				_elm_lang$core$List$map,
				_user$project$MiniLatex_Parser$parse,
				_user$project$MiniLatex_Paragraph$logicalParagraphify(str))));
};
var _user$project$MiniLatex_RenderToLatex$renderBackToLatexTest = function (str) {
	return _elm_lang$core$Native_Utils.eq(
		str,
		_user$project$MiniLatex_RenderToLatex$renderBackToLatex(str));
};
var _user$project$MiniLatex_RenderToLatex$renderBackToLatexTestModSpace = function (str) {
	return _elm_lang$core$Native_Utils.eq(
		A3(_elm_community$string_extra$String_Extra$replace, ' ', '', str),
		A3(
			_elm_community$string_extra$String_Extra$replace,
...
var _user$project$MiniLatex_RenderLatexForExport$renderUseForWeb = function (body) {
	return '';
};
...
var _user$project$MiniLatex_RenderLatexForExport$renderEnvironmentDict = _elm_lang$core$Dict$fromList(
	{
		...
		_0: {
			...
			_0: 'listing',
			_1: function (x) {
				return _user$project$MiniLatex_RenderLatexForExport$renderListing(x);
			}
		},
		_1: {
			ctor: '::',
			_0: {
				...
				_0: 'useforweb',
				_1: function (x) {
					return _user$project$MiniLatex_RenderLatexForExport$renderUseForWeb(x);
				}
			},
			_1: {ctor: '[]'}
		}
	});
var _user$project$MiniLatex_RenderLatexForExport$renderListing = function (body) {
	var text = _user$project$MiniLatex_RenderLatexForExport$render(body);
	return A2(
		_elm_lang$core$Basics_ops['++'],
		'\n\\begin{verbatim}\n',
		A2(
...
var _user$project$MiniLatex_RenderLatexForExport$renderImage = function (args) {
	...
	var _p3 = {ctor: '_Tuple2', _0: imageAttrs.$float, _1: imageAttrs.align};
	switch (_p3._0) {
		case 'left':
							...
							_1: {
								...
								_1: {
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: {ctor: '_Tuple2', _0: 'white-space', _1: 'pre-line'},
											_1: {ctor: '[]'}
										}
									}
								}
...
var _user$project$App_View$reRenderedLatexStyle = A4(_user$project$App_View$textStyle3, '400px', '600px', '20px', '#eee');
		...
		switch (_p0.ctor) {
			...
			default:
				return A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Latex (2)'),
						_1: {ctor: '[]'}
					});
		}
	});
...
var _user$project$App_View$renderToLatexViewButton = F2(
	function (model, width) {
		return _elm_lang$core$Native_Utils.eq(model.configuration, _user$project$App_Types$RenderToLatexView) ? A2(
			_elm_lang$html$Html$button,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onClick(_user$project$App_Types$ShowRenderToLatexView),
				_1: {
					ctor: '::',
					_0: A2(_user$project$App_View$buttonStyle, _user$project$App_View$colorBlue, width),
					_1: {ctor: '[]'}
...
var _user$project$App_View$renderToLatexPane = function (model) {
	var rerenderedText = _user$project$MiniLatex_RenderToLatex$renderBackToLatex(model.sourceText);
	return A2(
		_elm_lang$html$Html$pre,
		{
			ctor: '::',
			_0: _user$project$App_View$reRenderedLatexStyle,
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text(rerenderedText),
			_1: {ctor: '[]'}
		});
};
			...
			_1: {
				...
				_1: {
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: A2(_user$project$App_View$rawHtmlViewButton, model, 85),
							_1: {
								ctor: '::',
								_0: A2(_user$project$App_View$renderToLatexViewButton, model, 40),
								_1: {ctor: '[]'}
							}
						}
					}
...
var _user$project$App_View$renderToLatex = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		},
		{
			...
			_1: {
				ctor: '::',
				_0: A2(_user$project$App_View$viewLabel, 'Text parsed and rendered back to LaTeX (Almost Identity)', 400),
				_1: {
					ctor: '::',
					_0: _user$project$App_View$spacer(5),
					_1: {
						ctor: '::',
						_0: _user$project$App_View$renderToLatexPane(model),
						_1: {
							ctor: '::',
							_0: _user$project$App_View$spacer(5),
							_1: {
...
var _user$project$Main$renderToLatexView = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		},
		{
			...
			_1: {
				...
				_1: {
					...
					_1: {
						ctor: '::',
						_0: _user$project$App_View$renderToLatex(model),
						_1: {
							ctor: '::',
							_0: _user$project$App_View$spacer(5),
							_1: {
...
var _user$project$Main$mainView = function (model) {
	...
	switch (_p0.ctor) {
		...
		default:
			return _user$project$Main$renderToLatexView(model);
	}
};
...
var _user$project$Main$init = function () {
	...
	var model = {
		...
		sourceText2: _user$project$App_Source$initialText,
		...
		switch (_p1.ctor) {
			...
			case 'ShowRenderToLatexView':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{configuration: _user$project$App_Types$RenderToLatexView}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
