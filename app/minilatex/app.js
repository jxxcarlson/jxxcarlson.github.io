...
var _user$project$App_Types$Model = F8(
	function (a, b, c, d, e, f, g, h) {
		return {sourceText: a, parseResult: b, textToExport: c, hasMathResult: d, editRecord: e, seed: f, configuration: g, lineViewStyle: h};
	});
...
var _user$project$Main$exportLatex = function (model) {
	...
	return {
		...
		_0: _elm_lang$core$Native_Utils.update(
			model,
			{editRecord: editRecord, textToExport: textToExport, configuration: _user$project$App_Types$ExportLatexView}),
