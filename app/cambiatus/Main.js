...
var $author$project$Main$updateParameters = function (model) {
	return A2(
		...
		$elm$core$String$fromInt(model.trialsToRun),
		A2(
...
var $author$project$Main$displayLostSaleData = function (model) {
	return A2(
		...
		A2(
			...
			$elm$core$String$fromInt,
			$elm$core$List$reverse(
				A2($elm$core$List$take, 5, model.data))));
};
			...
			[
				...
				_List_fromArray(
					[
						...
						$mdgriffith$elm_ui$Element$text('Mean')),
						A2(
						$mdgriffith$elm_ui$Element$el,
						_List_fromArray(
							[
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$el,
				_List_Nil,
				$mdgriffith$elm_ui$Element$text('Lost Sales')),
				A2(
				$mdgriffith$elm_ui$Element$row,
				_List_fromArray(
					[
