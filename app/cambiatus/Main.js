...
var $author$project$Action$businessBuyGoods = function (state) {
	var ppp = state.config.probabilityOfPurchasing;
	...
	var probabilityToSelectABusiness = _v0.a;
	var seed1 = _v0.b;
	var business__ = function () {
		var _v5 = _Utils_Tuple2(
			_Utils_cmp(probabilityToSelectABusiness, ppp) < 0,
			_Utils_cmp(probabilityToSelectABusiness, 2 * ppp) < 0);
		if (_v5.a) {
			return A2($elm_community$list_extra$List$Extra$getAt, 0, state.businesses);
		} else {
			if (_v5.b) {
				return A2($elm_community$list_extra$List$Extra$getAt, 1, state.businesses);
			} else {
				return $elm$core$Maybe$Nothing;
			}
		}
	...
	var _v1 = A2($elm$random$Random$step, $author$project$Action$probability, seed1);
	var probabilityForChoosingPurchaseAmount = _v1.a;
	var seed2 = _v1.b;
