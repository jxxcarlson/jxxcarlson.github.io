...
var author$project$Currency$Complementary = {$: 'Complementary'};
...
var author$project$Currency$isValid = F2(
	function (t, c) {
		...
		if (_n0.$ === 'Infinite') {
			...
			return _Utils_cmp(expirationTime, t - c.issueTime) > 0;
		}
	});
...
var author$project$Currency$credit = F3(
	function (t, c, account__) {
		...
		var _n0 = A2(
			elm$core$List$filter,
			function (e) {
				return _Utils_eq(e.issueTime, c.issueTime) && _Utils_eq(e.expiration, c.expiration);
			},
			account_);
		if (_n0.b && (!_n0.b.b)) {
			var e = _n0.a;
			return A3(
				...
				function (ee) {
					return _Utils_eq(ee.issueTime, c.issueTime);
				},
				function (ee) {
...
var author$project$Currency$create = F5(
	function (currencyType, expiration, creationTime, amount, bank) {
		var newCurrency = {amount: amount, currencyType: currencyType, expiration: expiration, issueTime: creationTime};
		return _Utils_update(
			bank,
			{
		...
		return A2(
			...
			A3(
				...
				A2(
					...
					rows * columns,
					{id: -1, name: '', parentGraphId: 0, status: author$project$Grid$Vacant})));
	});
...
var author$project$Grid$NotRecruited = {$: 'NotRecruited'};
var author$project$Grid$Recruited = {$: 'Recruited'};
...
var author$project$Grid$cellFromEntity = function (entity) {
	...
	var _n0 = nodeState_.status;
	if (_n0.$ === 'Recruited') {
		return {id: entity.id, name: nodeState_.name, parentGraphId: entity.value.parentGraphId, status: author$project$Grid$Recruited};
	} else {
		return {id: entity.id, name: nodeState_.name, parentGraphId: entity.value.parentGraphId, status: author$project$Grid$NotRecruited};
	}
};
var author$project$Grid$insertNode = F2(
	function (nodeEntity, grid) {
		var nodeState_ = author$project$Network$nodeState(nodeEntity.label);
		return A3(
			author$project$CellGrid$setValue,
			grid,
			nodeState_.location,
			author$project$Grid$cellFromEntity(nodeEntity.label));
	});
...
var author$project$Network$makeEdge = function (_n0) {
	var from = _n0.a;
	var to = _n0.b;
	return {from: from, label: author$project$Network$zeroEdgeLabel, to: to};
};
var author$project$Network$NotRecruited = {$: 'NotRecruited'};
var author$project$Network$Recruited = {$: 'Recruited'};
var author$project$Network$Shopkeeper = {$: 'Shopkeeper'};
var author$project$Network$Unemployed = {$: 'Unemployed'};
var author$project$Network$setNodeState = F5(
	function (graphId, role, status, name, _n0) {
		var i = _n0.a;
		var j = _n0.b;
		return {
...
var author$project$Network$testNodes = _List_fromArray(
	[
		A2(
		elm_community$graph$Graph$Node,
		0,
		A5(
			author$project$Network$setNodeState,
			0,
			author$project$Network$Shopkeeper,
			author$project$Network$NotRecruited,
			'p0',
			_Utils_Tuple2(10, 18))),
		A2(
		elm_community$graph$Graph$Node,
		...
		A5(
			author$project$Network$setNodeState,
			0,
			author$project$Network$Unemployed,
			author$project$Network$NotRecruited,
			'p1',
			_Utils_Tuple2(16, 15))),
		A2(
...
var author$project$Network$hiddenTestGraph = A2(
	...
	author$project$Network$testNodes,
	_List_fromArray(
		[
			author$project$Network$makeEdge(
			_Utils_Tuple2(0, 1)),
			author$project$Network$makeEdge(
			_Utils_Tuple2(0, 2)),
			author$project$Network$makeEdge(
...
var author$project$Network$testGraph = A2(elm_community$graph$Graph$fromNodesAndEdges, author$project$Network$testNodes, _List_Nil);
...
var author$project$NetworkSimulator$defaultConfig = {
	epsilon: 1.0e-6,
	...
	return _Utils_Tuple2(
		{
			centralBank: A5(
				...
				author$project$Currency$Complementary,
			...
			configuration: author$project$NetworkSimulator$defaultConfig,
			displayMode: author$project$NetworkSimulator$DisplayGraph,
			drag: elm$core$Maybe$Nothing,
			forestState: author$project$NetworkSimulator$defaultConfig.forestState,
			gameClock: 0,
			gameOverCount: 0,
...
var author$project$NetworkSimulator$simulationSubscription = function (model) {
	var _n0 = model.drag;
	if (_n0.$ === 'Nothing') {
		return gampleman$elm_visualization$Force$isCompleted(model.simulation) ? elm$core$Platform$Sub$none : elm$browser$Browser$Events$onAnimationFrame(author$project$NetworkSimulator$Tick);
	} else {
	...
	return elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				...
				A2(elm$time$Time$every, model.configuration.gameTimeInterval, author$project$NetworkSimulator$GameTick)
			]));
};
var author$project$Currency$Infinite = {$: 'Infinite'};
var author$project$NetworkSimulator$Drag = F3(
	function (start, current, index) {
		return {current: current, index: index, start: start};
	});
...
var author$project$NetworkSimulator$advanceGameState = function (model) {
...
var author$project$NetworkSimulator$updateNode = F2(
	function (_n0, nodeCtx) {
		var x = _n0.a;
		var y = _n0.b;
		var nodeValue = nodeCtx.node.label;
		return A2(
...
var author$project$NetworkSimulator$handleDragAt = F2(
	function (model, xy) {
		var _n0 = model.drag;
		if (_n0.$ === 'Just') {
			var start = _n0.a.start;
			var index = _n0.a.index;
			return A2(
				author$project$NetworkSimulator$putCmd,
				elm$core$Platform$Cmd$none,
				_Utils_update(
					model,
					{
						...
						graph: A3(
							...
							model.graph),
						simulation: gampleman$elm_visualization$Force$reheat(model.simulation)
					}));
		} else {
			return A2(author$project$NetworkSimulator$putCmd, elm$core$Platform$Cmd$none, model);
		}
	});
var author$project$NetworkSimulator$handleDragEnd = F2(
	function (model, xy) {
		var _n0 = model.drag;
		if (_n0.$ === 'Just') {
			var start = _n0.a.start;
...
var author$project$NetworkSimulator$updateForestState = F3(
	function (model, tick, forestState) {
		var _n0 = A2(elm$core$Basics$modBy, model.configuration.gameCycleLength, tick);
		switch (_n0) {
			case 0:
				return model.configuration.forestDecayRate * forestState;
			case 5:
				return forestState + (model.configuration.numberOfForestWorkers * model.configuration.forestIncrementPerWorker);
			default:
				return forestState;
		}
	});
...
var author$project$Network$removeExpiredCurrencyFromEdges = F2(
	function (bt, g) {
		var edgeTransformer = function (e) {
			return _Utils_update(
				e,
				{
					transactions: A2(author$project$Currency$removeInvalid, bt, e.transactions)
				});
		};
...
var author$project$NetworkSimulator$ccCoin = F3(
	function (model, amount, issueTime) {
		return {amount: amount, currencyType: author$project$Currency$Complementary, expiration: model.configuration.expiration, issueTime: issueTime};
	});
var author$project$NetworkSimulator$transfer = function (model) {
	return {
		foodBought: A2(author$project$NetworkSimulator$ccCoin, model, -0.15),
		foodSold: A2(author$project$NetworkSimulator$ccCoin, model, model.configuration.numberOfForestWorkers * 0.15),
		forestPay: A2(author$project$NetworkSimulator$ccCoin, model, 1),
		houseRent: A2(author$project$NetworkSimulator$ccCoin, model, -0.4),
		shopRent: A2(author$project$NetworkSimulator$ccCoin, model, -0.8)
	};
};
...
var author$project$NetworkSimulator$buyFood = F4(
	function (model, shopkeeperName, tick, g) {
		var entityMapper = function (entity) {
			var _n0 = _Utils_cmp(
				author$project$Network$balanceFromEntity(entity),
				model.configuration.epsilon) < 0;
			if (_n0) {
				...
				if (_n1.$ === 'Unemployed') {
					...
					return A3(
						...
						_List_fromArray(
							[
								author$project$NetworkSimulator$transfer(model).foodSold(tick)
							]),
						entity);
				}
			} else {
				...
				if (_n2.$ === 'Unemployed') {
					return A3(
						...
						_List_fromArray(
							[
								author$project$NetworkSimulator$transfer(model).foodBought(tick)
							]),
						entity);
				} else {
					return A3(
...
var author$project$NetworkSimulator$payForForestryWork = F3(
	function (model, tick, g) {
		var entityMapper = function (entity) {
			...
			if (_n0) {
				return A3(
					...
					_List_fromArray(
						[
							author$project$NetworkSimulator$transfer(model).forestPay(tick)
						]),
					entity);
			} else {
				return entity;
...
var author$project$NetworkSimulator$payRent = F3(
	function (model, tick, g) {
		var entityMapper = function (entity) {
			var _n0 = _Utils_cmp(
				author$project$Network$balanceFromEntity(entity),
			...
			if (_n0) {
				...
				if (_n1.$ === 'Unemployed') {
					return A3(
						...
						_List_fromArray(
							[
								author$project$NetworkSimulator$transfer(model).houseRent(tick)
							]),
						entity);
				} else {
					return A3(
						...
						_List_fromArray(
							[
								author$project$NetworkSimulator$transfer(model).shopRent(tick)
							]),
						entity);
				}
			}
...
var author$project$NetworkSimulator$updateGraph = F3(
	function (model, tick, g) {
		var _n0 = A2(elm$core$Basics$modBy, model.configuration.gameCycleLength, tick);
		switch (_n0) {
			case 0:
			...
			case 1:
				return A3(author$project$NetworkSimulator$payForForestryWork, model, tick, g);
			case 2:
				return A3(author$project$NetworkSimulator$payRent, model, tick, g);
			case 3:
				return A4(author$project$NetworkSimulator$buyFood, model, model.configuration.shopkeeper1, tick, g);
			case 4:
				return A4(author$project$NetworkSimulator$buyFood, model, model.configuration.shopkeeper2, tick, g);
			default:
				return g;
		}
	});
		...
		return function (model_) {
			...
			function (model_) {
				return _Utils_update(
					model_,
					{
						forestState: A3(author$project$NetworkSimulator$updateForestState, model, tick, model.forestState)
					});
			}(
				function (model_) {
					return _Utils_update(
						model_,
						{
							graph: A3(author$project$NetworkSimulator$updateGraph, model, tick, model.graph)
						});
				}(model)));
	});
...
var author$project$Network$alterLink = function (_n0) {
	...
	return {
		distance: 90,
		source: from,
		strength: elm$core$Maybe$Just(1),
		target: to
	};
};
		...
		return A2(
			...
			function (x) {
				return _Utils_update(
					x,
					{
						outgoing: A3(elm_community$intdict$IntDict$insert, to, author$project$Network$zeroEdgeLabel, x.outgoing)
					});
			},
		...
		return A2(
			...
			function (n) {
				return _Utils_eq(n.id, nodeIndex) ? _Utils_update(
					n,
					{
						value: {accountBalance: n.value.accountBalance, location: n.value.location, name: n.value.name, numberRecruited: n.value.numberRecruited, parentGraphId: n.value.parentGraphId, role: n.value.role, status: status}
					}) : n;
			},
			graph);
	});
		...
		return A2(
			...
			function (n) {
				return _Utils_eq(n.id, nodeId) ? _Utils_update(
					n,
					{
						value: {accountBalance: n.value.accountBalance, location: n.value.location, name: n.value.name, numberRecruited: n.value.numberRecruited + 1, parentGraphId: n.value.parentGraphId, role: n.value.role, status: n.value.status}
					}) : n;
			},
			graph);
	});
	...
	function (model, msg_) {
		if (!_Utils_eq(model.gameState, author$project$NetworkSimulator$Phase1)) {
			...
			var audioMsg = function () {
				var _n3 = !elm$core$List$length(associatedOutgoingNodeIds);
				if (_n3) {
					return author$project$NetworkSimulator$Chirp;
				} else {
					return author$project$NetworkSimulator$LongChirp;
				...
				A2(
					...
					A3(
						...
						A4(
							...
							_List_fromArray(
								[
									{amount: 10, currencyType: author$project$Currency$Complementary, expiration: model.configuration.expiration, issueTime: model.gameClock}
								]),
			...
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{graph: newGraph, grid: newGrid, message: message}),
				author$project$NetworkSimulator$sendAudioMessage(audioMsg));
		}
	});
...
var author$project$NetworkSimulator$handleTick = F2(
	function (model, t) {
		var _n0 = A2(
		...
		if (_n1.$ === 'Nothing') {
			return A2(
				...
				_Utils_update(
					model,
					{
						graph: A2(author$project$NetworkSimulator$updateGraphWithList, model.graph, list),
						simulation: newState
					}));
		} else {
			var current = _n1.a.current;
			var index = _n1.a.index;
			return A2(
				author$project$NetworkSimulator$putCmd,
				elm$core$Platform$Cmd$none,
				_Utils_update(
					model,
					{
						graph: A3(
							...
							A2(author$project$NetworkSimulator$updateGraphWithList, model.graph, list))
					}));
		}
	});
...
var author$project$Grid$recruitedCount = function (_n0) {
	...
	return A3(
		...
		F2(
			function (cell, acc) {
				return _Utils_eq(cell.status, author$project$Grid$Recruited) ? (acc + 1) : acc;
			}),
		0,
		cellArray);
};
...
var author$project$NetworkMeasure$delta = 0.0;
...
var author$project$NetworkMeasure$inflowToNode = F2(
	function (nodeId, g) {
		var _n0 = A2(elm_community$graph$Graph$get, nodeId, g);
		if (_n0.$ === 'Nothing') {
			return 0;
		} else {
			var ctx = _n0.a;
			return elm$core$Basics$abs(
				author$project$NetworkMeasure$edgeFlow(ctx.incoming));
		}
	});
var author$project$NetworkMeasure$outflowFromNode = F2(
	function (nodeId, g) {
		var _n0 = A2(elm_community$graph$Graph$get, nodeId, g);
		if (_n0.$ === 'Nothing') {
			return 0;
...
var author$project$Utility$roundTo = F2(
	function (places, quantity) {
		...
		var ff = factor;
		var q2 = ff * quantity;
		var q3 = elm$core$Basics$round(q2);
		return q3 / ff;
	});
var author$project$NetworkMeasure$efficiencyOfEdge = F3(
	function (totalFlow_, g, edge) {
		...
		var _n0 = (_Utils_cmp(
			elm$core$Basics$abs(denominator),
			author$project$NetworkMeasure$epsilon) < 0) || (_Utils_cmp(
			elm$core$Basics$abs(numerator),
			author$project$NetworkMeasure$epsilon) < 0);
		if (_n0) {
			return author$project$NetworkMeasure$delta;
		} else {
...
var author$project$NetworkMeasure$postfixList = function (lst) {
	return A2(
		elm$core$List$take,
...
var author$project$NetworkMeasure$differences = function (lst) {
	var postfixList_ = author$project$NetworkMeasure$postfixList(lst);
	var differencesForPair = function (pair) {
		var _n0 = pair;
		var x = _n0.a;
		var lst_ = _n0.b;
		return A2(
	...
	return elm$core$List$concat(
		A2(elm$core$List$map, differencesForPair, postfixList_));
};
var author$project$NetworkMeasure$giniIndex = function (g) {
	var balances = author$project$NetworkMeasure$accountBalances(g);
	var n = elm$core$List$length(balances);
	var meanBalance = elm$core$List$sum(balances) / n;
	var absoluteDifferences = A2(
		elm$core$List$map,
		elm$core$Basics$abs,
...
var author$project$NetworkMeasure$resilience = function (g) {
	...
	return function (x) {
		...
		elm$core$List$sum(
			A2(
				elm$core$List$map,
				A2(author$project$NetworkMeasure$resilienceOfEdge, totalFlow_, g),
				elm_community$graph$Graph$edges(g))));
};
var author$project$NetworkMeasure$alpha = function (g) {
	var eff = author$project$NetworkMeasure$efficiency(g);
	if (_Utils_cmp(
		elm$core$Basics$abs(eff),
		author$project$NetworkMeasure$epsilon) < 0) {
		return author$project$NetworkMeasure$delta;
	} else {
		var ratio = 1 + (author$project$NetworkMeasure$resilience(g) / author$project$NetworkMeasure$efficiency(g));
		return 1 / ratio;
	}
};
var author$project$NetworkMeasure$sustainability = function (g) {
	var a = author$project$NetworkMeasure$alpha(g);
	var aa = A2(elm$core$Basics$pow, a, 1.288);
	return (_Utils_cmp(
		elm$core$Basics$abs(aa),
		author$project$NetworkMeasure$epsilon) < 0) ? author$project$NetworkMeasure$delta : (((-1.844) * aa) * A2(elm$core$Basics$logBase, 2, aa));
};
...
var author$project$NetworkSimulator$measures = function (model) {
...
var author$project$NetworkSimulator$nextHistory_ = function (model) {
	return (_Utils_eq(model.gameState, author$project$NetworkSimulator$Phase2) || (_Utils_eq(model.gameState, author$project$NetworkSimulator$Phase1) && _Utils_eq(
		A2(elm$core$Basics$modBy, model.configuration.gameCycleLength, model.gameClock),
		model.configuration.recruitStep))) ? A2(
		elm$core$List$cons,
...
var author$project$Network$recruitRandom = F3(
	function (numbers, designatedRecruiter, graph) {
		...
		if ((_n0.a.$ === 'Just') && (_n0.b.$ === 'Just')) {
			...
			var freeCurrency = {
				amount: 10,
				currencyType: author$project$Currency$Complementary,
...
var author$project$NetworkSimulator$recruitMoreNodes_ = F2(
	function (model, numbers) {
		var _n0 = _Utils_eq(model.gameState, author$project$NetworkSimulator$Phase1) && _Utils_eq(
			A2(elm$core$Basics$modBy, model.configuration.gameCycleLength, model.gameClock),
			model.configuration.recruitStep);
		if (!_n0) {
...
var author$project$NetworkSimulator$randomUpdate = F2(
	function (model, numbers) {
		...
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{gameState: newGameState, graph: newGraph, grid: newGrid, history: nextHistory, message: message, numberOfTransactionsToDate: model.numberOfTransactionsToDate + deltaTransactions, randomNumberList: numbers}),
			author$project$NetworkSimulator$sendAudioMessage(audioMsg));
	});
var author$project$NetworkSimulator$resetGame = function (model) {
	var _n0 = author$project$Network$setupGraph(author$project$Network$testGraph);
	var forces = _n0.a;
	var graph = _n0.b;
	return _Utils_Tuple2(
		_Utils_update(
...
var author$project$NetworkSimulator$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'Tick':
				var t = msg.a;
				return A2(author$project$NetworkSimulator$handleTick, model, t);
			case 'GameTick':
				var t = msg.a;
			...
			case 'DragEnd':
				var xy = msg.a;
				return A2(author$project$NetworkSimulator$handleDragEnd, model, xy);
			case 'SetGraphBehavior':
				var behavior = msg.a;
				return A2(
					author$project$NetworkSimulator$putCmd,
					elm$core$Platform$Cmd$none,
			...
			case 'AdvanceGameState':
				return author$project$NetworkSimulator$advanceGameState(model);
			case 'ReHeat':
				return A2(
					author$project$NetworkSimulator$putCmd,
					elm$core$Platform$Cmd$none,
			...
			case 'GotRandomNumbers':
				var numbers = msg.a;
				return A2(author$project$NetworkSimulator$randomUpdate, model, numbers);
			case 'SetDisplayMode':
				...
				return _Utils_Tuple2(
					...
					elm$core$Platform$Cmd$none);
			case 'ResetGame':
				return author$project$NetworkSimulator$resetGame(model);
			case 'CellGrid':
				var msg_ = msg.a;
				return A2(author$project$NetworkSimulator$handleMouseClickInGrid, model, msg_);
			default:
				var c = model.configuration;
				var _n1 = c.expiration;
				if (_n1.$ === 'Infinite') {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								configuration: _Utils_update(
									c,
									{
										expiration: author$project$Currency$Finite(100)
									})
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								configuration: _Utils_update(
									c,
									{expiration: author$project$Currency$Infinite})
							}),
						elm$core$Platform$Cmd$none);
				}
		}
	});
var author$project$Network$accountList = function (graph) {
	return A2(
		elm$core$List$map,
		function (n) {
			return _Utils_Tuple2(
...
var author$project$NetworkSimulator$barGraphAttributes = {
	graphHeight: 70,
	graphWidth: 300,
	options: _List_fromArray(
		[
			jxxcarlson$elm_graph$SimpleGraph$Color('rgb(200,0,0)'),
			jxxcarlson$elm_graph$SimpleGraph$DeltaX(15),
...
var jxxcarlson$elm_graph$SimpleGraph$buildSVGTransformString = function (ga) {
	var _n0 = jxxcarlson$elm_graph$SimpleGraph$scale(ga.options);
	var kx = _n0.a;
	var ky = _n0.b;
...
var author$project$NetworkSimulator$accountChart = function (graph) {
...
var author$project$NetworkSimulator$accountDisplay = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						mdgriffith$elm_ui$Element$moveLeft(48)
					]),
				_List_fromArray(
					[
						author$project$NetworkSimulator$accountChart(model.graph)
					])),
				A2(
				mdgriffith$elm_ui$Element$row,
				_List_fromArray(
...
var author$project$NetworkSimulator$displayMeasures = function (model) {
	var m = author$project$NetworkSimulator$measures(model);
	return A2(
		mdgriffith$elm_ui$Element$row,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_Nil,
				mdgriffith$elm_ui$Element$text(
					'tf: ' + elm$core$String$fromFloat(m.totalFlow))),
				A2(
				mdgriffith$elm_ui$Element$el,
				_List_Nil,
				mdgriffith$elm_ui$Element$text(
					'gini: ' + elm$core$String$fromFloat(m.gini))),
				A2(
				mdgriffith$elm_ui$Element$el,
				_List_Nil,
				mdgriffith$elm_ui$Element$text(
					'sus: ' + elm$core$String$fromFloat(m.sustainability))),
				A2(
				mdgriffith$elm_ui$Element$el,
				_List_Nil,
				mdgriffith$elm_ui$Element$text(
					'eff: ' + elm$core$String$fromFloat(m.efficiency))),
				A2(
				mdgriffith$elm_ui$Element$el,
				_List_Nil,
				mdgriffith$elm_ui$Element$text(
...
var author$project$NetworkSimulator$startOverButton = function (model) {
	return A2(
				...
				])),
		{
			...
			onPress: elm$core$Maybe$Just(author$project$NetworkSimulator$AdvanceGameState)
		});
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				author$project$NetworkSimulator$displayMeasures(model)
			]));
};
...
var author$project$NetworkSimulator$displayGraphButton = function (model) {
	return A2(
		...
		author$project$NetworkSimulator$buttonStyle(
			_List_fromArray(
				[
					author$project$NetworkSimulator$activeBackground(
					_Utils_eq(model.displayMode, author$project$NetworkSimulator$DisplayGraph))
				])),
		{
			label: A2(
				mdgriffith$elm_ui$Element$el,
...
var author$project$NetworkSimulator$ToggleCurrencyExpiration = {$: 'ToggleCurrencyExpiration'};
var author$project$NetworkSimulator$displayCurrencyType = function (model) {
	var _n0 = model.configuration.expiration;
	if (_n0.$ === 'Infinite') {
		return 'Currency does not expire';
	} else {
		var k = _n0.a;
		return 'Currency expires after ' + (elm$core$String$fromInt(k) + ' ticks');
	}
};
var author$project$NetworkSimulator$setCurrencyButton = function (model) {
	return A2(
		mdgriffith$elm_ui$Element$Input$button,
		author$project$NetworkSimulator$buttonStyle(
			_List_fromArray(
				[
					author$project$NetworkSimulator$activeBackground(
					_Utils_eq(model.displayMode, author$project$NetworkSimulator$DisplayGrid))
				])),
		{
			label: A2(
				mdgriffith$elm_ui$Element$el,
				...
				mdgriffith$elm_ui$Element$text(
					author$project$NetworkSimulator$displayCurrencyType(model))),
			onPress: elm$core$Maybe$Just(author$project$NetworkSimulator$ToggleCurrencyExpiration)
		});
};
			...
			[
				...
				_List_fromArray(
					[
						...
						author$project$NetworkSimulator$setCurrencyButton(model)
					]))
			]));
};
...
var jxxcarlson$elm_graph$SimpleGraph$boundingBox = F2(
	function (options, dw) {
		...
		if ((!_n0.a) && (!_n0.b)) {
			...
			return _List_fromArray(
				[
					_Utils_Tuple2(dw.xMin, dw.yMin),
					_Utils_Tuple2(dw.xMax, dw.yMin),
					_Utils_Tuple2(dw.xMax, dw.yMax),
					_Utils_Tuple2(dw.xMin, dw.yMax),
					_Utils_Tuple2(dw.xMin, dw.yMin)
				]);
		}
	});
var jxxcarlson$elm_graph$SimpleGraph$getScaleFactor = F2(
	function (dataWindow, gA) {
		var ky = gA.graphHeight / (dataWindow.yMax - dataWindow.yMin);
		var kx = gA.graphWidth / (dataWindow.xMax - dataWindow.xMin);
...
var jxxcarlson$elm_graph$SimpleGraph$makeXLabel = F3(
	function (_n0, dw, x) {
		...
		var dx = elm$core$String$fromFloat(kx * (x - dw.xMin));
		return A2(
			elm$svg$Svg$text_,
			_List_fromArray(
				[
			...
			return function (x) {
				...
				A2(
					...
					A2(
						elm$core$List$map,
						function (k) {
							return dw.xMin + ((k * (dw.xMax - dw.xMin)) / (n - 1));
						},
						A2(elm$core$List$range, 0, n - 1))));
		}
	});
...
var jxxcarlson$elm_graph$SimpleGraph$makeXTickMark = F3(
	function (ky, dw, x) {
		return _List_fromArray(
			[
				_Utils_Tuple2(x, dw.yMin),
				_Utils_Tuple2(x, dw.yMin - (jxxcarlson$elm_graph$SimpleGraph$tickMarkLength / ky))
			]);
	});
...
var jxxcarlson$elm_graph$SimpleGraph$makeYLabel = F3(
	function (_n0, dw, y) {
		...
		var label = elm$core$String$fromFloat(
			A2(jxxcarlson$elm_graph$SimpleGraph$roundTo, 1, y));
		var dy = elm$core$String$fromFloat((ky * (y - dw.yMin)) - 3);
		return A2(
			elm$svg$Svg$text_,
			_List_fromArray(
				[
			...
			return function (x) {
				...
				A2(
					...
					A2(
						elm$core$List$map,
						function (k) {
							return dw.yMin + ((k * (dw.yMax - dw.yMin)) / (n - 1));
						},
						A2(elm$core$List$range, 0, n - 1))));
		}
	});
var jxxcarlson$elm_graph$SimpleGraph$makeYTickMark = F3(
	function (kx, dw, y) {
		return _List_fromArray(
			[
				_Utils_Tuple2(dw.xMin, y),
				_Utils_Tuple2(dw.xMin - (jxxcarlson$elm_graph$SimpleGraph$tickMarkLength / kx), y)
			]);
	});
...
var jxxcarlson$elm_graph$SimpleGraph$lineChartAsSVGWithDataWindow = F3(
	function (dw, ga, data) {
		...
		var xLabels = A3(
			...
			scaleFactor,
			dw,
			jxxcarlson$elm_graph$SimpleGraph$xTickmarks(ga.options));
		var yLabels = A3(
			jxxcarlson$elm_graph$SimpleGraph$makeYLabels,
			scaleFactor,
			dw,
			jxxcarlson$elm_graph$SimpleGraph$yTickmarks(ga.options));
		...
		var boundingBox_ = renderPlain(
			A2(jxxcarlson$elm_graph$SimpleGraph$boundingBox, ga.options, dw));
		var abscissa = renderPlain(
			_List_fromArray(
				[
					_Utils_Tuple2(dw.xMin, 0),
					_Utils_Tuple2(dw.xMax, 0)
				]));
		return A2(
			elm$svg$Svg$g,
			_List_fromArray(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					elm$core$String$fromFloat(ga.graphHeight + 40)),
					elm$svg$Svg$Attributes$width(
					elm$core$String$fromFloat(ga.graphWidth + 50)),
					elm$svg$Svg$Attributes$viewBox(
					'-40 -20 ' + (elm$core$String$fromFloat(ga.graphWidth + 50) + (' ' + elm$core$String$fromFloat(ga.graphHeight + 40))))
				]),
			_List_fromArray(
				[
...
var author$project$NetworkSimulator$giniChart = function (model) {
...
var author$project$NetworkSimulator$linkElement = F3(
	function (model, graph, edge) {
		var target = A2(
			elm$core$Maybe$withDefault,
		...
		var color = (_Utils_cmp(
			...
			model.configuration.epsilon) < 0) ? A3(avh4$elm_color$Color$rgb255, 255, 255, 255) : A3(avh4$elm_color$Color$rgb255, 0, 0, 255);
		return A2(
			elm_community$typed_svg$TypedSvg$line,
			_List_fromArray(
				[
					elm_community$typed_svg$TypedSvg$Attributes$InPx$strokeWidth(
					author$project$Network$absoluteEdgeFlow(edge) + 1),
...
var author$project$NetworkSimulator$nodeColorizer = function (node) {
	var _n0 = node.label.value.status;
	if (_n0.$ === 'NotRecruited') {
		return elm_community$typed_svg$TypedSvg$Attributes$fill(
			elm_community$typed_svg$TypedSvg$Types$Fill(
				A3(avh4$elm_color$Color$rgb255, 0, 0, 255)));
	} else {
		var _n1 = node.label.value.parentGraphId;
		switch (_n1) {
			case 100:
				return elm_community$typed_svg$TypedSvg$Attributes$fill(
					elm_community$typed_svg$TypedSvg$Types$Fill(
						A3(avh4$elm_color$Color$rgb255, 244, 65, 238)));
			case 0:
				return elm_community$typed_svg$TypedSvg$Attributes$fill(
					elm_community$typed_svg$TypedSvg$Types$Fill(
						A3(avh4$elm_color$Color$rgb255, 0, 180, 0)));
			case 1:
				return elm_community$typed_svg$TypedSvg$Attributes$fill(
					elm_community$typed_svg$TypedSvg$Types$Fill(
						A3(avh4$elm_color$Color$rgb255, 244, 128, 65)));
			default:
				return elm_community$typed_svg$TypedSvg$Attributes$fill(
					elm_community$typed_svg$TypedSvg$Types$Fill(
						A3(avh4$elm_color$Color$rgb255, 244, 65, 238)));
...
var author$project$NetworkSimulator$nodeShape = F3(
	function (node, mouseHandler, accBal) {
		var _n0 = node.label.value.role;
		if (_n0.$ === 'Unemployed') {
			return elm_community$typed_svg$TypedSvg$circle(
				_List_fromArray(
					[
						elm_community$typed_svg$TypedSvg$Attributes$InPx$r(12.0 + (accBal / 2.5)),
						author$project$NetworkSimulator$nodeColorizer(node),
			...
			var r = 24.0 + (accBal / 2.5);
			return elm_community$typed_svg$TypedSvg$rect(
				_List_fromArray(
					[
						elm_community$typed_svg$TypedSvg$Attributes$width(
						...
						elm_community$typed_svg$TypedSvg$Attributes$InPx$strokeWidth(7),
						mouseHandler(node.id),
						elm_community$typed_svg$TypedSvg$Attributes$InPx$x(node.label.x - 15),
						elm_community$typed_svg$TypedSvg$Attributes$InPx$y(node.label.y - 12)
					]));
		}
	});
	...
	function (model, node) {
		...
		return A2(
			...
			_List_fromArray(
				[
					A4(
					author$project$NetworkSimulator$nodeShape,
					node,
					mouseHandler,
					accBal,
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									A2(elm_community$typed_svg$TypedSvg$Types$Translate, node.label.x - 6, node.label.y + 3)
								])),
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					A2(
						elm$core$List$map,
						A2(author$project$NetworkSimulator$linkElement, model, model.graph),
...
var author$project$CellGrid$renderCell = F3(
	function (cr, cellGrid, _n0) {
		...
		var color = A2(
			elm$core$Maybe$withDefault,
			cr.defaultColor,
			A2(elm$core$Maybe$map, cr.cellColorizer, cell));
		var txt = function () {
			var _n1 = cr.text;
			if (_n1.$ === 'Nothing') {
				return '';
...
var author$project$NetworkSimulator$cellRenderer = {
	cellColorizer: function (cell) {
		var _n0 = cell.status;
		switch (_n0.$) {
			case 'Recruited':
				var _n1 = cell.parentGraphId;
				switch (_n1) {
					case 100:
	...
	gridLineColor: A3(avh4$elm_color$Color$rgb, 0.5, 0.5, 0.5),
	gridLineWidth: 0.5,
...
var author$project$NetworkSimulator$main = elm$browser$Browser$element(
	{
		init: author$project$NetworkSimulator$init,
		subscriptions: author$project$NetworkSimulator$subscriptions,
		update: F2(
			function (msg, model) {
				return A2(author$project$NetworkSimulator$update, msg, model);
			}),
		view: author$project$NetworkSimulator$view
	});
