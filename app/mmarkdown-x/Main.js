...
var author$project$Main$init = function (flags) {
	var model = {counter: 0, option: author$project$Option$ExtendedMath, seed: 0, sourceText: author$project$Strings$initialText};
...
var author$project$Option$Extended = {$: 'Extended'};
var author$project$Option$Standard = {$: 'Standard'};
		...
		switch (msg.$) {
			...
			case 'SelectStandard':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{option: author$project$Option$Standard}),
					elm$core$Platform$Cmd$none);
			case 'SelectExtended':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{option: author$project$Option$Extended}),
					elm$core$Platform$Cmd$none);
			default:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{option: author$project$Option$ExtendedMath}),
					elm$core$Platform$Cmd$none);
		}
	});
		...
		return A2(
			...
			_Utils_ap(
				...
				A4(
					...
					_Utils_eq(model.option, author$project$Option$Extended),
	...
	function (model, width) {
		return A2(
			...
			_Utils_ap(
				...
				A4(
					author$project$Style$buttonStyleSelected,
					_Utils_eq(model.option, author$project$Option$ExtendedMath),
					author$project$Style$colorBlue,
					author$project$Style$colorDarkRed,
					width)),
			_List_fromArray(
...
var author$project$Block$blockLevel = function (_n0) {
	var k = _n0.b;
	return k;
};
var author$project$Block$Block = F3(
	function (a, b, c) {
		return {$: 'Block', a: a, b: b, c: c};
	});
var author$project$Block$changeLevel = F2(
	function (k, _n0) {
		var bt_ = _n0.a;
		var level_ = _n0.b;
		var content_ = _n0.c;
		return A3(author$project$Block$Block, bt_, level_ + k, content_);
	});
var author$project$Block$blockListOfFSM = function (_n0) {
	var blockList_ = _n0.b;
	return blockList_;
};
var author$project$Block$stateOfFSM = function (_n0) {
	var state_ = _n0.a;
	return state_;
};
var author$project$Block$flush = function (fsm) {
	var _n0 = author$project$Block$stateOfFSM(fsm);
	switch (_n0.$) {
		case 'Start':
			return elm$core$List$reverse(
				author$project$Block$blockListOfFSM(fsm));
		case 'Error':
			return elm$core$List$reverse(
				author$project$Block$blockListOfFSM(fsm));
		default:
...
var author$project$Block$rootBlock = A3(
	author$project$Block$Block,
	author$project$BlockType$MarkdownBlock(author$project$BlockType$Root),
	0,
	'DOCUMENT');
var author$project$Block$FSM = F3(
	function (a, b, c) {
		return {$: 'FSM', a: a, b: b, c: c};
	});
var author$project$Block$Start = {$: 'Start'};
var author$project$Block$emptyRegister = {blockStack: _List_Nil, itemIndex1: 0, itemIndex2: 0, itemIndex3: 0, itemIndex4: 0, level: 0};
var author$project$Block$initialFSM = A3(author$project$Block$FSM, author$project$Block$Start, _List_Nil, author$project$Block$emptyRegister);
var author$project$BlockType$TableRow = {$: 'TableRow'};
var author$project$Block$editBlock = function (block) {
	var bt = block.a;
	var lev = block.b;
	var content = block.c;
	return (_Utils_eq(
		bt,
		author$project$BlockType$MarkdownBlock(author$project$BlockType$TableRow)) && (content === 'row')) ? A3(author$project$Block$Block, bt, lev, '') : block;
};
var author$project$Block$Error = {$: 'Error'};
var author$project$Block$InBlock = function (a) {
	return {$: 'InBlock', a: a};
};
var author$project$Block$addLineToBlock = F2(
	function (str, _n0) {
...
var author$project$Block$removePrefix = F2(
...
var author$project$Block$type_ = function (_n0) {
	var bt = _n0.a;
	return bt;
};
var author$project$Block$typeOfState = function (s) {
	switch (s.$) {
		case 'Start':
			return elm$core$Maybe$Nothing;
		case 'InBlock':
...
var author$project$Block$processBalancedBlock = F3(
	function (blockType, line, fsm) {
		...
		if (_Utils_eq(
			...
			author$project$Block$typeOfState(
				author$project$Block$stateOfFSM(fsm)))) {
			var _n0 = author$project$Block$stateOfFSM(fsm);
			if (_n0.$ === 'InBlock') {
				var block_ = _n0.a;
				var line_ = A2(author$project$Block$removePrefix, blockType, line);
				return A3(
					author$project$Block$FSM,
					author$project$Block$Start,
					A2(
						elm$core$List$cons,
						A2(author$project$Block$addLineToBlock, line_, block_),
						blocks_),
					register);
			} else {
				return fsm;
			...
			var _n1 = author$project$Block$stateOfFSM(fsm);
			if (_n1.$ === 'InBlock') {
				var block_ = _n1.a;
				return A3(
					author$project$Block$FSM,
					author$project$Block$InBlock(
						A3(
							author$project$Block$Block,
							blockType,
							author$project$BlockType$level(line),
							line)),
...
var author$project$Block$addLineToState = F2(
	function (str, state_) {
		switch (state_.$) {
			case 'Start':
				return author$project$Block$Start;
			case 'Error':
				return author$project$Block$Error;
			default:
				var block_ = state_.a;
				return author$project$Block$InBlock(
					A2(author$project$Block$addLineToBlock, str, block_));
		}
	});
...
var author$project$Block$addLineToFSM = F2(
	function (str, _n0) {
		var state_ = _n0.a;
		var blocks_ = _n0.b;
		var register = _n0.c;
		switch (state_.$) {
			case 'Start':
				return A3(author$project$Block$FSM, state_, blocks_, register);
			case 'Error':
				return A3(author$project$Block$FSM, state_, blocks_, register);
			default:
				...
				if (_n2.$ === 'Nothing') {
					return A3(
						author$project$Block$FSM,
						A2(author$project$Block$addLineToState, str, state_),
						blocks_,
						register);
				} else {
					var block = _n2.a;
...
var author$project$Block$adjustLevel = function (block) {
	...
	if (_Utils_eq(
		...
		return A3(author$project$Block$Block, blockType, newLevel, content);
	} else {
		return block;
	}
};
var author$project$Block$incrementRegister = F2(
...
var author$project$Block$updateRegisterAndBlockType = F3(
	function (blockType, level_, register) {
		if (author$project$BlockType$isOListItem(blockType)) {
			var _n0 = A2(author$project$Block$incrementRegister, level_, register);
			var index = _n0.a;
			...
			return _Utils_Tuple2(blockType, author$project$Block$emptyRegister);
		}
	});
...
var author$project$BlockType$DisplayCode = {$: 'DisplayCode'};
...
var author$project$BlockType$codeBlock = A2(
	...
	elm$parser$Parser$Advanced$succeed(
		author$project$BlockType$BalancedBlock(author$project$BlockType$DisplayCode)),
...
var author$project$BlockType$parseStandard = elm$parser$Parser$Advanced$oneOf(
	_List_fromArray(
		[author$project$BlockType$tableBlock, author$project$BlockType$imageBlock, author$project$BlockType$mathBlock, author$project$BlockType$unorderedListItemBlock, author$project$BlockType$orderedListItemBlock, author$project$BlockType$quotationBlock, author$project$BlockType$codeBlock, author$project$BlockType$headingBlock, author$project$BlockType$horizontalRuleBlock]));
...
var author$project$Block$addNewMarkdownBlock = F4(
	function (option, currentBlock, line, fsm) {
		...
		var blocks = fsm.b;
		var register = fsm.c;
		var _n0 = A2(author$project$BlockType$get, option, line);
		if (_n0.b.$ === 'Nothing') {
			var _n1 = _n0.b;
			return fsm;
		} else {
			...
			var newLine = A2(author$project$Block$removePrefix, typeOfCurrentBlock, line);
			var _n2 = A3(author$project$Block$updateRegisterAndBlockType, newBlockType_, level, register);
			...
			var newBlock = A3(
				...
				newBlockType,
				level,
				A2(author$project$Block$removePrefix, newBlockType, newLine));
			return A3(
				author$project$Block$FSM,
				author$project$Block$InBlock(newBlock),
				A2(
					elm$core$List$cons,
					author$project$Block$adjustLevel(currentBlock),
					blocks),
				newRegister);
		}
	});
...
var author$project$Block$parseTableRow = F2(
	function (level, str) {
		return A2(
			elm$core$List$map,
			function (s) {
...
var author$project$Block$handleInnerTableRow = F6(
	function (blockTypeOfLine, level, line, state, blocks, register) {
		switch (state.$) {
			case 'Start':
				return A3(author$project$Block$FSM, state, blocks, register);
			case 'Error':
				return A3(author$project$Block$FSM, state, blocks, register);
			default:
				...
				var tableMarker = A3(
					...
					level + 1,
					'deleteMe');
				var rowBlock = A3(author$project$Block$Block, blockTypeOfLine, level + 1, 'row');
				var childrenOfNewBlock = A2(author$project$Block$parseTableRow, level + 2, line);
				...
				return A3(
					author$project$Block$FSM,
					author$project$Block$InBlock(tableMarker),
					blocks,
					_Utils_update(
						register,
						{
...
var author$project$Block$handleTableStart = F6(
	function (blockTypeOfLine, level, line, state, blocks, register) {
		switch (state.$) {
			case 'Start':
				return A3(author$project$Block$FSM, state, blocks, register);
			...
			default:
				...
				return A3(
					author$project$Block$FSM,
					author$project$Block$InBlock(rowBlock),
					blocks,
					_Utils_update(
						register,
...
var author$project$Block$newBlockTypeIsDifferent = F2(
	function (blockType, state) {
		if (state.$ === 'InBlock') {
			var currentBlock = state.a;
			return !_Utils_eq(
				author$project$Block$type_(currentBlock),
				blockType);
		} else {
			return false;
		}
	});
var author$project$Block$handleTableRow = F6(
	function (blockTypeOfLine, level, line, state, blocks, register) {
		return A2(author$project$Block$newBlockTypeIsDifferent, blockTypeOfLine, state) ? A6(author$project$Block$handleTableStart, blockTypeOfLine, level, line, state, blocks, register) : A6(author$project$Block$handleInnerTableRow, blockTypeOfLine, level, line, state, blocks, register);
	});
...
var author$project$Block$processMarkDownBlock = F5(
	function (option, level, blockTypeOfLine, line, fsm) {
		...
		if (state.$ === 'InBlock') {
			...
			var typeOfCurrentBlock = currentBlock.a;
			var levelOfCurrentBlock = currentBlock.b;
			return author$project$BlockType$isBalanced(typeOfCurrentBlock) ? A2(author$project$Block$addLineToFSM, line, fsm) : (_Utils_eq(
				blockTypeOfLine,
				...
				typeOfCurrentBlock,
				author$project$BlockType$MarkdownBlock(author$project$BlockType$TableRow)))) ? A2(author$project$Block$addLineToFSM, line, fsm) : (_Utils_eq(
				blockTypeOfLine,
				author$project$BlockType$MarkdownBlock(author$project$BlockType$TableRow)) ? A6(author$project$Block$handleTableRow, blockTypeOfLine, level, line, state, blocks, register) : A4(author$project$Block$addNewMarkdownBlock, option, currentBlock, line, fsm))));
		} else {
			return fsm;
		}
	});
...
var author$project$Block$nextStateIB = F3(
	function (option, line, fsm) {
		...
		if (_n0.b.$ === 'Nothing') {
			...
			return A3(
				author$project$Block$FSM,
				author$project$Block$Error,
				author$project$Block$blockListOfFSM(fsm),
				register);
		} else {
			var level = _n0.a;
			var blockType = _n0.b.a;
			return author$project$BlockType$isBalanced(blockType) ? A3(author$project$Block$processBalancedBlock, blockType, line, fsm) : (author$project$BlockType$isMarkDown(blockType) ? A5(author$project$Block$processMarkDownBlock, option, level, blockType, line, fsm) : fsm);
		}
	});
var author$project$Block$nextStateS = F3(
	function (option, line, _n0) {
		var state = _n0.a;
		var blocks = _n0.b;
		var register = _n0.c;
		var _n1 = A2(author$project$BlockType$get, option, line);
		if (_n1.b.$ === 'Nothing') {
			var _n2 = _n1.b;
			return A3(author$project$Block$FSM, author$project$Block$Error, blocks, register);
		} else {
			var level = _n1.a;
			var blockType = _n1.b.a;
			var newLine = A2(author$project$Block$removePrefix, blockType, line);
			var _n3 = A3(author$project$Block$updateRegisterAndBlockType, blockType, level, register);
			var newBlockType = _n3.a;
			var newRegister = _n3.b;
			return (_Utils_eq(
				newBlockType,
				author$project$BlockType$MarkdownBlock(author$project$BlockType$TableRow)) && A2(author$project$Block$newBlockTypeIsDifferent, newBlockType, state)) ? A6(author$project$Block$handleTableStart, blockType, level, line, state, blocks, register) : A3(
				author$project$Block$FSM,
				author$project$Block$InBlock(
					A3(author$project$Block$Block, newBlockType, level, newLine)),
				blocks,
				newRegister);
		}
	});
var author$project$Block$nextState = F3(
	function (option, str, fsm) {
		var state = fsm.a;
		var blocks = fsm.b;
		var register = fsm.c;
		var fsm_ = function () {
			var _n1 = elm$core$List$head(register.blockStack);
			if (_n1.$ === 'Nothing') {
				return fsm;
			} else {
				var block = _n1.a;
				var _n2 = author$project$Block$typeOfState(state);
				if (((_n2.$ === 'Just') && (_n2.a.$ === 'MarkdownBlock')) && (_n2.a.a.$ === 'TableRow')) {
					var _n3 = _n2.a.a;
					return fsm;
				} else {
					var tableBlock = A3(
					...
					var tableData = A2(
						elm$core$List$map,
						author$project$Block$editBlock,
						function (x) {
							return _Utils_ap(
								x,
								_List_fromArray(
		...
		switch (_n0.$) {
			case 'Start':
				return A3(author$project$Block$nextStateS, option, str, fsm_);
			case 'InBlock':
				return A3(author$project$Block$nextStateIB, option, str, fsm_);
			default:
				return fsm_;
		}
	});
var elm$core$String$lines = _String_lines;
var author$project$Block$splitIntoLines = function (str) {
	return A2(
		elm$core$List$map,
		function (l) {
			return l + '\n';
...
var author$project$Block$runFSM = F2(
	function (option, str) {
		var folder = F2(
			function (line, fsm) {
				return A3(author$project$Block$nextState, option, line, fsm);
			});
		return A3(
			elm$core$List$foldl,
			folder,
			author$project$Block$initialFSM,
			author$project$Block$splitIntoLines(str));
	});
...
var author$project$Block$parseToBlockTree = F2(
	function (option, str) {
		return A3(
			jxxcarlson$htree$HTree$fromList,
			author$project$Block$rootBlock,
			author$project$Block$blockLevel,
			A2(
				elm$core$List$map,
				author$project$Block$changeLevel(1),
				author$project$Block$flush(
					A2(author$project$Block$runFSM, option, str))));
	});
var author$project$Block$M = function (a) {
	return {$: 'M', a: a};
};
var author$project$Block$MMBlock = F3(
	function (a, b, c) {
		return {$: 'MMBlock', a: a, b: b, c: c};
	});
var author$project$Block$T = function (a) {
	return {$: 'T', a: a};
};
var author$project$MMInline$Stanza = function (a) {
	return {$: 'Stanza', a: a};
};
var author$project$MMInline$Paragraph = function (a) {
	return {$: 'Paragraph', a: a};
};
var author$project$MMInline$BoldText = function (a) {
	return {$: 'BoldText', a: a};
};
var author$project$MMInline$Expecting = function (a) {
	return {$: 'Expecting', a: a};
};
var author$project$MMInline$boldText = A2(
	elm$parser$Parser$Advanced$map,
	author$project$MMInline$BoldText,
	A2(
		elm$parser$Parser$Advanced$map,
					...
					A2(
							...
							A2(
								...
								elm$parser$Parser$Advanced$symbol(
									A2(
										elm$parser$Parser$Advanced$Token,
										'**',
										author$project$MMInline$Expecting('expecting \'**\' to begin bold text')))),
							elm$parser$Parser$Advanced$chompWhile(
								function (c) {
									return !_Utils_eq(
										c,
						...
						elm$parser$Parser$Advanced$symbol(
							A2(
								elm$parser$Parser$Advanced$Token,
								'**',
								author$project$MMInline$Expecting('expecting \'**\' to end bold text')))),
					elm$parser$Parser$Advanced$spaces)))));
var author$project$MMInline$Code = function (a) {
	return {$: 'Code', a: a};
};
...
var author$project$MMInline$code = A2(
	elm$parser$Parser$Advanced$map,
	author$project$MMInline$Code,
	A2(
		elm$parser$Parser$Advanced$map,
						...
						A2(
								...
								A2(
									...
									elm$parser$Parser$Advanced$symbol(
										A2(
											elm$parser$Parser$Advanced$Token,
											'`',
											author$project$MMInline$Expecting('Expecting \'``\' to begin inline code')))),
								elm$parser$Parser$Advanced$chompWhile(
									function (c) {
										return !_Utils_eq(
											c,
							...
							elm$parser$Parser$Advanced$symbol(
								A2(
									elm$parser$Parser$Advanced$Token,
									'`',
									author$project$MMInline$Expecting('Expecting \'``\' to end inline code')))),
						elm$parser$Parser$Advanced$chompWhile(
							function (c) {
								return !_Utils_eq(
									c,
...
var author$project$MMInline$Image = F2(
	function (a, b) {
		return {$: 'Image', a: a, b: b};
	});
var author$project$MMInline$PrefixedString = F2(
	function (prefix, text) {
		return {prefix: prefix, text: text};
	});
var author$project$MMInline$parseWhile = function (accepting) {
	return elm$parser$Parser$Advanced$getChompedString(
		elm$parser$Parser$Advanced$chompWhile(accepting));
};
var author$project$MMInline$image = A2(
	elm$parser$Parser$Advanced$map,
	function (ps) {
		return A2(author$project$MMInline$Image, ps.prefix, ps.text);
	},
	A2(
		elm$parser$Parser$Advanced$keeper,
		A2(
			...
			A2(
				elm$parser$Parser$Advanced$ignorer,
				elm$parser$Parser$Advanced$succeed(author$project$MMInline$PrefixedString),
				elm$parser$Parser$Advanced$symbol(
					A2(
						elm$parser$Parser$Advanced$Token,
						'![',
						author$project$MMInline$Expecting('Expecting \'![\' to begin image block')))),
			A2(
				elm$parser$Parser$Advanced$ignorer,
				author$project$MMInline$parseWhile(
					function (c) {
						return !_Utils_eq(
							c,
							_Utils_chr(']'));
				...
				elm$parser$Parser$Advanced$symbol(
					A2(
						elm$parser$Parser$Advanced$Token,
						'](',
						author$project$MMInline$Expecting('Expecting \'](\' in image block'))))),
		A2(
			elm$parser$Parser$Advanced$ignorer,
			A2(
				elm$parser$Parser$Advanced$ignorer,
				...
				elm$parser$Parser$Advanced$symbol(
					A2(
						elm$parser$Parser$Advanced$Token,
						')',
						author$project$MMInline$Expecting('Expecting \')\' to end image block')))),
			elm$parser$Parser$Advanced$chompWhile(
				function (c) {
					return _Utils_eq(
						c,
...
var author$project$MMInline$ItalicText = function (a) {
	return {$: 'ItalicText', a: a};
};
var author$project$MMInline$italicText = A2(
	elm$parser$Parser$Advanced$map,
	author$project$MMInline$ItalicText,
	A2(
		elm$parser$Parser$Advanced$map,
		elm$core$String$trim,
		A2(
					...
					A2(
							...
							A2(
								...
								elm$parser$Parser$Advanced$symbol(
									A2(
										elm$parser$Parser$Advanced$Token,
										'*',
										author$project$MMInline$Expecting('Expecting \'*\' to begin italic text')))),
							elm$parser$Parser$Advanced$chompWhile(
								function (c) {
									return !_Utils_eq(
										c,
						...
						elm$parser$Parser$Advanced$symbol(
							A2(
								elm$parser$Parser$Advanced$Token,
								'*',
								author$project$MMInline$Expecting('Expecting \'*\' to end italic text')))),
					elm$parser$Parser$Advanced$spaces)))));
var author$project$MMInline$linkLabel = A2(
	elm$parser$Parser$Advanced$keeper,
	A2(
		elm$parser$Parser$Advanced$ignorer,
		elm$parser$Parser$Advanced$succeed(elm$core$Basics$identity),
		elm$parser$Parser$Advanced$symbol(
			A2(
				elm$parser$Parser$Advanced$Token,
				'(',
				author$project$MMInline$Expecting('expecting \'(\' to begin link label')))),
	A2(
		elm$parser$Parser$Advanced$ignorer,
		A2(
			elm$parser$Parser$Advanced$ignorer,
			...
			elm$parser$Parser$Advanced$symbol(
				A2(
					elm$parser$Parser$Advanced$Token,
					')',
					author$project$MMInline$Expecting('expecting \')\' to end link label')))),
		elm$parser$Parser$Advanced$spaces));
var author$project$MMInline$BracketedText = function (a) {
	return {$: 'BracketedText', a: a};
};
var author$project$MMInline$Link = F2(
	function (a, b) {
		return {$: 'Link', a: a, b: b};
	});
var author$project$MMInline$linkOrBracket = function (ps) {
	var _n0 = ps.text;
	if (_n0 === ' ') {
		return author$project$MMInline$BracketedText(ps.prefix);
	} else {
		return A2(author$project$MMInline$Link, ps.text, ps.prefix);
	}
};
var author$project$MMInline$terminateBracket = A2(
	elm$parser$Parser$Advanced$map,
	function (_n0) {
		return ' ';
	},
	elm$parser$Parser$Advanced$succeed(_Utils_Tuple0));
var author$project$MMInline$link = A2(
	elm$parser$Parser$Advanced$map,
	function (ps) {
		return author$project$MMInline$linkOrBracket(ps);
	},
	A2(
		elm$parser$Parser$Advanced$keeper,
		A2(
			...
			A2(
				...
				elm$parser$Parser$Advanced$symbol(
					A2(
						elm$parser$Parser$Advanced$Token,
						'[',
						author$project$MMInline$Expecting('expecting \'[\' to begin link')))),
			A2(
				elm$parser$Parser$Advanced$ignorer,
				author$project$MMInline$parseWhile(
					function (c) {
				...
				elm$parser$Parser$Advanced$symbol(
					A2(
						elm$parser$Parser$Advanced$Token,
						']',
						author$project$MMInline$Expecting('expecting \']\' to end first part of link'))))),
		A2(
			elm$parser$Parser$Advanced$ignorer,
			elm$parser$Parser$Advanced$oneOf(
				_List_fromArray(
					[author$project$MMInline$linkLabel, author$project$MMInline$terminateBracket])),
			elm$parser$Parser$Advanced$spaces)));
var author$project$MMInline$OrdinaryText = function (a) {
...
var author$project$MMInline$ordinaryTextExtended = A2(
	elm$parser$Parser$Advanced$map,
	author$project$MMInline$OrdinaryText,
	elm$parser$Parser$Advanced$getChompedString(
		A2(
			elm$parser$Parser$Advanced$ignorer,
			A2(
				...
				A2(
					...
					author$project$MMInline$Expecting('expecting regular character to begin ordinary text line'))),
			elm$parser$Parser$Advanced$chompWhile(
				function (c) {
					return !A2(
						elm$core$List$member,
...
var author$project$MMInline$StrikeThroughText = function (a) {
	return {$: 'StrikeThroughText', a: a};
};
var author$project$MMInline$strikeThroughText = A2(
	elm$parser$Parser$Advanced$map,
	author$project$MMInline$StrikeThroughText,
	A2(
		elm$parser$Parser$Advanced$map,
		A2(elm$core$String$replace, '~~', ''),
		A2(
					...
					A2(
							...
							A2(
								...
								elm$parser$Parser$Advanced$symbol(
									A2(
										elm$parser$Parser$Advanced$Token,
										'~~',
										author$project$MMInline$Expecting('expecting \'~~\' to begin strikethrough')))),
							elm$parser$Parser$Advanced$chompWhile(
								function (c) {
									return !_Utils_eq(
										c,
						...
						elm$parser$Parser$Advanced$symbol(
							A2(
								elm$parser$Parser$Advanced$Token,
								'~~',
								author$project$MMInline$Expecting('expecting \'~~\' to end strikethrough')))),
					elm$parser$Parser$Advanced$spaces)))));
var author$project$MMInline$inlineExtended = elm$parser$Parser$Advanced$oneOf(
	_List_fromArray(
		[author$project$MMInline$code, author$project$MMInline$image, author$project$MMInline$link, author$project$MMInline$boldText, author$project$MMInline$italicText, author$project$MMInline$strikeThroughText, author$project$MMInline$ordinaryTextExtended]));
var author$project$MMInline$InlineMath = function (a) {
	return {$: 'InlineMath', a: a};
};
var author$project$MMInline$inlineMath = A2(
	elm$parser$Parser$Advanced$map,
	author$project$MMInline$InlineMath,
	A2(
		elm$parser$Parser$Advanced$map,
		elm$core$String$dropRight(1),
		A2(
						...
						A2(
								...
								A2(
									...
									elm$parser$Parser$Advanced$symbol(
										A2(
											elm$parser$Parser$Advanced$Token,
											'$',
											author$project$MMInline$Expecting('Expecting \'$\' to begin inline math')))),
								elm$parser$Parser$Advanced$chompWhile(
									function (c) {
										return !_Utils_eq(
											c,
							...
							elm$parser$Parser$Advanced$symbol(
								A2(
									elm$parser$Parser$Advanced$Token,
									'$',
									author$project$MMInline$Expecting('Expecting \'$\' to end inline math')))),
						elm$parser$Parser$Advanced$chompWhile(
							function (c) {
								return _Utils_eq(
									c,
...
var author$project$MMInline$ordinaryTextExtendedMath = A2(
	elm$parser$Parser$Advanced$map,
	author$project$MMInline$OrdinaryText,
	elm$parser$Parser$Advanced$getChompedString(
		A2(
...
var author$project$MMInline$inlineExtendedMath = elm$parser$Parser$Advanced$oneOf(
	_List_fromArray(
		[author$project$MMInline$code, author$project$MMInline$image, author$project$MMInline$link, author$project$MMInline$boldText, author$project$MMInline$italicText, author$project$MMInline$strikeThroughText, author$project$MMInline$inlineMath, author$project$MMInline$ordinaryTextExtendedMath]));
var author$project$MMInline$ordinaryTextStandard = A2(
	elm$parser$Parser$Advanced$map,
	author$project$MMInline$OrdinaryText,
	elm$parser$Parser$Advanced$getChompedString(
		A2(
...
var author$project$MMInline$inlineStandard = elm$parser$Parser$Advanced$oneOf(
	_List_fromArray(
		[author$project$MMInline$code, author$project$MMInline$image, author$project$MMInline$link, author$project$MMInline$boldText, author$project$MMInline$italicText, author$project$MMInline$ordinaryTextStandard]));
var author$project$MMInline$inline = function (option) {
	switch (option.$) {
		case 'Standard':
			return author$project$MMInline$inlineStandard;
		case 'Extended':
			return author$project$MMInline$inlineExtended;
		default:
			return author$project$MMInline$inlineExtendedMath;
	}
};
...
var author$project$MMInline$manyHelp = F2(
	function (p, vs) {
...
var author$project$MMInline$many = function (p) {
	return A2(
		elm$parser$Parser$Advanced$loop,
		_List_Nil,
		author$project$MMInline$manyHelp(p));
};
var author$project$MMInline$inlineList = function (option) {
	return author$project$MMInline$many(
		author$project$MMInline$inline(option));
};
var author$project$MMInline$Line = function (a) {
	return {$: 'Line', a: a};
};
var author$project$MMInline$displayDeadEnd = function (deadend) {
	var _n0 = deadend.problem;
	var error = _n0.a;
	return error;
};
var author$project$MMInline$decodeInlineError = function (errorList) {
	var errorMessage = A2(
		elm$core$String$join,
		';;\n\n',
		A2(elm$core$List$map, author$project$MMInline$displayDeadEnd, errorList));
	return author$project$MMInline$OrdinaryText(errorMessage);
};
var author$project$MMInline$resolveInlineResult = function (result) {
	if (result.$ === 'Ok') {
		var res_ = result.a;
		return author$project$MMInline$Line(res_);
	} else {
		var list = result.a;
		return author$project$MMInline$decodeInlineError(list);
	}
};
var author$project$MMInline$parseLine = F2(
	function (option, str) {
		return author$project$MMInline$resolveInlineResult(
			A2(
				elm$parser$Parser$Advanced$run,
				author$project$MMInline$inlineList(option),
				str));
	});
...
var author$project$MMInline$endsWithPunctuation = function (str) {
	return A2(
		elm$core$List$member,
...
var author$project$MMInline$wrapper = F2(
	function (str, acc) {
		return (acc.currentString === '') ? {currentString: str, lst: _List_Nil} : (author$project$MMInline$endsWithPunctuation(acc.currentString) ? {
			currentString: str,
...
var author$project$MMInline$wrap = function (strList) {
	return elm$core$List$reverse(
		function (acc) {
			...
			A3(
				elm$core$List$foldl,
				author$project$MMInline$wrapper,
				{currentString: '', lst: _List_Nil},
				strList)));
};
var author$project$MMInline$parse = F2(
	function (option, str) {
		return author$project$MMInline$Paragraph(
			A2(
				elm$core$List$map,
				author$project$MMInline$parseLine(option),
				author$project$MMInline$wrap(
					A2(elm$core$String$split, '\n', str))));
	});
var author$project$Block$mapperExtended = F2(
	function (option_, _n0) {
		...
		if (bt.$ === 'MarkdownBlock') {
			...
			if (mt.$ === 'Poetry') {
				return A3(
					author$project$Block$MMBlock,
					author$project$BlockType$MarkdownBlock(mt),
					level_,
					author$project$Block$M(
						author$project$MMInline$Stanza(content_)));
			} else {
				return A3(
					author$project$Block$MMBlock,
					author$project$BlockType$MarkdownBlock(mt),
					level_,
					author$project$Block$M(
						A2(author$project$MMInline$parse, option_, content_)));
			}
		} else {
			switch (bt.a.$) {
				case 'DisplayCode':
					...
					return A3(
						...
						author$project$BlockType$BalancedBlock(author$project$BlockType$DisplayCode),
						level_,
						author$project$Block$T(content_));
				case 'Verbatim':
					var _n4 = bt.a;
					return A3(
						author$project$Block$MMBlock,
...
var author$project$Block$mapperExtendedMath = F2(
	function (option_, _n0) {
		var bt = _n0.a;
		var level_ = _n0.b;
		var content_ = _n0.c;
...
var author$project$Block$mapperStandard = F2(
	function (option_, _n0) {
		var bt = _n0.a;
		var level_ = _n0.b;
		var content_ = _n0.c;
...
var author$project$Block$selectMapper = F2(
	function (option, block) {
		...
		switch (option.$) {
			case 'Standard':
				return A2(author$project$Block$mapperStandard, option, block);
			case 'Extended':
				return A2(author$project$Block$mapperExtended, option, block);
			default:
				return A2(author$project$Block$mapperExtendedMath, option, block);
		}
	});
...
var author$project$Block$parseToMMBlockTree = F2(
	function (option, str) {
		return A2(
			zwilias$elm_rosetree$Tree$map,
			author$project$Block$selectMapper(option),
			A2(author$project$Block$parseToBlockTree, option, str));
	});
...
var author$project$Markdown$Elm$mathText = function (content) {
	return A3(
		elm$html$Html$node,
		'math-text',
		_List_fromArray(
			[
				elm$html$Html$Attributes$id('math-to-typeset'),
...
var author$project$Markdown$Elm$displayMathText = function (str) {
	var str2 = elm$core$String$trim(str);
	return author$project$Markdown$Elm$mathText('\\[\n' + (str2 + '\n\\]'));
};
var author$project$Markdown$Elm$inlineMathText = function (str) {
	return author$project$Markdown$Elm$mathText(
		'\\(' + (elm$core$String$trim(str) + '\\)'));
};
var author$project$Markdown$Elm$isPunctuation = function (str) {
	return A2(
		elm$core$List$member,
		str,
		_List_fromArray(
...
var author$project$Markdown$Elm$renderStanza = function (arg) {
...
var author$project$Markdown$Elm$strikethrough = function (str) {
	return A2(
		elm$html$Html$span,
		_List_fromArray(
			[
...
var author$project$Markdown$Elm$joinLine = function (items) {
	var folder = F2(
		function (item, acc) {
			if (item.$ === 'OrdinaryText') {
				var str = item.a;
				return author$project$Markdown$Elm$isPunctuation(
					A2(elm$core$String$left, 1, str)) ? A2(
					elm$core$List$cons,
					author$project$Markdown$Elm$renderToHtmlMsg(item),
					acc) : A2(
					elm$core$List$cons,
					A2(
						elm$html$Html$span,
	...
	return elm$core$List$reverse(
		A3(elm$core$List$foldl, folder, _List_Nil, items));
};
var author$project$Markdown$Elm$renderToHtmlMsg = function (mmInline) {
	switch (mmInline.$) {
		case 'OrdinaryText':
			var str = mmInline.a;
			return A2(
		...
		case 'InlineMath':
			var str = mmInline.a;
			return author$project$Markdown$Elm$inlineMathText(str);
		case 'StrikeThroughText':
			var str = mmInline.a;
			return author$project$Markdown$Elm$strikethrough(str);
		case 'BracketedText':
			var str = mmInline.a;
			return A2(
				elm$html$Html$span,
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						elm$html$Html$Attributes$class('mm-image')
					]),
				_List_fromArray(
					[
						elm$html$Html$text(label)
		...
		case 'Line':
			...
			return A2(
				elm$html$Html$span,
				_List_Nil,
				author$project$Markdown$Elm$joinLine(arg));
		case 'Paragraph':
			var arg = mmInline.a;
			return A2(
				elm$html$Html$p,
				...
				A2(elm$core$List$map, author$project$Markdown$Elm$renderToHtmlMsg, arg));
		case 'Stanza':
			var arg = mmInline.a;
			return author$project$Markdown$Elm$renderStanza(arg);
		default:
			var arg = mmInline.a;
			return A2(
				elm$html$Html$p,
...
var author$project$Markdown$Elm$renderBlockContent = function (blockContent) {
	if (blockContent.$ === 'M') {
		var mmInline = blockContent.a;
		return author$project$Markdown$Elm$renderToHtmlMsg(mmInline);
	} else {
...
var author$project$Markdown$Elm$renderHeading = F2(
		...
		switch (k) {
			case 1:
				return A2(
					...
					_List_fromArray(
						[
							author$project$Markdown$Elm$renderBlockContent(blockContent)
						]));
			case 2:
				return A2(
					elm$html$Html$h2,
...
var author$project$Markdown$Elm$alphabet = function (k) {
...
var author$project$Markdown$Elm$prependToParagraph = F2(
	function (head, tail) {
		if (tail.$ === 'T') {
			return tail;
		} else {
			...
			if (mmInLine.$ === 'Paragraph') {
				var lst = mmInLine.a;
				return author$project$Block$M(
					author$project$MMInline$Paragraph(
...
var author$project$Markdown$Elm$romanNumeral = function (k) {
	var alpha = _List_fromArray(
...
var author$project$Markdown$Elm$renderOListItem = F3(
	function (index, k, blockContent) {
		...
		var label = function () {
			switch (k) {
				...
				case 2:
					return author$project$Markdown$Elm$alphabet(index) + '. ';
				case 3:
					return author$project$Markdown$Elm$romanNumeral(index) + '. ';
				case 4:
					return elm$core$String$fromInt(index) + '. ';
				default:
					return 'N. ';
		...
		return A2(
			...
			_List_fromArray(
				[
					author$project$Markdown$Elm$renderBlockContent(
					A2(
						author$project$Markdown$Elm$prependToParagraph,
						author$project$MMInline$OrdinaryText(label),
						blockContent))
				]));
	});
var author$project$Markdown$Elm$renderPoetry = function (blockContent) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
...
var author$project$Markdown$Elm$renderQuotation = function (blockContent) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
...
var author$project$Markdown$Elm$renderUListItem = F2(
	function (k, blockContent) {
		var margin = elm$core$String$fromInt(18 * k) + 'px';
		var label = function () {
			switch (k) {
...
var author$project$Markdown$Elm$renderBlock = function (block) {
	if (block.a.$ === 'BalancedBlock') {
		switch (block.a.a.$) {
			case 'DisplayMath':
				...
				if (blockContent.$ === 'T') {
					var str = blockContent.a;
					return author$project$Markdown$Elm$displayMathText(str);
				} else {
					return author$project$Markdown$Elm$displayMathText('');
				}
			case 'Verbatim':
				var _n11 = block.a.a;
				var level = block.b;
		...
		switch (block.a.a.$) {
			...
			case 'Plain':
				...
				var level = block.b;
				var blockContent = block.c;
				return author$project$Markdown$Elm$renderBlockContent(blockContent);
			case 'Blank':
				var _n3 = block.a.a;
				var level = block.b;
				var blockContent = block.c;
			...
			case 'Heading':
				...
				var level = block.b;
				var blockContent = block.c;
				return A2(author$project$Markdown$Elm$renderHeading, k, blockContent);
			case 'Quotation':
				var _n4 = block.a.a;
				var level = block.b;
				var blockContent = block.c;
				return author$project$Markdown$Elm$renderQuotation(blockContent);
			case 'Poetry':
				var _n5 = block.a.a;
				var level = block.b;
				var blockContent = block.c;
				return author$project$Markdown$Elm$renderPoetry(blockContent);
			case 'UListItem':
				var _n6 = block.a.a;
				var level = block.b;
				var blockContent = block.c;
				return A2(author$project$Markdown$Elm$renderUListItem, level, blockContent);
			case 'OListItem':
				var index = block.a.a.a;
				var level = block.b;
				var blockContent = block.c;
				return A3(author$project$Markdown$Elm$renderOListItem, index, level, blockContent);
			case 'HorizontalRule':
				var _n7 = block.a.a;
				var level = block.b;
				var blockContent = block.c;
...
var author$project$Markdown$Elm$mmBlockTreeToHtml3 = function (tree) {
	if (_Utils_eq(
		...
		return A2(
			...
			_List_fromArray(
				[
					elm$html$Html$Attributes$class('no-children')
				]),
			_List_fromArray(
				[
					author$project$Markdown$Elm$renderBlock(
				...
				switch (_n0.a.a.$) {
					case 'TableRow':
						...
						return A2(
							...
							A2(
								elm$core$List$map,
								author$project$Markdown$Elm$mmBlockTreeToHtml3,
								zwilias$elm_rosetree$Tree$children(tree)));
					case 'Table':
						var _n2 = _n0.a.a;
						return A2(
...
var author$project$Markdown$Elm$toHtml = F2(
	function (option, str) {
		return author$project$Markdown$Elm$mmBlockTreeToHtml3(
			A2(author$project$Block$parseToMMBlockTree, option, str));
	});
var author$project$Style$renderedSourceStyle = A3(author$project$Style$textStyle, '500px', '450px', '#fff');
...
var author$project$Main$renderedSource = function (model) {
	var token = 'renderedText: ' + elm$core$String$fromInt(model.counter);
	return A3(
		...
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				token,
				A2(author$project$Markdown$Elm$toHtml, model.option, model.sourceText))
			]));
};
	...
	function (model, width) {
		return A2(
			...
			_Utils_ap(
				...
				A4(
					author$project$Style$buttonStyleSelected,
					_Utils_eq(model.option, author$project$Option$Standard),
					author$project$Style$colorBlue,
					author$project$Style$colorDarkRed,
					width)),
			_List_fromArray(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text('Edit text below; '),
						elm$html$Html$text('choose Markdown flavor here: '),
