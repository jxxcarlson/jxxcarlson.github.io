...
var author$project$MeenyLatex$LatexState$emptyLatexState = {counters: author$project$MeenyLatex$LatexState$initialCounters, crossReferences: elm$core$Dict$empty, dictionary: elm$core$Dict$empty, tableOfContents: _List_Nil};
...
var author$project$MeenyLatex$StateReducerHelpers$setSectionCounters = F2(
	function (info, latexState) {
		var argList = A2(
			elm$core$List$map,
			author$project$MeenyLatex$ParserTools$list2LeadingString,
			A2(elm$core$List$map, author$project$MeenyLatex$ParserTools$latexList2List, info.value));
...
var author$project$MeenyLatex$ListMachine$nextInternalState = function (internalState_) {
...
var author$project$MeenyLatex$ListMachine$makeReducer = F3(
	function (computeOutput, input, machineState) {
		var nextInternalState_ = author$project$MeenyLatex$ListMachine$nextInternalState(machineState.internalstate);
...
var author$project$MeenyLatex$ListMachine$initialInternalState = function (inputList) {
	return {
		after: elm$core$List$head(
...
var author$project$MeenyLatex$ListMachine$initialMachineState = function (inputList) {
	return {
		internalstate: author$project$MeenyLatex$ListMachine$initialInternalState(inputList),
		outputList: _List_Nil
	};
};
var author$project$MeenyLatex$ListMachine$run_ = F3(
	function (reducer, initialMachineState_, inputList) {
		return A3(elm$core$List$foldl, reducer, initialMachineState_, inputList);
	});
var author$project$MeenyLatex$ListMachine$run = F2(
	function (reducer, inputList) {
		var initialMachineState_ = author$project$MeenyLatex$ListMachine$initialMachineState(inputList);
		var finalState = A3(author$project$MeenyLatex$ListMachine$run_, reducer, initialMachineState_, inputList);
		return elm$core$List$reverse(finalState.outputList);
	});
var author$project$MeenyLatex$ListMachine$runMachine = F2(
	function (outputFunction, inputList) {
		return A2(
			author$project$MeenyLatex$ListMachine$run,
			author$project$MeenyLatex$ListMachine$makeReducer(outputFunction),
			inputList);
	});
...
var author$project$MeenyLatex$Render2$addSpace = function (internalState) {
	var c = A2(
		elm$core$Maybe$withDefault,
		author$project$MeenyLatex$Parser$LXString(''),
		internalState.after);
		...
		switch (_n0.a.$) {
			case 'Macro':
				...
				return A2(
					...
					_List_fromArray(
						['.', ',', '?', '!', ';', ':'])) ? author$project$MeenyLatex$Parser$LXString(str) : author$project$MeenyLatex$Parser$LXString(' ' + str);
			case 'InlineMath':
				var str = _n0.b.a;
				return A2(
					elm$core$List$member,
...
var author$project$MeenyLatex$Render2$makeTocItem = function (tocItem) {
	...
	var id = A2(
		...
		author$project$MeenyLatex$Render2$sectionPrefix(ti.level),
		ti.name);
	var i = tocItem.a;
	var href = 'href=\"#_' + (id + '\"');
...
var author$project$MeenyLatex$Utility$capitalize = function (str) {
	return _Utils_ap(
...
var author$project$MeenyLatex$Render2$renderLatexList = F2(
	function (latexState, latexList) {
		return function (list) {
			...
			A2(author$project$MeenyLatex$ListMachine$runMachine, author$project$MeenyLatex$Render2$addSpace, latexList));
	});
				...
				[
					...
					_List_fromArray(
						[
							elm$html$Html$text(
							_Utils_ap(
								author$project$MeenyLatex$Utility$capitalize(name),
								tnoString))
						])),
					A2(
					elm$html$Html$div,
...
var author$project$Main$init = function (flags) {
	...
	var model = {
		...
		hasMathResult: A2(elm$core$List$map, author$project$MeenyLatex$HasMath$listHasMath, parseResult),
		...
		stopTime: elm$time$Time$millisToPosix(0),
...
var author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 'MathPaper':
				return A2(author$project$Main$useSource, author$project$Source$basicExample, model);
			case 'Grammar':
			...
			default:
				...
				var start = A2(elm$time$Time$toMillis, elm$time$Time$utc, model.startTime);
				var elapsedMilliseconds = stop - start;
				var message = 'Elapsed: ' + elm$core$String$fromFloat(elapsedMilliseconds);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{message: message, stopTime: stopTime}),
					elm$core$Platform$Cmd$none);
		}
	});
...
var author$project$View$basicExampleButton = function (width) {
	return A2(
...
var author$project$View$buttonBarBottomLeft = A2(
	...
	_List_fromArray(
		[
			author$project$View$basicExampleButton(96),
	...
	return A3(
		...
		_List_fromArray(
			[
				...
				elm$html$Html$text(model.sourceText))
			]));
};
...
var author$project$View$ribbonStyle = function (color) {
	return _List_fromArray(
		[
			A2(elm$html$Html$Attributes$style, 'width', '990px'),
...
var author$project$View$textInfo = function (model) {
	...
	var cc = elm$core$String$fromInt(
		elm$core$String$length(model.sourceText)) + ' characters';
...
var author$project$View$headerRibbon = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					elm$html$Html$text('MeenyLatex Demo II')
				])),
...
var author$project$MeenyLatex$Driver$getRenderedText = F2(
	function (macroDefinitions, editRecord) {
		return editRecord.renderedParagraphs;
	});
var author$project$View$renderedSourcePane = function (model) {
	return A2(
		...
		A2(
			...
			A2(author$project$MeenyLatex$Driver$getRenderedText, '', model.editRecord)));
};
...
var author$project$MeenyLatex$RenderLatexForExport$renderImage = function (args) {
	...
	var _n1 = _Utils_Tuple2(imageAttrs._float, imageAttrs.align);
	switch (_n1.a) {
		case 'left':
...
throw 'Some top-level definitions from `MeenyLatex.RenderLatexForExport` are causing infinite recursion:\n\n  ┌─────┐\n  │    macroRenderer\n  │     ↓\n  │    render\n  │     ↓\n  │    renderArg\n  │     ↓\n  │    renderArgList\n  │     ↓\n  │    renderCleanedArgList\n  │     ↓\n  │    renderCode\n  │     ↓\n  │    renderDefaultEnvironment\n  │     ↓\n  │    renderEnvironment\n  │     ↓\n  │    renderEnvironmentDict\n  │     ↓\n  │    renderHref\n  │     ↓\n  │    renderImage\n  │     ↓\n  │    renderItem\n  │     ↓\n  │    renderLatexList\n  │     ↓\n  │    renderListing\n  │     ↓\n  │    renderMacro\n  │     ↓\n  │    renderMacroDict\n  │     ↓\n  │    renderOptArgList\n  │     ↓\n  │    renderSMacro\n  │     ↓\n  │    renderSpecialArgList\n  │     ↓\n  │    reproduceMacro\n  └─────┘\n\nThese errors are very tricky, so read https://elm-lang.org/0.19.0/halting-problem to learn how to fix it!';}
...
var author$project$View$renderedLatexStyle = A4(author$project$View$textStyle3, '545px', '670px', '40px', '#eee');
