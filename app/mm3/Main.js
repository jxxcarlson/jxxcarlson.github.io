...
var author$project$Markdown$Elm$joinLine = function (items) {
	...
	var flush = function (_n1) {
		var accString = _n1.a;
		var accElement = _n1.b;
		if (!_Utils_eq(accString, _List_Nil)) {
			var content = A2(elm$core$String$join, '', accString);
			var span = A2(
				elm$html$Html$span,
...
var author$project$Markdown$Elm$renderToHtmlMsg = function (mmInline) {
	switch (mmInline.$) {
		...
		case 'Line':
			var arg = mmInline.a;
			var joined = author$project$Markdown$Elm$joinLine(arg);
...
var author$project$Markdown$Elm$nameFromBlockContent = function (blockContent) {
...
var author$project$Markdown$Elm$renderHeading = F2(
	function (k, blockContent) {
		var name = author$project$Markdown$Elm$nameFromBlockContent(blockContent);
		switch (k) {
			case 1:
				return A2(
					elm$html$Html$h1,
...
var author$project$Parse$M = function (a) {
	return {$: 'M', a: a};
};
...
var author$project$Markdown$Elm$mmBlockTreeToHtml = function (tree) {
	if (_Utils_eq(
		zwilias$elm_rosetree$Tree$children(tree),
		_List_Nil)) {
		return author$project$Markdown$Elm$renderBlock(
				...
				switch (_n0.a.a.$) {
					case 'TableRow':
						...
						return A2(
							...
							A2(
								elm$core$List$map,
								author$project$Markdown$Elm$mmBlockTreeToHtml,
								zwilias$elm_rosetree$Tree$children(tree)));
					case 'Table':
						var _n2 = _n0.a.a;
						return A2(
...
var author$project$Parse$MDBlock = F3(
	function (a, b, c) {
		return {$: 'MDBlock', a: a, b: b, c: c};
	});
var author$project$Parse$T = function (a) {
	return {$: 'T', a: a};
};
var author$project$Parse$mapperExtended = F2(
	function (option_, _n0) {
		...
		if (bt.$ === 'MarkdownBlock') {
			...
			if (mt.$ === 'Poetry') {
				return A3(
					author$project$Parse$MDBlock,
					author$project$BlockType$MarkdownBlock(mt),
					level_,
					author$project$Parse$M(
			...
			switch (bt.a.$) {
				case 'DisplayCode':
					...
					return A3(
						...
						level_,
						author$project$Parse$T(content_));
				case 'Verbatim':
					var _n4 = bt.a;
					return A3(
						author$project$Parse$MDBlock,
...
var author$project$Parse$mapperExtendedMath = F2(
	function (option_, _n0) {
		var bt = _n0.a;
		var level_ = _n0.b;
		var content_ = _n0.c;
...
var author$project$Parse$mapperStandard = F2(
	function (option_, _n0) {
		var bt = _n0.a;
		var level_ = _n0.b;
		var content_ = _n0.c;
...
var author$project$Parse$selectMapper = F2(
	function (option, block) {
		...
		switch (option.$) {
			case 'Standard':
				return A2(author$project$Parse$mapperStandard, option, block);
			case 'Extended':
				return A2(author$project$Parse$mapperExtended, option, block);
			default:
				return A2(author$project$Parse$mapperExtendedMath, option, block);
		}
	});
var author$project$Parse$blockLevel = function (_n0) {
	var k = _n0.b;
	return k;
};
var author$project$Parse$Block = F3(
	function (a, b, c) {
		return {$: 'Block', a: a, b: b, c: c};
	});
var author$project$Parse$changeLevel = F2(
	function (k, _n0) {
		var bt_ = _n0.a;
		var level_ = _n0.b;
		var content_ = _n0.c;
		return A3(author$project$Parse$Block, bt_, level_ + k, content_);
	});
var author$project$Parse$blockListOfFSM = function (_n0) {
	var blockList_ = _n0.b;
	return blockList_;
};
var author$project$Parse$stateOfFSM = function (_n0) {
	var state_ = _n0.a;
	return state_;
};
var author$project$Parse$flush = function (fsm) {
	var _n0 = author$project$Parse$stateOfFSM(fsm);
	switch (_n0.$) {
		case 'Start':
			return elm$core$List$reverse(
				author$project$Parse$blockListOfFSM(fsm));
		case 'Error':
			return elm$core$List$reverse(
				author$project$Parse$blockListOfFSM(fsm));
		default:
...
var author$project$Parse$rootBlock = A3(
	author$project$Parse$Block,
	author$project$BlockType$MarkdownBlock(author$project$BlockType$Root),
	0,
	'DOCUMENT');
var author$project$Parse$FSM = F3(
	function (a, b, c) {
		return {$: 'FSM', a: a, b: b, c: c};
	});
var author$project$Parse$Start = {$: 'Start'};
var author$project$Parse$emptyRegister = {blockStack: _List_Nil, itemIndex1: 0, itemIndex2: 0, itemIndex3: 0, itemIndex4: 0, level: 0};
var author$project$Parse$initialFSM = A3(author$project$Parse$FSM, author$project$Parse$Start, _List_Nil, author$project$Parse$emptyRegister);
var author$project$BlockType$Table = {$: 'Table'};
var author$project$BlockType$TableRow = {$: 'TableRow'};
var author$project$Parse$editBlock = function (block) {
	var bt = block.a;
	var lev = block.b;
	var content = block.c;
	return (_Utils_eq(
		bt,
		author$project$BlockType$MarkdownBlock(author$project$BlockType$TableRow)) && (content === 'row')) ? A3(author$project$Parse$Block, bt, lev, '') : block;
};
var author$project$Parse$typeOfBlock = function (_n0) {
	var bt = _n0.a;
	return bt;
};
var author$project$Parse$typeOfState = function (s) {
	switch (s.$) {
		case 'Start':
			return elm$core$Maybe$Nothing;
		case 'InBlock':
			...
			return elm$core$Maybe$Just(
				author$project$Parse$typeOfBlock(b));
		default:
			return elm$core$Maybe$Nothing;
	}
};
...
var author$project$Parse$handleRegister = function (fsm) {
	var state = fsm.a;
	var blocks = fsm.b;
	var register = fsm.c;
	...
	if (_n0.$ === 'Nothing') {
		...
		var block = _n0.a;
		var _n1 = author$project$Parse$typeOfState(state);
		if (((_n1.$ === 'Just') && (_n1.a.$ === 'MarkdownBlock')) && (_n1.a.a.$ === 'TableRow')) {
			...
			var tableData = A2(
				elm$core$List$map,
				author$project$Parse$editBlock,
				function (x) {
					return _Utils_ap(
						x,
						_List_fromArray(
			...
			var newBlocks = A2(
				...
				blocks);
			return A3(
				author$project$Parse$FSM,
				author$project$Parse$Start,
...
var author$project$Parse$Error = {$: 'Error'};
var author$project$Parse$InBlock = function (a) {
	return {$: 'InBlock', a: a};
};
var author$project$Parse$addLineToBlock = F2(
	function (line, _n0) {
...
var author$project$Parse$removePrefix = F2(
...
var author$project$Parse$processBalancedBlock = F3(
	function (blockType, line, fsm) {
		...
		if (_Utils_eq(
			...
			author$project$Parse$typeOfState(
				author$project$Parse$stateOfFSM(fsm)))) {
			var _n0 = author$project$Parse$stateOfFSM(fsm);
			if (_n0.$ === 'InBlock') {
				var block_ = _n0.a;
				var line_ = A2(author$project$Parse$removePrefix, blockType, line);
				return A3(
					author$project$Parse$FSM,
					author$project$Parse$Start,
					A2(
						elm$core$List$cons,
						A2(author$project$Parse$addLineToBlock, line_, block_),
						blocks_),
					register);
			} else {
				return fsm;
			...
			var _n1 = author$project$Parse$stateOfFSM(fsm);
			if (_n1.$ === 'InBlock') {
				var block_ = _n1.a;
				return A3(
					author$project$Parse$FSM,
					author$project$Parse$InBlock(
						A3(
							author$project$Parse$Block,
							blockType,
...
var author$project$Parse$addLineToState = F2(
	function (line, state_) {
		switch (state_.$) {
			case 'Start':
				return author$project$Parse$Start;
			case 'Error':
				return author$project$Parse$Error;
			default:
				var block_ = state_.a;
				return author$project$Parse$InBlock(
					A2(author$project$Parse$addLineToBlock, line, block_));
		}
	});
var author$project$Parse$addLineToFSM = F2(
	function (line, _n0) {
		var state_ = _n0.a;
		var blocks_ = _n0.b;
		var register = _n0.c;
		switch (state_.$) {
			case 'Start':
				return A3(author$project$Parse$FSM, state_, blocks_, register);
			case 'Error':
				return A3(author$project$Parse$FSM, state_, blocks_, register);
			default:
				...
				if (_n2.$ === 'Nothing') {
					return A3(
						author$project$Parse$FSM,
						A2(author$project$Parse$addLineToState, line, state_),
						blocks_,
						register);
				} else {
					var block = _n2.a;
...
var author$project$Parse$adjustLevel = function (block) {
	...
	if (_Utils_eq(
		...
		return A3(author$project$Parse$Block, blockType, newLevel, content);
	} else {
		return block;
	}
};
...
var author$project$Parse$incrementRegister = F2(
...
var author$project$Parse$updateRegisterAndBlockType = F3(
	function (blockType, level_, register) {
		if (author$project$BlockType$isOListItem(blockType)) {
			var _n0 = A2(author$project$Parse$incrementRegister, level_, register);
			var index = _n0.a;
			...
			return _Utils_Tuple2(blockType, author$project$Parse$emptyRegister);
		}
	});
var author$project$Parse$addNewMarkdownBlock = F4(
	function (option, currentBlock, line, fsm) {
		...
		if (_n0.b.$ === 'Nothing') {
			...
			var newLine = A2(author$project$Parse$removePrefix, typeOfCurrentBlock, line);
			var _n2 = A3(author$project$Parse$updateRegisterAndBlockType, newBlockType_, level, register);
			...
			var newBlock = A3(
				...
				newBlockType,
				level,
				A2(author$project$Parse$removePrefix, newBlockType, newLine));
			return A3(
				author$project$Parse$FSM,
				author$project$Parse$InBlock(newBlock),
				A2(
					elm$core$List$cons,
					author$project$Parse$adjustLevel(currentBlock),
					blocks),
				newRegister);
		}
	});
var author$project$BlockType$TableCell = {$: 'TableCell'};
var author$project$Parse$parseTableRow = F2(
	function (level, line) {
		return A2(
			elm$core$List$map,
			function (s) {
...
var author$project$Parse$handleInnerTableRow = F6(
	function (blockTypeOfLine, level, line, state, blocks, register) {
		switch (state.$) {
			case 'Start':
				return A3(author$project$Parse$FSM, state, blocks, register);
			case 'Error':
				return A3(author$project$Parse$FSM, state, blocks, register);
			default:
				...
				var tableMarker = A3(
					...
					level + 1,
					'deleteMe');
				var rowBlock = A3(author$project$Parse$Block, blockTypeOfLine, level + 1, 'row');
				var childrenOfNewBlock = A2(author$project$Parse$parseTableRow, level + 2, line);
				...
				return A3(
					author$project$Parse$FSM,
					author$project$Parse$InBlock(tableMarker),
					blocks,
					_Utils_update(
						register,
						{
...
var author$project$Parse$handleTableStart = F6(
	function (blockTypeOfLine, level, line, state, blocks, register) {
		switch (state.$) {
			case 'Start':
				return A3(author$project$Parse$FSM, state, blocks, register);
			...
			default:
				...
				return A3(
					author$project$Parse$FSM,
					author$project$Parse$InBlock(rowBlock),
					blocks,
					_Utils_update(
						register,
...
var author$project$Parse$newBlockTypeIsDifferent = F2(
	function (blockType, state) {
		if (state.$ === 'InBlock') {
			var currentBlock = state.a;
			return !_Utils_eq(
				author$project$Parse$typeOfBlock(currentBlock),
				blockType);
		} else {
			return false;
		}
	});
var author$project$Parse$handleTableRow = F6(
	function (blockTypeOfLine, level, line, state, blocks, register) {
		return A2(author$project$Parse$newBlockTypeIsDifferent, blockTypeOfLine, state) ? A6(author$project$Parse$handleTableStart, blockTypeOfLine, level, line, state, blocks, register) : A6(author$project$Parse$handleInnerTableRow, blockTypeOfLine, level, line, state, blocks, register);
	});
var author$project$Parse$lineIsNotBlank = function (line) {
	return elm$core$String$trim(line) !== '';
};
var author$project$Parse$processMarkDownBlock = F5(
	function (option, level, blockTypeOfLine, line, fsm) {
		...
		if (state.$ === 'InBlock') {
			...
			var typeOfCurrentBlock = currentBlock.a;
			var levelOfCurrentBlock = currentBlock.b;
			return author$project$BlockType$isBalanced(typeOfCurrentBlock) ? A2(author$project$Parse$addLineToFSM, line, fsm) : (_Utils_eq(
				blockTypeOfLine,
				...
				typeOfCurrentBlock,
				author$project$BlockType$MarkdownBlock(author$project$BlockType$TableRow))) && author$project$Parse$lineIsNotBlank(line))) ? A2(author$project$Parse$addLineToFSM, line, fsm) : (_Utils_eq(
				blockTypeOfLine,
				author$project$BlockType$MarkdownBlock(author$project$BlockType$TableRow)) ? A6(author$project$Parse$handleTableRow, blockTypeOfLine, level, line, state, blocks, register) : A4(author$project$Parse$addNewMarkdownBlock, option, currentBlock, line, fsm))));
		} else {
			return fsm;
		}
	});
var author$project$Parse$nextStateInBlock = F3(
	function (option, line, fsm) {
		...
		if (_n0.b.$ === 'Nothing') {
			...
			return A3(
				author$project$Parse$FSM,
				author$project$Parse$Error,
				author$project$Parse$blockListOfFSM(fsm),
				register);
		} else {
			var level = _n0.a;
			var blockType = _n0.b.a;
			return author$project$BlockType$isBalanced(blockType) ? A3(author$project$Parse$processBalancedBlock, blockType, line, fsm) : (author$project$BlockType$isMarkDown(blockType) ? A5(author$project$Parse$processMarkDownBlock, option, level, blockType, line, fsm) : fsm);
		}
	});
var author$project$Parse$nextStateStart = F3(
	function (option, line, fsm) {
		var state = fsm.a;
		var blocks = fsm.b;
		var register = fsm.c;
		...
		if (_n0.b.$ === 'Nothing') {
			var _n1 = _n0.b;
			return A3(author$project$Parse$FSM, author$project$Parse$Error, blocks, register);
		} else {
			var level = _n0.a;
			var blockType = _n0.b.a;
			var newLine = A2(author$project$Parse$removePrefix, blockType, line);
			var _n2 = A3(author$project$Parse$updateRegisterAndBlockType, blockType, level, register);
			var newBlockType = _n2.a;
			var newRegister = _n2.b;
			return (_Utils_eq(
				newBlockType,
				author$project$BlockType$MarkdownBlock(author$project$BlockType$TableRow)) && A2(author$project$Parse$newBlockTypeIsDifferent, newBlockType, state)) ? A6(author$project$Parse$handleTableStart, blockType, level, line, state, blocks, register) : (author$project$Parse$lineIsNotBlank(line) ? A3(
				author$project$Parse$FSM,
				author$project$Parse$InBlock(
					A3(author$project$Parse$Block, newBlockType, level, newLine)),
				blocks,
				newRegister) : fsm);
		}
	});
var author$project$Parse$nextState = F3(
	function (option, line, fsm_) {
		var state = fsm_.a;
		var blocks = fsm_.b;
		var register = fsm_.c;
		var fsm = author$project$Parse$handleRegister(fsm_);
		var _n0 = author$project$Parse$stateOfFSM(fsm);
		switch (_n0.$) {
			case 'Start':
				return A3(author$project$Parse$nextStateStart, option, line, fsm);
			case 'InBlock':
				return A3(author$project$Parse$nextStateInBlock, option, line, fsm);
			default:
				return fsm;
		}
	});
var author$project$Parse$runFSM = F2(
	function (option, lines) {
		var folder = F2(
			function (line, fsm) {
				return A3(author$project$Parse$nextState, option, line, fsm);
			});
		return A3(elm$core$List$foldl, folder, author$project$Parse$initialFSM, lines);
	});
var elm$core$String$lines = _String_lines;
var author$project$Parse$splitIntoLines = function (str) {
	return A2(
		elm$core$List$map,
		function (l) {
			return l + '\n';
...
var author$project$Parse$toBlockTree = F2(
	function (option, document) {
		return A3(
			jxxcarlson$htree$HTree$fromList,
			author$project$Parse$rootBlock,
			author$project$Parse$blockLevel,
			A2(
				elm$core$List$map,
				author$project$Parse$changeLevel(1),
				author$project$Parse$flush(
					A2(
						author$project$Parse$runFSM,
						option,
						author$project$Parse$splitIntoLines(document)))));
	});
...
var author$project$Parse$toMDBlockTree = F2(
	function (option, document) {
		return A2(
			zwilias$elm_rosetree$Tree$map,
			author$project$Parse$selectMapper(option),
			A2(author$project$Parse$toBlockTree, option, document));
	});
		...
		return function (x) {
			...
			A2(
				...
				zwilias$elm_rosetree$Tree$children(
					A2(author$project$Parse$toMDBlockTree, option, str))));
	});
