...
var $author$project$DemoSimple$DocAbout = {$: 'DocAbout'};
var $author$project$AppText$about = '\nA bunch of test files here.\n\n**Main Problems:**\n\n- Performance: laggy over 1500 words\n\n';
var $jxxcarlson$elm_text_editor$Editor$Config$DontWrap = {$: 'DontWrap'};
var $author$project$DemoSimple$EditorMsg = function (a) {
	return {$: 'EditorMsg', a: a};
};
var $author$project$DemoSimple$config = {
	editorMsg: $author$project$DemoSimple$EditorMsg,
	fontProportion: 0.75,
	height: 480,
	lineHeight: 16.0,
...
var $jxxcarlson$elm_text_editor$Editor$Update$scrollToText = F3(
...
var $jxxcarlson$elm_text_editor$Editor$scrollToString = F2(
	function (str, _v0) {
		var data = _v0.a;
		var _v1 = A3($jxxcarlson$elm_text_editor$Editor$Update$scrollToText, str, data.state, data.buffer);
		var is = _v1.a;
		var b = _v1.b;
		return $jxxcarlson$elm_text_editor$Editor$Editor(
			{buffer: b, state: is});
	});
var $author$project$DemoSimple$highlightText = F2(
	function (str, model) {
		var newEditor = A2($jxxcarlson$elm_text_editor$Editor$scrollToString, str, model.editor);
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{editor: newEditor}),
...
var $author$project$DemoSimple$load = F3(
	function (wrapOption, text, model) {
		var newEditor = A3($jxxcarlson$elm_text_editor$Editor$load, wrapOption, text, model.editor);
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{editor: newEditor}),
			...
			case 'EditorMsg':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{editor: editor}),
					A2($elm$core$Platform$Cmd$map, $author$project$DemoSimple$EditorMsg, cmd));
			case 'Test':
				return A3($author$project$DemoSimple$load, $jxxcarlson$elm_text_editor$Editor$Config$DontWrap, $jxxcarlson$elm_text_editor$Editor$Strings$info, model);
			case 'GetSpeech':
				return A3(
					$author$project$DemoSimple$load,
					$jxxcarlson$elm_text_editor$Editor$Config$DoWrap,
					$author$project$AppText$gettysburgAddress,
					_Utils_update(
						model,
						{document: $author$project$DemoSimple$DocGettysburg}));
			case 'Get500':
				return A3(
					$author$project$DemoSimple$load,
					$jxxcarlson$elm_text_editor$Editor$Config$DontWrap,
					$author$project$AppText$words500,
					_Utils_update(
						model,
						{document: $author$project$DemoSimple$Doc500}));
			case 'Get1000':
				return A3(
					$author$project$DemoSimple$load,
					$jxxcarlson$elm_text_editor$Editor$Config$DontWrap,
					$author$project$AppText$words1000,
					_Utils_update(
						model,
						{document: $author$project$DemoSimple$Doc1000}));
			case 'Get1500':
				return A3(
					$author$project$DemoSimple$load,
					$jxxcarlson$elm_text_editor$Editor$Config$DontWrap,
					$author$project$AppText$words1500,
					_Utils_update(
						model,
						{document: $author$project$DemoSimple$Doc1500}));
			case 'Get3000':
				return A3(
					$author$project$DemoSimple$load,
					$jxxcarlson$elm_text_editor$Editor$Config$DontWrap,
					$author$project$AppText$words3000,
					_Utils_update(
						model,
						{document: $author$project$DemoSimple$Doc3000}));
			case 'Jabberwocky':
				return A3(
					$author$project$DemoSimple$load,
					$jxxcarlson$elm_text_editor$Editor$Config$DontWrap,
					$author$project$AppText$jabberwocky,
					_Utils_update(
						model,
						{document: $author$project$DemoSimple$DocJabberWock}));
			case 'About':
				return A3(
					$author$project$DemoSimple$load,
					$jxxcarlson$elm_text_editor$Editor$Config$DontWrap,
					$author$project$AppText$about,
					_Utils_update(
						model,
						{document: $author$project$DemoSimple$DocAbout}));
			case 'Code':
				return A3(
					$author$project$DemoSimple$load,
					$jxxcarlson$elm_text_editor$Editor$Config$DontWrap,
					$author$project$AppText$code,
					_Utils_update(
						model,
						{document: $author$project$DemoSimple$DocCode}));
			case 'FindTreasure':
				return A2($author$project$DemoSimple$highlightText, 'treasure', model);
			default:
...
var $jxxcarlson$elm_text_editor$Editor$View$ensureNonBreakingSpace = function (_char) {
	return _Utils_eq(
		_char,
		_Utils_chr(' ')) ? $jxxcarlson$elm_text_editor$Editor$View$nonBreakingSpace : _char;
};
...
var $author$project$DemoSimple$About = {$: 'About'};
var $author$project$DemoSimple$highlight = F2(
	function (source, target) {
		var _v0 = _Utils_eq(source, target);
		if (_v0) {
			return _List_fromArray(
				[
					A2($elm$html$Html$Attributes$style, 'background-color', '#900')
				]);
		} else {
			return _List_fromArray(
				[
...
var $author$project$DemoSimple$rowButtonLabelStyle = function (width) {
	return _List_fromArray(
		[
			A2($elm$html$Html$Attributes$style, 'font-size', '12px'),
			A2($elm$html$Html$Attributes$style, 'color', '#eee'),
...
var $author$project$DemoSimple$rowButtonStyle = _List_fromArray(
	[
		A2($elm$html$Html$Attributes$style, 'font-size', '12px'),
		A2($elm$html$Html$Attributes$style, 'border', 'none'),
		A2($elm$html$Html$Attributes$style, 'margin-right', '8px'),
...
var $author$project$DemoSimple$rowButton = F6(
	function (model, width, msg, doc, str, attr) {
		return A2(
			$elm$html$Html$div,
			_Utils_ap($author$project$DemoSimple$rowButtonStyle, attr),
			_List_fromArray(
				[
					A2(
					$elm$html$Html$button,
					_Utils_ap(
						...
						_Utils_ap(
							$author$project$DemoSimple$rowButtonLabelStyle(width),
							A2($author$project$DemoSimple$highlight, doc, model.document))),
					_List_fromArray(
						[
							$elm$html$Html$text(str)
						]))
...
var $author$project$DemoSimple$aboutButton = function (model) {
	return A6($author$project$DemoSimple$rowButton, model, 80, $author$project$DemoSimple$About, $author$project$DemoSimple$DocAbout, 'About', _List_Nil);
};
var $author$project$DemoSimple$Code = {$: 'Code'};
var $author$project$DemoSimple$codeButton = function (model) {
	return A6($author$project$DemoSimple$rowButton, model, 80, $author$project$DemoSimple$Code, $author$project$DemoSimple$DocCode, 'Code', _List_Nil);
};
...
var $author$project$DemoSimple$Jabberwocky = {$: 'Jabberwocky'};
var $author$project$DemoSimple$jabberWockyButton = function (model) {
	return A6($author$project$DemoSimple$rowButton, model, 100, $author$project$DemoSimple$Jabberwocky, $author$project$DemoSimple$DocJabberWock, 'Jabberwocky', _List_Nil);
};
var $author$project$DemoSimple$GetSpeech = {$: 'GetSpeech'};
var $author$project$DemoSimple$speechTextButton = function (model) {
	return A6($author$project$DemoSimple$rowButton, model, 160, $author$project$DemoSimple$GetSpeech, $author$project$DemoSimple$DocGettysburg, 'Gettysburg Address', _List_Nil);
};
var $author$project$DemoSimple$Get1000 = {$: 'Get1000'};
var $author$project$DemoSimple$textButton1000 = function (model) {
	return A6($author$project$DemoSimple$rowButton, model, 100, $author$project$DemoSimple$Get1000, $author$project$DemoSimple$Doc1000, '1000 words', _List_Nil);
};
var $author$project$DemoSimple$Get1500 = {$: 'Get1500'};
var $author$project$DemoSimple$textButton1500 = function (model) {
	return A6($author$project$DemoSimple$rowButton, model, 100, $author$project$DemoSimple$Get1500, $author$project$DemoSimple$Doc1500, '1500 words', _List_Nil);
};
var $author$project$DemoSimple$Get3000 = {$: 'Get3000'};
var $author$project$DemoSimple$textButton3000 = function (model) {
	return A6($author$project$DemoSimple$rowButton, model, 100, $author$project$DemoSimple$Get3000, $author$project$DemoSimple$Doc3000, '3000 words', _List_Nil);
};
var $author$project$DemoSimple$Get500 = {$: 'Get500'};
var $author$project$DemoSimple$textButton500 = function (model) {
	return A6($author$project$DemoSimple$rowButton, model, 100, $author$project$DemoSimple$Get500, $author$project$DemoSimple$Doc500, '500 words', _List_Nil);
};
var $author$project$DemoSimple$footer = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				...
				A2($elm$html$Html$Attributes$style, 'top', '590px'),
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('This editor is based on  '),
						A2(
						$elm$html$Html$a,
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								$elm$html$Html$text(' and is inspired by previous work of ')
							])),
						A2(
						$elm$html$Html$a,
						_List_fromArray(
							[
								$elm$html$Html$Attributes$href('https://discourse.elm-lang.org/t/text-editor-done-in-pure-elm/1365')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('Martin Janiczek')
							]))
					])),
				A2(
				$elm$html$Html$div,
				...
				_List_fromArray(
					[
						$elm$html$Html$text('ctrl-h to toggle help, ctrl-shift-w to wrap all text')
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						$author$project$DemoSimple$aboutButton(model),
						$author$project$DemoSimple$codeButton(model),
						$author$project$DemoSimple$jabberWockyButton(model),
						$author$project$DemoSimple$speechTextButton(model),
						$author$project$DemoSimple$textButton500(model),
						$author$project$DemoSimple$textButton1000(model),
						$author$project$DemoSimple$textButton1500(model),
						$author$project$DemoSimple$textButton3000(model)
					]))
			]));
};
...
var $author$project$DemoSimple$px = function (p) {
	return $elm$core$String$fromFloat(p) + 'px';
};
var $author$project$DemoSimple$title = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
	...
	_List_fromArray(
		[
			$elm$html$Html$text('A Pure Elm Text Editor (Simple)')
		]));
var $author$project$DemoSimple$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				$author$project$DemoSimple$title,
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$style,
						'width',
						$author$project$DemoSimple$px(
							$jxxcarlson$elm_text_editor$Editor$getWidth(model.editor)))
					]),
				_List_fromArray(
					[
						A2($jxxcarlson$elm_text_editor$Editor$embedded, $author$project$DemoSimple$config, model.editor)
					])),
				$author$project$DemoSimple$footer(model)
			]));
};
var $author$project$DemoSimple$main = $elm$browser$Browser$element(
	{init: $author$project$DemoSimple$init, subscriptions: $author$project$DemoSimple$subscriptions, update: $author$project$DemoSimple$update, view: $author$project$DemoSimple$view});
_Platform_export({'DemoSimple':{'init':$author$project$DemoSimple$main(
