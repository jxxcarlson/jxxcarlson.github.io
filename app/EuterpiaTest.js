...
var author$project$Example$bpm = function (model) {
	return A2(
...
var author$project$Songs$s1 = 'c 3 qn, d 3 qn, e 3 qn, f 3  qn, g 3 qn, a 3 qn, b 3 qn, c 4 bn';
var author$project$Songs$s2 = 'c 3 qn, e 3 qn, g 3 qn, d 4 qn | ds 4 qn, df 4 qn, c 4 wn';
...
var author$project$Pitch$tjsStringOfPitchClass = function (pitchClass) {
	switch (pitchClass.$) {
		case 'Cff':
			return 'Bb';
		case 'Cf':
...
var author$project$Pitch$tjsStringOfPitch = function (_n0) {
	...
	var octave = _n0.b;
	return _Utils_ap(
		author$project$Pitch$tjsStringOfPitchClass(pitchClass),
			...
			case 'Sample1':
				return _Utils_Tuple2(
					_Utils_update(
						...
						{
							voice1Music: elm$core$Result$toMaybe(
								author$project$MusicParser$parseSequence(author$project$Songs$s1)),
							voice1String: author$project$Songs$s1
						}),
					elm$core$Platform$Cmd$none);
			case 'Sample2':
				return _Utils_Tuple2(
					_Utils_update(
						...
						{
							voice1Music: elm$core$Result$toMaybe(
								author$project$MusicParser$parseSequence(author$project$Songs$s2)),
							voice1String: author$project$Songs$s2
						}),
					elm$core$Platform$Cmd$none);
			case 'ReadVoice1':
				var str = msg.a;
