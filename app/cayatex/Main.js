...
{
	if (region.cx.by === region.dO.by)
	{
		return 'on line ' + region.cx.by;
	}
	return 'on lines ' + region.cx.by + ' through ' + region.dO.by;
}
	...
	return _Platform_initialize(
		...
		function(sendToApp, initialModel) {
			...
			return _Browser_makeAnimator(initialModel, function(model)
			{
				...
				var doc = view(model);
				var nextNode = _VirtualDom_node('body')(_List_Nil)(doc.fE);
				var patches = _VirtualDom_diff(currNode, nextNode);
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { gD: 'hidden', fQ: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { gD: 'mozHidden', fQ: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { gD: 'msHidden', fQ: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { gD: 'webkitHidden', fQ: 'webkitvisibilitychange' }
		: { gD: 'hidden', fQ: 'visibilitychange' };
}
...
function _Browser_getViewport()
{
	return {
		...
		e9: {
			fe: _Browser_window.pageXOffset,
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {dU: fragment, d2: host, ey: path, eB: port_, eJ: protocol, eK: query};
	});
...
var $elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {fX: col, f1: contextStack, hz: problem, df: row};
	});
...
var $elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			...
			A4($elm$parser$Parser$Advanced$DeadEnd, s.df, s.fX, x, s.h));
	});
...
var $elm$parser$Parser$Advanced$Located = F3(
	function (row, col, context) {
		return {fX: col, h: context, df: row};
	});
var $elm$parser$Parser$Advanced$changeContext = F2(
	function (newContext, s) {
		return {fX: s.fX, h: newContext, j: s.j, am: s.am, df: s.df, hU: s.hU};
	});
		...
		return function (s0) {
			var _v1 = parse(
				A2(
					...
					A2(
						$elm$core$List$cons,
						A3($elm$parser$Parser$Advanced$Located, s0.df, s0.fX, context),
						s0.h),
					s0));
			if (!_v1.$) {
				var p = _v1.a;
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.am, s.df, s.fX, s.hU);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			progress,
			0,
			{fX: newCol, h: s.h, j: s.j, am: newOffset, df: newRow, hU: s.hU});
	};
};
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					...
					0,
					{fX: col, h: s0.h, j: s0.j, am: offset, df: row, hU: s0.hU});
			} else {
...
var $elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5($elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.am, s.df, s.fX, s);
	};
};
...
var $author$project$Parser$Metadata$init = F4(
	function (generation, lineNumber, start, finish) {
		return {fB: lineNumber, bv: generation, a2: '', g$: finish - start, am: start};
	});
...
var $elm$parser$Parser$Advanced$chompIf = F2(
	function (isGood, expecting) {
		return function (s) {
			var newOffset = A3($elm$parser$Parser$Advanced$isSubChar, isGood, s.am, s.hU);
			return _Utils_eq(newOffset, -1) ? A2(
				$elm$parser$Parser$Advanced$Bad,
				false,
				...
				true,
				0,
				{fX: 1, h: s.h, j: s.j, am: s.am + 1, df: s.df + 1, hU: s.hU}) : A3(
				$elm$parser$Parser$Advanced$Good,
				true,
				0,
				{fX: s.fX + 1, h: s.h, j: s.j, am: newOffset, df: s.df, hU: s.hU}));
		};
	});
...
var $elm$parser$Parser$Advanced$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{fX: 1, h: _List_Nil, j: 1, am: 0, df: 1, hU: src});
		if (!_v1.$) {
			var value = _v1.b;
...
var $mdgriffith$elm_ui$Internal$Style$classes = {fh: 'a', cE: 'atv', fk: 'ab', fl: 'cx', fm: 'cy', fn: 'acb', fo: 'accx', fp: 'accy', fq: 'acr', ds: 'al', dt: 'ar', fr: 'at', cF: 'ah', cG: 'av', fv: 's', fy: 'bh', fz: 'b', fF: 'w7', fH: 'bd', fI: 'bdt', bW: 'bn', fJ: 'bs', bY: 'cpe', fU: 'cp', fV: 'cpx', fW: 'cpy', v: 'c', b_: 'ctr', b$: 'cb', b0: 'ccx', ax: 'ccy', bo: 'cl', b1: 'cr', f0: 'ct', f6: 'cptr', f7: 'ctxt', gw: 'fcs', dS: 'focus-within', gy: 'fs', gA: 'g', c_: 'hbh', c1: 'hc', d$: 'he', c2: 'hf', d0: 'hfp', gF: 'hv', gI: 'ic', gK: 'fr', ca: 'lbl', gO: 'iml', gP: 'imlf', gQ: 'imlp', gR: 'implw', gS: 'it', gW: 'i', eg: 'lnk', a5: 'nb', en: 'notxt', hg: 'ol', hh: 'or', aL: 'oq', hm: 'oh', ew: 'pg', ex: 'p', hs: 'ppe', hE: 'ui', df: 'r', hG: 'sb', hH: 'sbx', hI: 'sby', hJ: 'sbt', hP: 'e', hQ: 'cap', hR: 'sev', hZ: 'sk', h3: 't', h4: 'tc', h5: 'w8', h6: 'w2', h7: 'w9', h8: 'tj', cz: 'tja', h9: 'tl', ia: 'w3', ib: 'w5', ic: 'w4', id: 'tr', ie: 'w6', $8: 'w1', ih: 'tun', e7: 'ts', aQ: 'clr', iq: 'u', dm: 'wc', fa: 'we', dn: 'wf', fb: 'wfp', dp: 'wrp'};
...
var $mdgriffith$elm_ui$Element$clipY = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$overflow, $mdgriffith$elm_ui$Internal$Style$classes.fW);
...
var $mdgriffith$elm_ui$Internal$Model$columnClass = $mdgriffith$elm_ui$Internal$Style$classes.fv + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.v);
...
var $mdgriffith$elm_ui$Internal$Model$pageClass = $mdgriffith$elm_ui$Internal$Style$classes.fv + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.ew);
var $mdgriffith$elm_ui$Internal$Model$paragraphClass = $mdgriffith$elm_ui$Internal$Style$classes.fv + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.ex);
var $mdgriffith$elm_ui$Internal$Model$rowClass = $mdgriffith$elm_ui$Internal$Style$classes.fv + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.df);
var $mdgriffith$elm_ui$Internal$Model$singleClass = $mdgriffith$elm_ui$Internal$Style$classes.fv + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.hP);
	...
	switch (style.$) {
		...
		case 8:
			...
			return 'grid-rows-' + (A2(
				...
				$elm$core$String$join,
				'-',
				A2($elm$core$List$map, $mdgriffith$elm_ui$Internal$Model$lengthClassName, template.D)) + ('-space-x-' + ($mdgriffith$elm_ui$Internal$Model$lengthClassName(template.hS.a) + ('-space-y-' + $mdgriffith$elm_ui$Internal$Model$lengthClassName(template.hS.b)))))));
		case 9:
			var pos = style.a;
			return 'gp grid-pos-' + ($elm$core$String$fromInt(pos.df) + ('-' + ($elm$core$String$fromInt(pos.fX) + ('-' + ($elm$core$String$fromInt(pos.it) + ('-' + $elm$core$String$fromInt(pos.c0)))))));
		case 11:
...
var $mdgriffith$elm_ui$Internal$Model$formatBoxShadow = function (shadow) {
	return A2(
		...
		A2(
			...
			_List_fromArray(
				[
					shadow.d8 ? $elm$core$Maybe$Just('inset') : $elm$core$Maybe$Nothing,
					$elm$core$Maybe$Just(
					$elm$core$String$fromFloat(shadow.am.a) + 'px'),
					$elm$core$Maybe$Just(
					$elm$core$String$fromFloat(shadow.am.b) + 'px'),
					$elm$core$Maybe$Just(
					$elm$core$String$fromFloat(shadow.fD) + 'px'),
					$elm$core$Maybe$Just(
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.gF, $mdgriffith$elm_ui$Internal$Style$classes.aQ)) + ':hover',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.gF, $mdgriffith$elm_ui$Internal$Style$classes.aL)) + ':hover',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.gw, $mdgriffith$elm_ui$Internal$Style$classes.aQ)) + ':focus',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.gw, $mdgriffith$elm_ui$Internal$Style$classes.aL)) + ':focus',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
	...
	function (options, rule, maybePseudo) {
		switch (rule.$) {
			...
			case 5:
				...
				var paragraph = '.' + $mdgriffith$elm_ui$Internal$Style$classes.ex;
				var page = '.' + $mdgriffith$elm_ui$Internal$Style$classes.ew;
			...
			case 8:
				...
				var xSpacing = toGridLength(template.hS.a);
				var ySpacing = toGridLength(template.hS.b);
				var rows = function (x) {
				...
				var msColumns = function (x) {
					...
					A2(
						...
						ySpacing,
						A2($elm$core$List$map, toGridLength, template.D)));
				var gapY = 'grid-row-gap:' + (toGridLength(template.hS.b) + ';');
				var gapX = 'grid-column-gap:' + (toGridLength(template.hS.a) + ';');
				...
				var msPosition = A2(
					...
					_List_fromArray(
						[
							...
							'-ms-grid-column-span: ' + ($elm$core$String$fromInt(position.it) + ';')
						]));
				var modernPosition = A2(
					...
					_List_fromArray(
						[
							...
							'grid-column: ' + ($elm$core$String$fromInt(position.fX) + (' / ' + ($elm$core$String$fromInt(position.fX + position.it) + ';')))
						]));
				var _class = '.grid-pos-' + ($elm$core$String$fromInt(position.df) + ('-' + ($elm$core$String$fromInt(position.fX) + ('-' + ($elm$core$String$fromInt(position.it) + ('-' + $elm$core$String$fromInt(position.c0)))))));
...
var $mdgriffith$elm_ui$Internal$Model$renderFontAdjustmentRule = F3(
	function (fontToAdjust, _v0, otherFontName) {
		...
		return A2(
			...
			' ',
			_Utils_ap(
				A3($mdgriffith$elm_ui$Internal$Model$fontRule, name, $mdgriffith$elm_ui$Internal$Style$classes.hQ, capital),
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					'.' + (name + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.hQ + (', ' + ('.' + (name + (' .' + $mdgriffith$elm_ui$Internal$Style$classes.hQ))))))),
					_List_fromArray(
						[
					...
					A2(
					$mdgriffith$elm_ui$Internal$Model$bracket,
					'.' + (name + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.hQ + ('> .' + ($mdgriffith$elm_ui$Internal$Style$classes.h3 + (', .' + (name + (' .' + ($mdgriffith$elm_ui$Internal$Style$classes.hQ + (' > .' + $mdgriffith$elm_ui$Internal$Style$classes.h3)))))))))),
					_List_fromArray(
						[
...
var $mdgriffith$elm_ui$Internal$Model$adjust = F3(
	function (size, height, vertical) {
		return {c0: height / size, bc: size, e8: vertical};
	});
	...
	return _Utils_Tuple2(
		...
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'vertical-align',
				$elm$core$String$fromFloat(converted.e8) + 'em'),
				_Utils_Tuple2(
				'font-size',
					...
					return A3(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class($mdgriffith$elm_ui$Internal$Style$classes.fv + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.hP))
									]))
							]));
			}
		}();
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.fv, $mdgriffith$elm_ui$Internal$Style$classes.hP, $mdgriffith$elm_ui$Internal$Style$classes.b_, $mdgriffith$elm_ui$Internal$Style$classes.ax, $mdgriffith$elm_ui$Internal$Style$classes.fq])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.fv, $mdgriffith$elm_ui$Internal$Style$classes.hP, $mdgriffith$elm_ui$Internal$Style$classes.b_, $mdgriffith$elm_ui$Internal$Style$classes.ax, $mdgriffith$elm_ui$Internal$Style$classes.fo])))
						]),
					_List_fromArray(
						[html])) : html));
			case 1:
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.fv, $mdgriffith$elm_ui$Internal$Style$classes.hP, $mdgriffith$elm_ui$Internal$Style$classes.b_, $mdgriffith$elm_ui$Internal$Style$classes.fp])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.fv, $mdgriffith$elm_ui$Internal$Style$classes.hP, $mdgriffith$elm_ui$Internal$Style$classes.b_, $mdgriffith$elm_ui$Internal$Style$classes.fn])))
						]),
					_List_fromArray(
						[html])) : html));
			default:
...
var $mdgriffith$elm_ui$Internal$Model$textElementClasses = $mdgriffith$elm_ui$Internal$Style$classes.fv + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.h3 + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.dm + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.c1)))));
...
var $mdgriffith$elm_ui$Internal$Model$textElementFillClasses = $mdgriffith$elm_ui$Internal$Style$classes.fv + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.h3 + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.dn + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.c2)))));
...
var $mdgriffith$elm_ui$Internal$Model$createElement = F3(
	function (context, children, rendered) {
					...
					case 1:
						...
						return _Utils_eq(context, $mdgriffith$elm_ui$Internal$Model$asParagraph) ? _Utils_Tuple2(
							A2(
								...
								_Utils_Tuple2(
									key,
									A2(styled.gG, $mdgriffith$elm_ui$Internal$Model$NoStyleSheet, context)),
								htmls),
							$elm$core$List$isEmpty(existingStyles) ? styled.e0 : _Utils_ap(styled.e0, existingStyles)) : _Utils_Tuple2(
							A2(
								$elm$core$List$cons,
								_Utils_Tuple2(
									key,
									A2(styled.gG, $mdgriffith$elm_ui$Internal$Model$NoStyleSheet, context)),
								htmls),
							$elm$core$List$isEmpty(existingStyles) ? styled.e0 : _Utils_ap(styled.e0, existingStyles));
					case 2:
						var str = child.a;
						return _Utils_Tuple2(
							A2(
		...
		if (children.$ === 1) {
			...
			var keyed = _v1.a;
			var styles = _v1.b;
			var newStyles = $elm$core$List$isEmpty(styles) ? rendered.e0 : _Utils_ap(rendered.e0, styles);
			if (!newStyles.b) {
				return $mdgriffith$elm_ui$Internal$Model$Unstyled(
					A5(
						...
						$mdgriffith$elm_ui$Internal$Model$Keyed(
							A3($mdgriffith$elm_ui$Internal$Model$addKeyedChildren, 'nearby-element-pls', keyed, rendered.fS)),
				...
				return $mdgriffith$elm_ui$Internal$Model$Unstyled(
					A5(
						...
						$mdgriffith$elm_ui$Internal$Model$Unkeyed(
							A2($mdgriffith$elm_ui$Internal$Model$addChildren, unkeyed, rendered.fS)),
						$mdgriffith$elm_ui$Internal$Model$NoStyleSheet));
			} else {
				var allStyles = newStyles;
				return $mdgriffith$elm_ui$Internal$Model$Styled(
						...
						switch (location) {
							case 0:
								return A2(
									...
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.a5, $mdgriffith$elm_ui$Internal$Style$classes.hP, $mdgriffith$elm_ui$Internal$Style$classes.fh]));
							case 1:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.a5, $mdgriffith$elm_ui$Internal$Style$classes.hP, $mdgriffith$elm_ui$Internal$Style$classes.fz]));
							case 2:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.a5, $mdgriffith$elm_ui$Internal$Style$classes.hP, $mdgriffith$elm_ui$Internal$Style$classes.hh]));
							case 3:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.a5, $mdgriffith$elm_ui$Internal$Style$classes.hP, $mdgriffith$elm_ui$Internal$Style$classes.hg]));
							case 4:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.a5, $mdgriffith$elm_ui$Internal$Style$classes.hP, $mdgriffith$elm_ui$Internal$Style$classes.gK]));
							default:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.a5, $mdgriffith$elm_ui$Internal$Style$classes.hP, $mdgriffith$elm_ui$Internal$Style$classes.fy]));
						}
					}())
				]),
			_List_fromArray(
				[
					...
					switch (elem.$) {
						...
						default:
							var styled = elem.a;
							return A2(styled.gG, $mdgriffith$elm_ui$Internal$Model$NoStyleSheet, $mdgriffith$elm_ui$Internal$Model$asEl);
					}
				}()
				]));
	});
...
var $mdgriffith$elm_ui$Internal$Model$alignXName = function (align) {
	switch (align) {
		...
		default:
			return $mdgriffith$elm_ui$Internal$Style$classes.cF + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.fl);
	}
};
var $mdgriffith$elm_ui$Internal$Model$alignYName = function (align) {
	switch (align) {
		...
		case 2:
			return $mdgriffith$elm_ui$Internal$Style$classes.cG + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.fk);
		default:
			return $mdgriffith$elm_ui$Internal$Style$classes.cG + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.fm);
	}
};
	...
	switch (h.$) {
		case 0:
			...
			return _Utils_Tuple3(
				...
				$mdgriffith$elm_ui$Internal$Style$classes.d$ + (' ' + name),
				_List_fromArray(
					[
		...
		case 2:
			...
			return (portion === 1) ? _Utils_Tuple3(
				...
				A2($mdgriffith$elm_ui$Internal$Flag$add, $mdgriffith$elm_ui$Internal$Flag$heightFill, $mdgriffith$elm_ui$Internal$Flag$none),
				$mdgriffith$elm_ui$Internal$Style$classes.d0 + (' height-fill-' + $elm$core$String$fromInt(portion)),
				_List_fromArray(
					[
						A3(
						$mdgriffith$elm_ui$Internal$Model$Single,
						$mdgriffith$elm_ui$Internal$Style$classes.fv + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.v + (' > ' + $mdgriffith$elm_ui$Internal$Style$dot(
...
var $mdgriffith$elm_ui$Internal$Model$renderWidth = function (w) {
	switch (w.$) {
		case 0:
			...
			return _Utils_Tuple3(
				$mdgriffith$elm_ui$Internal$Flag$none,
				$mdgriffith$elm_ui$Internal$Style$classes.fa + (' width-px-' + $elm$core$String$fromInt(px)),
				_List_fromArray(
					[
						A3(
						$mdgriffith$elm_ui$Internal$Model$Single,
		...
		case 2:
			...
			return (portion === 1) ? _Utils_Tuple3(
				...
				_List_Nil) : _Utils_Tuple3(
				A2($mdgriffith$elm_ui$Internal$Flag$add, $mdgriffith$elm_ui$Internal$Flag$widthFill, $mdgriffith$elm_ui$Internal$Flag$none),
				$mdgriffith$elm_ui$Internal$Style$classes.fb + (' width-fill-' + $elm$core$String$fromInt(portion)),
				_List_fromArray(
					[
						A3(
						$mdgriffith$elm_ui$Internal$Model$Single,
						$mdgriffith$elm_ui$Internal$Style$classes.fv + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.df + (' > ' + $mdgriffith$elm_ui$Internal$Style$dot(
					...
					case 7:
						...
						if (A2($mdgriffith$elm_ui$Internal$Flag$present, $mdgriffith$elm_ui$Internal$Flag$width, has)) {
							...
							switch (width.$) {
								case 0:
									var px = width.a;
									var $temp$classes = ($mdgriffith$elm_ui$Internal$Style$classes.fa + (' width-px-' + $elm$core$String$fromInt(px))) + (' ' + classes),
										$temp$node = node,
								...
								case 2:
									...
									if (portion === 1) {
										...
										var $temp$classes = classes + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.fb + (' width-fill-' + $elm$core$String$fromInt(portion)))),
											$temp$node = node,
											$temp$has = A2(
											$mdgriffith$elm_ui$Internal$Flag$add,
											$mdgriffith$elm_ui$Internal$Flag$widthFill,
						...
						if (A2($mdgriffith$elm_ui$Internal$Flag$present, $mdgriffith$elm_ui$Internal$Flag$height, has)) {
							...
							switch (height.$) {
								case 0:
									...
									var name = 'height-px-' + val;
									var $temp$classes = $mdgriffith$elm_ui$Internal$Style$classes.d$ + (' ' + (name + (' ' + classes))),
										$temp$node = node,
								...
								case 2:
									...
									if (portion === 1) {
										...
										var $temp$classes = classes + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.d0 + (' height-fill-' + $elm$core$String$fromInt(portion)))),
											$temp$node = node,
											$temp$has = A2(
											$mdgriffith$elm_ui$Internal$Flag$add,
											$mdgriffith$elm_ui$Internal$Flag$heightFill,
					...
					case 9:
						...
						var newStyles = function () {
							switch (elem.$) {
								...
								default:
									var styled = elem.a;
									return _Utils_ap(styles, styled.e0);
							}
						}();
						var $temp$classes = classes,
							$temp$node = node,
...
var $mdgriffith$elm_ui$Internal$Model$optionsToRecord = function (options) {
				...
				case 0:
					...
					if (_v4.$ === 1) {
						return _Utils_update(
							record,
							{
								gF: $elm$core$Maybe$Just(hoverable)
							});
					} else {
						return record;
					}
	...
	return andFinally(
		A3(
			$elm$core$List$foldr,
			combine,
			{gw: $elm$core$Maybe$Nothing, gF: $elm$core$Maybe$Nothing, cg: $elm$core$Maybe$Nothing},
			options));
};
			...
			A2(
				...
				$mdgriffith$elm_ui$Internal$Model$htmlClass(
					A2(
						...
						' ',
						_List_fromArray(
							[$mdgriffith$elm_ui$Internal$Style$classes.hE, $mdgriffith$elm_ui$Internal$Style$classes.fv, $mdgriffith$elm_ui$Internal$Style$classes.hP]))),
...
var $mdgriffith$elm_ui$Element$column = F2(
	function (attrs, children) {
		return A4(
			...
			A2(
				$elm$core$List$cons,
				$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.f0 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bo)),
				A2(
					$elm$core$List$cons,
...
var $mdgriffith$elm_ui$Element$pointer = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$cursor, $mdgriffith$elm_ui$Internal$Style$classes.f6);
		...
		return A4(
			...
			A2(
				...
				A2(
					...
					A2(
						$elm$core$List$cons,
						$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.b0 + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.ax + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.hJ + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.en)))))),
						A2(
							$elm$core$List$cons,
				...
				_Utils_ap(
					_List_fromArray(
						[
							...
							$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.en + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.hs)),
...
var $mdgriffith$elm_ui$Element$Input$textHelper = F3(
	function (textInput, attrs, textOptions) {
				...
				_Utils_ap(
					_List_fromArray(
						[
							...
							$mdgriffith$elm_ui$Internal$Model$Attr(
							$elm$html$Html$Events$onInput(textOptions.hf)),
										...
										if (_v2.$ === 1) {
											...
											return _List_fromArray(
												[
													...
													A3($mdgriffith$elm_ui$Element$Input$renderPlaceholder, place, redistributed.T, textOptions.h3 === ''))
												]);
										}
									}()
									])))),
		...
		return A3(
			...
			A2(
				$elm$core$List$cons,
				A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$cursor, $mdgriffith$elm_ui$Internal$Style$classes.f7),
				A2(
					$elm$core$List$cons,
...
var $mdgriffith$elm_ui$Element$Input$multiline = F2(
	function (attrs, multi) {
		return A3(
			...
			{I: $elm$core$Maybe$Nothing, O: multi.hT, y: $mdgriffith$elm_ui$Element$Input$TextArea},
			attrs,
			{a2: multi.a2, hf: multi.hf, hu: multi.hu, h3: multi.h3});
	});
...
var $author$project$Main$inputText = function (model) {
	return A2(
			...
			]),
		{
			...
			hf: $author$project$Main$InputText,
...
var $folkertdev$elm_paragraph$Paragraph$stepr = F3(
	function (options, w, state) {
		var tot_width = (w + 1) + state.it;
		var width_hd = function (p) {
			return (tot_width - p.it) - 1;
		};
		var waste = function (p) {
			return $folkertdev$elm_paragraph$Paragraph$single(p) ? 0 : (p.bR + A2(
				$elm$core$Basics$pow,
				options.et - width_hd(p),
				2));
		};
		var tot_len = 1 + state.g$;
		var old_width_hd = function (p) {
			return (state.it - p.it) - 1;
		};
		var _new = function (p) {
			return $folkertdev$elm_paragraph$Paragraph$single(p) ? {g$: state.g$, bR: 0, it: state.it} : {
				g$: state.g$,
				bR: p.it + A2(
					$elm$core$Basics$pow,
					options.et - old_width_hd(p),
					2),
				it: state.it
			};
		};
		var k = F2(
			function (p, q) {
				var wq0 = width_hd(q);
				var wp0 = width_hd(p);
				var rq0 = (options.ej - wq0) + 1;
				return ($folkertdev$elm_paragraph$Paragraph$single(q) && (!p.it)) ? A2($elm$core$Basics$min, options.et - wp0, rq0) : ($folkertdev$elm_paragraph$Paragraph$single(q) ? rq0 : A2(
					$elm$core$Basics$min,
					A2(
			...
			while (true) {
				...
				if (_v0.$ === 1) {
					...
					if (_v2.$ === 1) {
						return (_Utils_cmp(
							width_hd(q),
							options.ej) > 0) ? $folkertdev$elm_paragraph$SymmetricList$empty : ps_pq;
					} else {
						var p = _v2.a;
						if ((_Utils_cmp(
							waste(p),
		...
		if (_v6.$ === 1) {
			...
			return {aU: newCandidates, g$: tot_len, it: tot_width};
		}
	});
...
var $folkertdev$elm_paragraph$Paragraph$paragraph = F2(
	function (options, words) {
		var zs = A3(
			...
			A2($elm$core$List$map, options.e$, words));
		if (!zs.b) {
			return _List_Nil;
		} else {
			var first = zs.a;
...
var $author$project$Main$paragraphFormat = {ej: 80, et: 70, e$: $elm$core$String$length};
var $author$project$Main$CYTMsg = function (a) {
	return {$: 5, a: a};
};
var $author$project$Main$initStateWithData = F2(
	function (k, data) {
		return {fB: 0, bv: k, hr: data, hK: '', it: 300};
	});
...
var $jxxcarlson$elm_graph$SimpleGraph$bMakeYLabels = F2(
	function (yMax, ga) {
		var n = $jxxcarlson$elm_graph$SimpleGraph$yTickmarks(ga.hl);
		var _v0 = !n;
		if (_v0) {
...
var $jxxcarlson$elm_graph$SimpleGraph$buildSVGTransformString = function (ga) {
	var _v0 = $jxxcarlson$elm_graph$SimpleGraph$scale(ga.hl);
	var kx = _v0.a;
	var ky = _v0.b;
...
var $jxxcarlson$elm_graph$SimpleGraph$bxTickmarks = function (ga) {
	var dx = $jxxcarlson$elm_graph$SimpleGraph$xTickmarks(ga.hl) * $jxxcarlson$elm_graph$SimpleGraph$deltaX(ga.hl);
...
var $jxxcarlson$elm_graph$SimpleGraph$barChartAsSVG = F2(
	function (ga, data) {
		...
		var barWidth = 0.8 * $jxxcarlson$elm_graph$SimpleGraph$deltaX(ga.hl);
		var gbar = function (_v1) {
			var x = _v1.a;
			var y = _v1.b;
			return A5(
				$jxxcarlson$elm_graph$SimpleGraph$barRect,
				$jxxcarlson$elm_graph$SimpleGraph$lineColor(ga.hl),
				barWidth,
				ga.cX,
				x,
				y);
		...
		var _v0 = A2(
			...
			$jxxcarlson$elm_graph$SimpleGraph$deltaX(ga.hl),
			data);
		var yMax = _v0.a;
...
var $author$project$Widget$Data$bargraph = F5(
	function (renderArgs, name, args, body, sm) {
		...
		var barGraphAttributes = {cX: graphHeight, cY: graphWidth, hl: options};
		return A2(
			$mdgriffith$elm_ui$Element$column,
			_List_Nil,
			_List_fromArray(
...
var $author$project$Render$Elm$image = F5(
	function (renderArgs, name, args, body, meta) {
		var displayWidth = renderArgs.hr.dF.dL;
		var dict = $author$project$CYUtility$keyValueDict(args);
...
var $jxxcarlson$elm_graph$SimpleGraph$lineChartAsSVGWithDataWindow = F3(
	function (dw, ga, data) {
		...
		var xLabels = A3(
			...
			scaleFactor,
			dw,
			$jxxcarlson$elm_graph$SimpleGraph$xTickmarks(ga.hl));
		var yLabels = A3(
			$jxxcarlson$elm_graph$SimpleGraph$makeYLabels,
			scaleFactor,
			dw,
			$jxxcarlson$elm_graph$SimpleGraph$yTickmarks(ga.hl));
		...
		var boundingBox_ = renderPlain(
			A2($jxxcarlson$elm_graph$SimpleGraph$boundingBox, ga.hl, dw));
...
var $author$project$Widget$Data$linegraph = F5(
	function (renderArgs, name, args, body, sm) {
		...
		var lineGraphAttributes = {cX: graphHeight, cY: graphWidth, hl: options};
		return A2(
			$mdgriffith$elm_ui$Element$column,
			_List_Nil,
			_List_fromArray(
					...
					A2(
						...
						A2(
							...
							A2(
								...
								A2(
									$elm$core$List$cons,
									$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.b0 + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.ax + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.eg)))),
									attrs)))))),
			$mdgriffith$elm_ui$Internal$Model$Unkeyed(
				_List_fromArray(
					[label])));
			...
			A3(
				...
				_List_fromArray(
					[
						...
						A4($author$project$Render$Elm$mathText_, displayMode, renderArgs.hK, content, meta))
					])));
	});
...
var $author$project$Widget$Data$scatterplot = F5(
	function (renderArgs, name, args, body, sm) {
		...
		var scatterPlotAttributes = {cX: graphHeight, cY: graphWidth, hl: options};
		return A2(
			$mdgriffith$elm_ui$Element$column,
			_List_Nil,
			_List_fromArray(
...
var $author$project$Render$Elm$renderTocItem = function (tocItem) {
	return A2(
		...
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$Font$color($author$project$Render$Elm$linkColor),
				$author$project$Render$Elm$tocPadding(tocItem.ee)
			]),
		{
		...
		return A2(
			...
			A2(
				...
				A2(
					...
					$elm$core$List$reverse(renderArgs.hr.be))));
	});
	...
	function (renderArgs, name, args, body, meta) {
		...
		if (_v1.$ === 1) {
			if (A2($elm$core$List$member, name, $author$project$Render$Elm$theoremLikeElements)) {
				...
				var _v2 = A2($elm$core$Dict$get, name, renderArgs.hr.cb);
				if (!_v2.$) {
					var macroForm = _v2.a;
					return A2(
...
var $author$project$Parser$Data$defaultConfig = {dz: '#00c', dL: 470, d1: '#fAA', eL: '#a00'};
...
var $author$project$Parser$Document$init = F2(
	function (generation, strList) {
		return {
			...
			u: 0,
			J: 0,
			f8: $author$project$Parser$Data$init($author$project$Parser$Data$defaultConfig),
			bv: generation,
			as: strList,
...
var $author$project$Parser$Metadata$dummy = {fB: 0, bv: 0, a2: '', g$: 0, am: 0};
var $author$project$Parser$RecoveryData$problemWithElement = {
	...
	hp: A4(
		...
		A2(
			...
			$elm$core$Maybe$Nothing),
		$elm$core$Maybe$Nothing),
	hz: $author$project$Parser$Error$ExpectingRightBracket,
	ig: 1
};
		...
		return A2(
			...
			function (r) {
				return _Utils_update(
					r,
					{
						hp: A2($author$project$Parser$RecoveryData$setSourceMap, newSourceMap, r.hp)
					});
			},
...
var $author$project$Parser$Driver$newParsed = F3(
	function (tc_, lxError_, mRecoveryData) {
		if (!mRecoveryData.$) {
			var rd = mRecoveryData.a;
			return A2($elm$core$List$cons, rd.hp, tc_.da);
		} else {
...
var $author$project$Parser$Driver$handleError = F2(
	function (tc_, e) {
		...
		var lxError = A4(
			...
			$elm$core$Maybe$Just(
				{fB: tc_.aq, bv: tc_.bv, a2: '', g$: errorColumn, am: tc_.am + errorColumn}));
		switch (problem.$) {
			case 2:
...
var $author$project$Parser$Driver$packet = {
	gz: $author$project$Parser$Getters$getSource,
	gB: $elm$core$Maybe$Just($author$project$Parser$Driver$handleError),
	gE: $elm$core$Maybe$Nothing,
	gL: $author$project$Parser$Driver$incrementOffset,
	hq: $author$project$Parser$Element$parser
};
...
var $author$project$Parser$Loop$newExpr = F3(
	function (packet, tc_, expr) {
		...
		if ((!_v0.$) && (_v0.a === 'highlight')) {
			var _v1 = packet.gE;
			if (_v1.$ === 1) {
				return A2(packet.gL, tc_.am, expr);
			} else {
				var hl = _v1.a;
				return A2(
					packet.gL,
	...
	function (packet, tc) {
		if ((tc.h3 === '') || (tc.Q > 100)) {
			...
			if (!_v0.$) {
				...
				var data = A2($author$project$Parser$Data$update, parsand, tc.f8);
				return $author$project$Parser$Tool$Loop(
					_Utils_update(
						tc,
						{
							...
							ho: $elm$core$Maybe$Just(parsand),
							da: A2(
								$elm$core$List$cons,
...
var $author$project$Parser$Document$updateData = function (tc) {
	...
	if (_v0.$ === 1) {
		...
		var parsand = _v0.a;
		return A2($author$project$Parser$Data$update, parsand, tc.f8);
	}
};
var $author$project$Parser$Document$pushBlock_ = F2(
	function (line, state) {
		...
		var tc = A4($author$project$Parser$Driver$parseLoop, state.bv, state.aj, state.f8, str);
		return _Utils_update(
			state,
			{
				n: _List_Nil,
				u: 0,
				J: 0,
				f8: $author$project$Parser$Document$updateData(tc),
...
var $elm$parser$Parser$DeadEnd = F3(
	function (row, col, problem) {
		return {fX: col, hz: problem, df: row};
	});
var $elm$parser$Parser$problemToDeadEnd = function (p) {
	return A3($elm$parser$Parser$DeadEnd, p.df, p.fX, p.hz);
};
...
var $author$project$Parser$Document$flush = function (state) {
	...
	var newState = function () {
		if (input === '') {
			...
			var tc_ = A4($author$project$Parser$Driver$parseLoop, state.bv, state.aj, state.f8, input);
...
var $author$project$Parser$Document$popBlockStack = F2(
	function (currentLine_, state) {
		...
		if (!newBlockLevel) {
			...
			var tc_ = A4($author$project$Parser$Driver$parseLoop, state.bv, state.aj, state.f8, input_);
			var tc = _Utils_update(
				tc_,
				{h3: input_});
			return _Utils_update(
...
var $author$project$Main$render = F2(
	function (k, str) {
		var state = A2(
			...
			k,
			$elm$core$String$lines(str));
		var newState = A2($author$project$Main$initStateWithData, k, state.f8);
		return A2(
...
var $author$project$Main$noFocus = {fx: $elm$core$Maybe$Nothing, fG: $elm$core$Maybe$Nothing, hM: $elm$core$Maybe$Nothing};
...
var $author$project$Main$main = $elm$browser$Browser$element(
	{gN: $author$project$Main$init, h$: $author$project$Main$subscriptions, ir: $author$project$Main$update, is: $author$project$Main$view});
