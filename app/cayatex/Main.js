...
{
	if (region.cx.by === region.dN.by)
	{
		return 'on line ' + region.cx.by;
	}
	return 'on lines ' + region.cx.by + ' through ' + region.dN.by;
}
		...
		while (true) {
			if (fromIndex < 0) {
				return A2(
					...
					false,
					{A: nodeList, s: (len / $elm$core$Array$branchFactor) | 0, x: tail});
			} else {
...
var $elm$parser$Parser$Advanced$changeContext = F2(
	function (newContext, s) {
		return {fW: s.fW, h: newContext, j: s.j, am: s.am, df: s.df, hT: s.hT};
	});
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.am, s.df, s.fW, s.hT);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			progress,
			0,
			{fW: newCol, h: s.h, j: s.j, am: newOffset, df: newRow, hT: s.hT});
	};
};
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					...
					0,
					{fW: col, h: s0.h, j: s0.j, am: offset, df: row, hT: s0.hT});
			} else {
...
var $elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5($elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.am, s.df, s.fW, s);
	};
};
...
var $author$project$Parser$Metadata$init = F4(
	function (generation, lineNumber, start, finish) {
		return {fA: lineNumber, bv: generation, a2: '', g_: finish - start, am: start};
	});
...
var $elm$parser$Parser$Advanced$chompIf = F2(
	function (isGood, expecting) {
		return function (s) {
			var newOffset = A3($elm$parser$Parser$Advanced$isSubChar, isGood, s.am, s.hT);
			return _Utils_eq(newOffset, -1) ? A2(
				$elm$parser$Parser$Advanced$Bad,
				false,
				...
				true,
				0,
				{fW: 1, h: s.h, j: s.j, am: s.am + 1, df: s.df + 1, hT: s.hT}) : A3(
				$elm$parser$Parser$Advanced$Good,
				true,
				0,
				{fW: s.fW + 1, h: s.h, j: s.j, am: newOffset, df: s.df, hT: s.hT}));
		};
	});
...
var $elm$parser$Parser$Advanced$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{fW: 1, h: _List_Nil, j: 1, am: 0, df: 1, hT: src});
		if (!_v1.$) {
			var value = _v1.b;
...
var $author$project$Main$init = function (flags) {
	return _Utils_Tuple2(
		{
			Q: 0,
			as: $author$project$Main$initialText,
			cg: 1,
			ba: $author$project$Render$String$renderString($author$project$Main$initialText),
			$7: flags.c0,
			fb: flags.is
		},
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							Q: model.Q + 1,
							as: str,
							ba: $author$project$Render$String$renderString(str)
						}),
					$elm$core$Platform$Cmd$none);
			case 4:
				var mode = msg.a;
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							Q: model.Q + 1,
							as: '',
							ba: $author$project$Render$String$renderString('')
						}),
					$elm$core$Platform$Cmd$none);
			case 3:
				var docName = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						...
						{
							Q: model.Q + 1,
							as: $author$project$Data$get(docName),
							ba: $author$project$Render$String$renderString(
...
var $mdgriffith$elm_ui$Internal$Style$classes = {fg: 'a', cE: 'atv', fj: 'ab', fk: 'cx', fl: 'cy', fm: 'acb', fn: 'accx', fo: 'accy', fp: 'acr', ds: 'al', dt: 'ar', fq: 'at', cF: 'ah', cG: 'av', fu: 's', fx: 'bh', fy: 'b', fE: 'w7', fG: 'bd', fH: 'bdt', bW: 'bn', fI: 'bs', bY: 'cpe', fT: 'cp', fU: 'cpx', fV: 'cpy', v: 'c', b_: 'ctr', b$: 'cb', b0: 'ccx', ax: 'ccy', bo: 'cl', b1: 'cr', f$: 'ct', f5: 'cptr', f6: 'ctxt', gv: 'fcs', dR: 'focus-within', gx: 'fs', gz: 'g', c_: 'hbh', c1: 'hc', d_: 'he', c2: 'hf', d$: 'hfp', gE: 'hv', gH: 'ic', gJ: 'fr', ca: 'lbl', gN: 'iml', gO: 'imlf', gP: 'imlp', gQ: 'implw', gR: 'it', gV: 'i', ef: 'lnk', a5: 'nb', em: 'notxt', hf: 'ol', hg: 'or', aL: 'oq', hl: 'oh', ev: 'pg', ew: 'p', hr: 'ppe', hD: 'ui', df: 'r', hF: 'sb', hG: 'sbx', hH: 'sby', hI: 'sbt', hO: 'e', hP: 'cap', hQ: 'sev', hY: 'sk', h2: 't', h3: 'tc', h4: 'w8', h5: 'w2', h6: 'w9', h7: 'tj', cz: 'tja', h8: 'tl', h9: 'w3', ia: 'w5', ib: 'w4', ic: 'tr', id: 'w6', ie: 'w1', ig: 'tun', e6: 'ts', aQ: 'clr', ip: 'u', dm: 'wc', e9: 'we', dn: 'wf', fa: 'wfp', dp: 'wrp'};
	...
	switch (style.$) {
		...
		case 8:
			...
			return 'grid-rows-' + (A2(
				...
				$elm$core$String$join,
				'-',
				A2($elm$core$List$map, $mdgriffith$elm_ui$Internal$Model$lengthClassName, template.D)) + ('-space-x-' + ($mdgriffith$elm_ui$Internal$Model$lengthClassName(template.hR.a) + ('-space-y-' + $mdgriffith$elm_ui$Internal$Model$lengthClassName(template.hR.b)))))));
		case 9:
			var pos = style.a;
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.gE, $mdgriffith$elm_ui$Internal$Style$classes.aQ)) + ':hover',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.gE, $mdgriffith$elm_ui$Internal$Style$classes.aL)) + ':hover',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.gv, $mdgriffith$elm_ui$Internal$Style$classes.aQ)) + ':focus',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.gv, $mdgriffith$elm_ui$Internal$Style$classes.aL)) + ':focus',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.cE, $mdgriffith$elm_ui$Internal$Style$classes.aQ)) + ':active',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.cE, $mdgriffith$elm_ui$Internal$Style$classes.aL)) + ':active',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
...
var $mdgriffith$elm_ui$Internal$Style$emptyIntermediate = F2(
	function (selector, closing) {
		return {aw: closing, p: _List_Nil, W: _List_Nil, N: selector};
	});
					...
					case 3:
						...
						return _Utils_update(
							rendered,
							{
								p: A2(
									$elm$core$List$cons,
									{aw: '\n}', p: _List_Nil, W: props, N: '@supports (' + (prop + (':' + (value + (') {' + parent.N))))},
									rendered.p)
							});
					case 5:
						var selector = rule.a;
...
var $mdgriffith$elm_ui$Internal$Style$renderCompact = function (styleClasses) {
	...
	var renderClass = function (rule) {
		...
		if (!_v2.b) {
			...
			return rule.N + ('{' + (renderValues(rule.W) + (rule.aw + '}')));
		}
	};
...
var $mdgriffith$elm_ui$Internal$Model$adjust = F3(
	function (size, height, vertical) {
		return {c0: height / size, bc: size, e7: vertical};
	});
...
var $mdgriffith$elm_ui$Internal$Model$convertAdjustment = function (adjustment) {
	var lines = _List_fromArray(
		[adjustment.bm, adjustment.bk, adjustment.br, adjustment.bz]);
	var lineHeight = 1.5;
						...
						switch (location) {
							case 0:
								return A2(
									...
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.a5, $mdgriffith$elm_ui$Internal$Style$classes.hO, $mdgriffith$elm_ui$Internal$Style$classes.fg]));
							case 1:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.a5, $mdgriffith$elm_ui$Internal$Style$classes.hO, $mdgriffith$elm_ui$Internal$Style$classes.fy]));
							case 2:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.a5, $mdgriffith$elm_ui$Internal$Style$classes.hO, $mdgriffith$elm_ui$Internal$Style$classes.hg]));
							case 3:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.a5, $mdgriffith$elm_ui$Internal$Style$classes.hO, $mdgriffith$elm_ui$Internal$Style$classes.hf]));
							case 4:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.a5, $mdgriffith$elm_ui$Internal$Style$classes.hO, $mdgriffith$elm_ui$Internal$Style$classes.gJ]));
							default:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.a5, $mdgriffith$elm_ui$Internal$Style$classes.hO, $mdgriffith$elm_ui$Internal$Style$classes.fx]));
						}
					}())
				]),
			_List_fromArray(
...
var $mdgriffith$elm_ui$Element$column = F2(
	function (attrs, children) {
		return A4(
			...
			A2(
				$elm$core$List$cons,
				$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.f$ + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bo)),
				A2(
					$elm$core$List$cons,
...
var $author$project$Main$clearTextButton = A2(
	...
	$author$project$Main$buttonStyle2,
	{
		...
		bA: $elm$core$Maybe$Just($author$project$Main$ClearText)
	});
...
var $mdgriffith$elm_ui$Element$Input$negateBox = function (box) {
	return {bl: -box.bl, bx: -box.bx, bF: -box.bF, bL: -box.bL};
};
							...
							return _Utils_update(
								els,
								{
									...
									as: A2(
										$elm$core$List$cons,
										newHeight,
										A2($elm$core$List$cons, newLineHeight, els.as)),
	...
	function (isMultiline, stacked, attrs) {
		return function (redist) {
			...
			A3(
				...
				{T: _List_Nil, o: _List_Nil, as: _List_Nil, f: _List_Nil, bh: _List_Nil},
				attrs));
	});
...
var $mdgriffith$elm_ui$Element$Input$textHelper = F3(
	function (textInput, attrs, textOptions) {
		...
		var redistributed = A3(
			...
			$mdgriffith$elm_ui$Element$Input$isStacked(textOptions.a2),
			withDefaults);
				...
				_Utils_ap(
					_List_fromArray(
						[
							...
							$mdgriffith$elm_ui$Element$Input$hiddenLabelAttribute(textOptions.a2),
		...
		return A3(
			...
			A2(
				...
				A2(
					$elm$core$List$cons,
					$mdgriffith$elm_ui$Element$Input$isHiddenLabel(textOptions.a2) ? $mdgriffith$elm_ui$Internal$Model$NoAttribute : $mdgriffith$elm_ui$Element$spacing(5),
...
var $mdgriffith$elm_ui$Element$Input$multiline = F2(
	function (attrs, multi) {
		return A3(
			...
			{I: $elm$core$Maybe$Nothing, O: multi.hS, y: $mdgriffith$elm_ui$Element$Input$TextArea},
			attrs,
			{a2: multi.a2, he: multi.he, ht: multi.ht, h2: multi.h2});
	});
...
var $author$project$Main$inputText = function (model) {
	return A2(
		...
		{
			a2: $mdgriffith$elm_ui$Element$Input$labelHidden('Enter source text here'),
...
var $folkertdev$elm_paragraph$Paragraph$startr = function (width) {
	return {
		aU: $folkertdev$elm_paragraph$SymmetricList$singleton(
			{g_: 0, bR: 0, is: 0}),
		g_: 1,
		is: width
	};
...
var $folkertdev$elm_paragraph$Paragraph$stepr = F3(
	function (options, w, state) {
		...
		var _v6 = $folkertdev$elm_paragraph$SymmetricList$last(state.aU);
		if (_v6.$ === 1) {
			return state;
		} else {
			var last = _v6.a;
			...
			return {aU: newCandidates, g_: tot_len, is: tot_width};
		}
	});
...
var $author$project$Main$initStateWithData = F2(
	function (k, data) {
		return {fA: 0, bv: k, hq: data, hJ: '', is: 300};
	});
...
var $jxxcarlson$elm_graph$SimpleGraph$getDataWindow = function (pointList) {
	...
	return {ae: xMax, q: xMin, af: yMax, z: yMin};
};
		...
		if ((!_v0.a) && (!_v0.b)) {
			...
			return _List_fromArray(
				[
					...
					_Utils_Tuple2(dw.ae, dw.z),
					_Utils_Tuple2(dw.ae, dw.af),
					_Utils_Tuple2(dw.q, dw.af),
					_Utils_Tuple2(dw.q, dw.z)
				]);
		}
	});
var $jxxcarlson$elm_graph$SimpleGraph$getScaleFactor = F2(
	function (dataWindow, gA) {
		var ky = gA.cX / (dataWindow.af - dataWindow.z);
		var kx = gA.cY / (dataWindow.ae - dataWindow.q);
		...
		return $mdgriffith$elm_ui$Element$html(
			A3(
				...
				_List_fromArray(
					[
						_Utils_Tuple2(
						$elm$core$String$fromInt(renderArgs.bv),
...
var $jxxcarlson$elm_graph$SimpleGraph$scatterPlotAsSVG = F2(
	function (ga, data) {
		...
		var xScaleFactor = ga.cY / (dw.ae - dw.q);
		var yScaleFactor = ga.cX / (dw.af - dw.z);
		var rescaledData = A2(
			$elm$core$List$map,
			function (_v1) {
				var x = _v1.a;
		...
		var boundingBox_ = renderPlain(
			A2(
				...
				_Utils_update(
					dw,
					{ae: dw.ae + (diameter / xScaleFactor), af: dw.af + (diameter / yScaleFactor)})));
		return A2(
			$elm$svg$Svg$g,
			_List_fromArray(
				[transformer]),
...
var $author$project$Render$Elm$renderTocItem = function (tocItem) {
	return A2(
		...
		{
			a2: $mdgriffith$elm_ui$Element$text(tocItem.a2 + (' ' + tocItem.ch)),
		...
		return A2(
			...
			A2(
				...
				A2(
					...
					$elm$core$List$reverse(renderArgs.hq.be))));
	});
...
var $author$project$Parser$Metadata$dummy = {fA: 0, bv: 0, a2: '', g_: 0, am: 0};
...
var $author$project$Parser$Driver$newStack = F3(
	function (tc_, errorText_, mRecoveryData) {
		if (!mRecoveryData.$) {
			return _Utils_eq(
				$elm$core$List$head(tc_.aE),
				$elm$core$Maybe$Just('highlight')) ? tc_.aE : A2($elm$core$List$cons, 'highlight', tc_.aE);
		} else {
			return A2(
				$elm$core$List$cons,
				errorText_,
				A2($elm$core$List$cons, 'highlight', tc_.aE));
		}
	});
var $author$project$Parser$Driver$unhandledError = F6(
	function (tc_, mFirstError, errorColumn, mRecoveryData, lxError, errorText) {
		return {
			...
			Q: tc_.Q,
			f7: tc_.f7,
			bt: {bp: _List_Nil, bH: 4},
			bv: tc_.bv,
			am: A3($author$project$Parser$Driver$newOffset, tc_, errorColumn, mRecoveryData),
			hn: $elm$core$Maybe$Nothing,
			da: A3($author$project$Parser$Driver$newParsed, tc_, lxError, mRecoveryData),
			aE: A3($author$project$Parser$Driver$newStack, tc_, errorText, mRecoveryData),
...
var $author$project$Parser$Driver$handleError = F2(
	function (tc_, e) {
		...
		var lxError = A4(
			...
			$elm$core$Maybe$Just(
				{fA: tc_.aq, bv: tc_.bv, a2: '', g_: errorColumn, am: tc_.am + errorColumn}));
		switch (problem.$) {
			case 2:
...
var $author$project$Parser$Loop$newExpr = F3(
	function (packet, tc_, expr) {
		var _v0 = $elm$core$List$head(tc_.aE);
		if ((!_v0.$) && (_v0.a === 'highlight')) {
			var _v1 = packet.gD;
			if (_v1.$ === 1) {
				return A2(packet.gK, tc_.am, expr);
			} else {
				var hl = _v1.a;
				return A2(
					packet.gK,
...
var $author$project$Vector$resetFrom = F2(
	function (k, v) {
		var suffix = A2($elm$core$List$repeat, v.bc - k, 0);
...
var $author$project$Vector$increment = F2(
	function (k, v) {
		return ((k < 0) || (_Utils_cmp(k, v.bc) > -1)) ? v : A2(
...
var $author$project$Parser$Data$handleSection = F3(
	function (name, element, data) {
		...
		if (level_.$ === 1) {
			...
			var tocItem = {
				a2: $author$project$Parser$Data$sectionLabel(newData),
				ed: level - 1,
			...
			return _Utils_update(
				newData,
				{
					be: A2($elm$core$List$cons, tocItem, data.be)
				});
		}
	});
...
var $author$project$Parser$Document$pushBlock_ = F2(
	function (line, state) {
		...
		var tc = A4($author$project$Parser$Driver$parseLoop, state.bv, state.aj, state.f7, str);
		return _Utils_update(
			state,
			{
				n: _List_Nil,
				...
				E: $elm$core$Maybe$Just(tc),
				aj: state.aj + $author$project$Parser$Document$countLines(state.n),
				C: A2($elm$core$List$cons, tc, state.C)
			});
	});
...
var $author$project$Parser$Document$flush = function (state) {
	...
	var newState = function () {
		if (input === '') {
			...
			var tc_ = A4($author$project$Parser$Driver$parseLoop, state.bv, state.aj, state.f7, input);
	...
	if ($author$project$Parser$Document$noError(newState)) {
		...
		if ((!_v0.$) && (_v0.a === 2)) {
			...
			var correctedState = _Utils_update(
				state,
				{n: _List_Nil, u: 0, J: 0, as: correctedText});
...
var $author$project$Parser$Document$handleError = function (state) {
	if (_Utils_eq(state.as, _List_Nil)) {
					...
					return $author$project$Parser$Document$Loop(
						_Utils_update(
							state,
							{
								u: 0,
								J: 0,
								E: A2($elm$core$Maybe$map, $author$project$Parser$Document$resetError, state.E)
							}));
				case 2:
					var foo = 1;
					var correctedText = A2(
...
var $author$project$Parser$Document$popBlockStack = F2(
	function (currentLine_, state) {
		...
		if (!newBlockLevel) {
			...
			var tc_ = A4($author$project$Parser$Driver$parseLoop, state.bv, state.aj, state.f7, input_);
			var tc = _Utils_update(
				tc_,
				{h2: input_});
			return _Utils_update(
				state,
				{
					...
					f7: $author$project$Parser$Document$updateData(tc),
					E: $elm$core$Maybe$Just(tc),
					aj: state.aj + (2 + $elm$core$List$length(state.n)),
					C: A2($elm$core$List$cons, tc, state.C)
				});
		} else {
			return _Utils_update(
	...
	if (_v0.a.$ === 1) {
		...
		if (!_v0.b) {
			...
			var state = _Utils_update(
				state_,
				{
					as: A2($elm$core$List$drop, 1, state_.as)
				});
				...
				case 4:
					...
					return $author$project$Parser$Document$Loop(
						_Utils_update(
							state,
							{
								as: A2($elm$core$List$drop, 1, state.as)
							}));
				case 0:
					switch (_v2.a) {
						case 0:
...
var $author$project$Main$outputDisplay_ = function (model) {
	return A2(
		...
		(model.cg === 1) ? _List_fromArray(
			[
				A2($author$project$Main$render, model.Q, model.as)
			]) : A2(
			$elm$core$List$map,
			$mdgriffith$elm_ui$Element$text,
			A2($folkertdev$elm_paragraph$Paragraph$lines, $author$project$Main$paragraphFormat, model.ba)));
};
			...
			[
				...
				_List_fromArray(
					[
						...
						$mdgriffith$elm_ui$Element$text(
						'generation: ' + $elm$core$String$fromInt(model.Q)),
						$author$project$Main$wordCountElement(model.as)
					])),
