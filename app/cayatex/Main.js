...
{
	if (region.dd.ce === region.em.ce)
	{
		return 'on line ' + region.dd.ce;
	}
	return 'on lines ' + region.dd.ce + ' through ' + region.em.ce;
}
...
function _VirtualDom_makeCallback(eventNode, initialHandler)
{
	function callback(event)
	{
		...
		var currentEventNode = (
			...
			(tag == 2 ? value.b : tag == 3 && value.dQ) && event.preventDefault(),
			eventNode
		);
		var tagger;
		var i;
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { gJ: 'hidden', f_: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { gJ: 'mozHidden', f_: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { gJ: 'msHidden', f_: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { gJ: 'webkitHidden', f_: 'webkitvisibilitychange' }
		: { gJ: 'hidden', f_: 'visibilitychange' };
}
...
function _Browser_getViewport()
{
	return {
		...
		aF: {
			...
			is: _Browser_doc.documentElement.clientWidth,
...
function _Browser_getScene()
{
	...
	return {
		is: Math.max(body.scrollWidth, body.offsetWidth, elem.scrollWidth, elem.offsetWidth, elem.clientWidth),
		...
		while (true) {
			if (fromIndex < 0) {
				return A2(
					...
					false,
					{H: nodeList, w: (len / $elm$core$Array$branchFactor) | 0, C: tail});
			} else {
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {bo: fragment, ey: host, bE: path, e1: port_, e7: protocol, bH: query};
	});
...
var $elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {f5: col, b1: contextStack, hB: problem, dU: row};
	});
...
var $elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			...
			A4($elm$parser$Parser$Advanced$DeadEnd, s.dU, s.f5, x, s.e));
	});
var $elm$parser$Parser$Advanced$end = function (x) {
	return function (s) {
		return _Utils_eq(
			$elm$core$String$length(s.hW),
...
var $elm$parser$Parser$Advanced$Located = F3(
	function (row, col, context) {
		return {f5: col, e: context, dU: row};
	});
var $elm$parser$Parser$Advanced$changeContext = F2(
	function (newContext, s) {
		return {f5: s.f5, e: newContext, i: s.i, aA: s.aA, dU: s.dU, hW: s.hW};
	});
		...
		return function (s0) {
			var _v1 = parse(
				A2(
					...
					A2(
						$elm$core$List$cons,
						A3($elm$parser$Parser$Advanced$Located, s0.dU, s0.f5, context),
						s0.e),
					s0));
			if (!_v1.$) {
				var p = _v1.a;
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.aA, s.dU, s.f5, s.hW);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			progress,
			0,
			{f5: newCol, e: s.e, i: s.i, aA: newOffset, dU: newRow, hW: s.hW});
	};
};
...
var $elm$parser$Parser$Advanced$chompWhileHelp = F5(
	function (isGood, offset, row, col, s0) {
		chompWhileHelp:
		while (true) {
			var newOffset = A3($elm$parser$Parser$Advanced$isSubChar, isGood, offset, s0.hW);
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					$elm$parser$Parser$Advanced$Good,
					_Utils_cmp(s0.aA, offset) < 0,
					0,
					{f5: col, e: s0.e, i: s0.i, aA: offset, dU: row, hW: s0.hW});
			} else {
...
var $elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5($elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.aA, s.dU, s.f5, s);
	};
};
...
var $elm$parser$Parser$Advanced$getSource = function (s) {
	return A3($elm$parser$Parser$Advanced$Good, false, s.hW, s);
};
				...
				$elm$parser$Parser$Advanced$succeed(
					F3(
						function (begin, end, content) {
							return {
								dr: A3($elm$core$String$slice, begin, end, content),
								g4: end - begin,
								dd: begin
							};
						})),
...
var $author$project$Parser$Metadata$init = F4(
	function (generation, lineNumber, start, finish) {
		return {fN: lineNumber, ca: generation, aT: '', g4: finish - start, aA: start};
	});
...
var $elm$parser$Parser$Advanced$chompIf = F2(
	function (isGood, expecting) {
		return function (s) {
			var newOffset = A3($elm$parser$Parser$Advanced$isSubChar, isGood, s.aA, s.hW);
			return _Utils_eq(newOffset, -1) ? A2(
				$elm$parser$Parser$Advanced$Bad,
				false,
				...
				true,
				0,
				{f5: 1, e: s.e, i: s.i, aA: s.aA + 1, dU: s.dU + 1, hW: s.hW}) : A3(
				$elm$parser$Parser$Advanced$Good,
				true,
				0,
				{f5: s.f5 + 1, e: s.e, i: s.i, aA: newOffset, dU: s.dU, hW: s.hW}));
		};
	});
				...
				$elm$parser$Parser$Advanced$succeed(
					F3(
						function (start, finish, content) {
							return {
								dr: A3($elm$core$String$slice, start, finish, content),
								dB: finish,
								dd: start
							};
						})),
...
var $author$project$Parser$XString$escapedChar = A2(
	$elm$parser$Parser$Advanced$map,
	function (result) {
		return {dr: '\\' + result.dr, dB: result.dB, dd: result.dd - 1};
	},
	A2(
			...
			A2(
				...
				function (data) {
					return A2(
						...
						data.dr,
						$elm$core$Maybe$Just(
							A4($author$project$Parser$Metadata$init, generation, lineNumber, data.dd, data.dB)));
				},
...
var $author$project$Parser$RawString$updateState = F3(
	function (maxHashes, c, state) {
		return (c === '#') ? ((A2($elm$core$String$right, 1, state.dr) === '#') ? ((_Utils_cmp(state.an + 1, state.an + 1) > 0) ? $elm$parser$Parser$Advanced$Done(
			{
				dr: _Utils_ap(state.dr, c),
				an: state.an + 1
			}) : $elm$parser$Parser$Advanced$Loop(
			{
				dr: _Utils_ap(state.dr, c),
...
var $author$project$Parser$RawString$parser = A2(
	...
	function (maxHashes) {
		return A2(
			$elm$parser$Parser$Advanced$map,
			function (ls) {
				return A2($elm$core$String$dropRight, maxHashes, ls.dr);
			},
...
var $elm$parser$Parser$Advanced$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{f5: 1, e: _List_Nil, i: 1, aA: 0, dU: 1, hW: src});
		if (!_v1.$) {
			var value = _v1.b;
	...
	return _Utils_Tuple2(
		{
			...
			cZ: 1,
			aY: $author$project$Render$String$renderString($author$project$Main$initialText),
			d0: flags.dI,
			fq: flags.is
		},
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							F: model.F + 1,
							ao: str,
							aY: $author$project$Render$String$renderString(str)
						}),
					$elm$core$Platform$Cmd$none);
			case 6:
				var mode = msg.a;
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							F: model.F + 1,
							ao: '',
							aY: $author$project$Render$String$renderString('')
						}),
					$elm$core$Platform$Cmd$none);
			case 3:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							...
							aY: $author$project$Render$String$renderString($author$project$Data$text)
						}),
					$elm$core$Platform$Cmd$none);
			case 4:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							...
							aY: $author$project$Render$String$renderString($author$project$Data$test)
						}),
					$elm$core$Platform$Cmd$none);
			case 5:
				return _Utils_Tuple2(
...
var $mdgriffith$elm_ui$Internal$Style$classes = {ft: 'a', dk: 'atv', fw: 'ab', fx: 'cx', fy: 'cy', fz: 'acb', fA: 'accx', fB: 'accy', fC: 'acr', d4: 'al', d5: 'ar', fD: 'at', dl: 'ah', dm: 'av', fH: 's', fK: 'bh', fL: 'b', fQ: 'w7', fS: 'bd', fT: 'bdt', cD: 'bn', fU: 'bs', cF: 'cpe', f2: 'cp', f3: 'cpx', f4: 'cpy', z: 'c', cH: 'ctr', cI: 'cb', cJ: 'ccx', aR: 'ccy', b0: 'cl', cK: 'cr', ga: 'ct', gf: 'cptr', gg: 'ctxt', gC: 'fcs', ep: 'focus-within', gE: 'fs', gG: 'g', dG: 'hbh', dJ: 'hc', ev: 'he', dK: 'hf', ew: 'hfp', gL: 'hv', gO: 'ic', gQ: 'fr', cU: 'lbl', gT: 'iml', gU: 'imlf', gV: 'imlp', gW: 'implw', gX: 'it', g$: 'i', eK: 'lnk', bz: 'nb', eR: 'notxt', hi: 'ol', hj: 'or', a9: 'oq', ho: 'oh', e_: 'pg', e$: 'p', hu: 'ppe', hG: 'ui', dU: 'r', hI: 'sb', hJ: 'sbx', hK: 'sby', hL: 'sbt', hR: 'e', hS: 'cap', hT: 'sev', h$: 'sk', h3: 't', h4: 'tc', h5: 'w8', h6: 'w2', h7: 'w9', h8: 'tj', df: 'tja', h9: 'tl', ia: 'w3', ib: 'w5', ic: 'w4', id: 'tr', ie: 'w6', $8: 'w1', ih: 'tun', fm: 'ts', bd: 'clr', ip: 'u', d_: 'wc', fo: 'we', d$: 'wf', fp: 'wfp', d1: 'wrp'};
var $mdgriffith$elm_ui$Internal$Flag$overflow = $mdgriffith$elm_ui$Internal$Flag$flag(20);
var $mdgriffith$elm_ui$Element$clipX = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$overflow, $mdgriffith$elm_ui$Internal$Style$classes.f3);
var $mdgriffith$elm_ui$Element$clipY = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$overflow, $mdgriffith$elm_ui$Internal$Style$classes.f4);
...
var $mdgriffith$elm_ui$Internal$Model$columnClass = $mdgriffith$elm_ui$Internal$Style$classes.fH + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.z);
var $mdgriffith$elm_ui$Internal$Model$gridClass = $mdgriffith$elm_ui$Internal$Style$classes.fH + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.gG);
var $mdgriffith$elm_ui$Internal$Model$pageClass = $mdgriffith$elm_ui$Internal$Style$classes.fH + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.e_);
var $mdgriffith$elm_ui$Internal$Model$paragraphClass = $mdgriffith$elm_ui$Internal$Style$classes.fH + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.e$);
var $mdgriffith$elm_ui$Internal$Model$rowClass = $mdgriffith$elm_ui$Internal$Style$classes.fH + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.dU);
var $mdgriffith$elm_ui$Internal$Model$singleClass = $mdgriffith$elm_ui$Internal$Style$classes.fH + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.hR);
	...
	switch (style.$) {
		...
		case 8:
			...
			return 'grid-rows-' + (A2(
				$elm$core$String$join,
				'-',
				A2($elm$core$List$map, $mdgriffith$elm_ui$Internal$Model$lengthClassName, template.aZ)) + ('-cols-' + (A2(
				$elm$core$String$join,
				'-',
				A2($elm$core$List$map, $mdgriffith$elm_ui$Internal$Model$lengthClassName, template.O)) + ('-space-x-' + ($mdgriffith$elm_ui$Internal$Model$lengthClassName(template.hU.a) + ('-space-y-' + $mdgriffith$elm_ui$Internal$Model$lengthClassName(template.hU.b)))))));
		case 9:
			var pos = style.a;
			return 'gp grid-pos-' + ($elm$core$String$fromInt(pos.dU) + ('-' + ($elm$core$String$fromInt(pos.f5) + ('-' + ($elm$core$String$fromInt(pos.is) + ('-' + $elm$core$String$fromInt(pos.dI)))))));
		case 11:
		...
		A2(
			...
			_List_fromArray(
				[
					...
					$elm$core$Maybe$Just(
					$mdgriffith$elm_ui$Internal$Model$formatColor(shadow.f6))
				])));
};
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.gL, $mdgriffith$elm_ui$Internal$Style$classes.bd)) + ':hover',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.gL, $mdgriffith$elm_ui$Internal$Style$classes.a9)) + ':hover',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.gC, $mdgriffith$elm_ui$Internal$Style$classes.bd)) + ':focus',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.gC, $mdgriffith$elm_ui$Internal$Style$classes.a9)) + ':focus',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.dk, $mdgriffith$elm_ui$Internal$Style$classes.bd)) + ':active',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.dk, $mdgriffith$elm_ui$Internal$Style$classes.a9)) + ':active',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
...
var $mdgriffith$elm_ui$Internal$Style$overrides = '@media screen and (-ms-high-contrast: active), (-ms-high-contrast: none) {' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.fH) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.dU) + (' > ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.fH) + (' { flex-basis: auto !important; } ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.fH) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.dU) + (' > ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.fH) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.cH) + (' { flex-basis: auto !important; }}' + ($mdgriffith$elm_ui$Internal$Style$inputTextReset + ($mdgriffith$elm_ui$Internal$Style$sliderReset + ($mdgriffith$elm_ui$Internal$Style$trackReset + ($mdgriffith$elm_ui$Internal$Style$thumbReset + $mdgriffith$elm_ui$Internal$Style$explainer)))))))))))))));
...
var $mdgriffith$elm_ui$Internal$Style$emptyIntermediate = F2(
	function (selector, closing) {
		return {aQ: closing, s: _List_Nil, ad: _List_Nil, Y: selector};
	});
					...
					case 3:
						...
						return _Utils_update(
							rendered,
							{
								s: A2(
									$elm$core$List$cons,
									{aQ: '\n}', s: _List_Nil, ad: props, Y: '@supports (' + (prop + (':' + (value + (') {' + parent.Y))))},
									rendered.s)
							});
					case 5:
						var selector = rule.a;
...
var $mdgriffith$elm_ui$Internal$Style$renderCompact = function (styleClasses) {
	...
	var renderClass = function (rule) {
		...
		if (!_v2.b) {
			...
			return rule.Y + ('{' + (renderValues(rule.ad) + (rule.aQ + '}')));
		}
	};
	...
	function (options, rule, maybePseudo) {
		switch (rule.$) {
			...
			case 5:
				...
				var row = '.' + $mdgriffith$elm_ui$Internal$Style$classes.dU;
				var wrappedRow = '.' + ($mdgriffith$elm_ui$Internal$Style$classes.d1 + row);
				var right = '.' + $mdgriffith$elm_ui$Internal$Style$classes.d5;
				var paragraph = '.' + $mdgriffith$elm_ui$Internal$Style$classes.e$;
				var page = '.' + $mdgriffith$elm_ui$Internal$Style$classes.e_;
			...
			case 8:
				...
				var rows = function (x) {
					...
					A2(
						$elm$core$String$join,
						' ',
						A2($elm$core$List$map, toGridLength, template.aZ)));
			...
			case 9:
				...
				var msPosition = A2(
					...
					_List_fromArray(
						[
							'-ms-grid-row: ' + ($elm$core$String$fromInt(position.dU) + ';'),
							'-ms-grid-row-span: ' + ($elm$core$String$fromInt(position.dI) + ';'),
							'-ms-grid-column: ' + ($elm$core$String$fromInt(position.f5) + ';'),
							'-ms-grid-column-span: ' + ($elm$core$String$fromInt(position.is) + ';')
						]));
				var modernPosition = A2(
					...
					_List_fromArray(
						[
							'grid-row: ' + ($elm$core$String$fromInt(position.dU) + (' / ' + ($elm$core$String$fromInt(position.dU + position.dI) + ';'))),
							'grid-column: ' + ($elm$core$String$fromInt(position.f5) + (' / ' + ($elm$core$String$fromInt(position.f5 + position.is) + ';')))
						]));
				var _class = '.grid-pos-' + ($elm$core$String$fromInt(position.dU) + ('-' + ($elm$core$String$fromInt(position.f5) + ('-' + ($elm$core$String$fromInt(position.is) + ('-' + $elm$core$String$fromInt(position.dI)))))));
	...
	function (name, modifier, _v0) {
		...
		return _List_fromArray(
			[
				...
				A2($mdgriffith$elm_ui$Internal$Model$bracket, '.' + (name + ('.' + (modifier + ('> .' + ($mdgriffith$elm_ui$Internal$Style$classes.h3 + (', .' + (name + (' .' + (modifier + (' > .' + $mdgriffith$elm_ui$Internal$Style$classes.h3)))))))))), textAdjustment)
			]);
	});
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					A2(
					$mdgriffith$elm_ui$Internal$Model$bracket,
					'.' + (name + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.hS + ('> .' + ($mdgriffith$elm_ui$Internal$Style$classes.h3 + (', .' + (name + (' .' + ($mdgriffith$elm_ui$Internal$Style$classes.hS + (' > .' + $mdgriffith$elm_ui$Internal$Style$classes.h3)))))))))),
					_List_fromArray(
						[
...
var $mdgriffith$elm_ui$Internal$Model$adjust = F3(
	function (size, height, vertical) {
		return {dI: height / size, bM: size, fn: vertical};
	});
...
var $mdgriffith$elm_ui$Internal$Model$convertAdjustment = function (adjustment) {
	var lines = _List_fromArray(
		[adjustment.b_, adjustment.bW, adjustment.b4, adjustment.cf]);
	var lineHeight = 1.5;
	...
	return {
		b_: A3($mdgriffith$elm_ui$Internal$Model$adjust, capitalSize, ascender - newBaseline, capitalVertical),
	...
	return _Utils_Tuple2(
		...
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'line-height',
				$elm$core$String$fromFloat(converted.dI)),
				_Utils_Tuple2(
				'vertical-align',
				...
				return {
					...
					cv: function () {
						...
						if (_v1.$ === 1) {
							...
							var topLevel = _v1.a;
							return A2($elm$core$List$cons, topLevel, rendered.cv);
						}
					}()
				};
			});
					...
					return A3(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class($mdgriffith$elm_ui$Internal$Style$classes.fH + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.hR))
									]))
							]));
			}
		}();
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.fH, $mdgriffith$elm_ui$Internal$Style$classes.hR, $mdgriffith$elm_ui$Internal$Style$classes.cH, $mdgriffith$elm_ui$Internal$Style$classes.aR, $mdgriffith$elm_ui$Internal$Style$classes.fC])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.fH, $mdgriffith$elm_ui$Internal$Style$classes.hR, $mdgriffith$elm_ui$Internal$Style$classes.cH, $mdgriffith$elm_ui$Internal$Style$classes.aR, $mdgriffith$elm_ui$Internal$Style$classes.fA])))
						]),
					_List_fromArray(
						[html])) : html));
			case 1:
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.fH, $mdgriffith$elm_ui$Internal$Style$classes.hR, $mdgriffith$elm_ui$Internal$Style$classes.cH, $mdgriffith$elm_ui$Internal$Style$classes.fB])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.fH, $mdgriffith$elm_ui$Internal$Style$classes.hR, $mdgriffith$elm_ui$Internal$Style$classes.cH, $mdgriffith$elm_ui$Internal$Style$classes.fz])))
						]),
					_List_fromArray(
						[html])) : html));
			default:
...
var $mdgriffith$elm_ui$Internal$Model$textElementClasses = $mdgriffith$elm_ui$Internal$Style$classes.fH + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.h3 + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.d_ + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.dJ)))));
...
var $mdgriffith$elm_ui$Internal$Model$textElementFillClasses = $mdgriffith$elm_ui$Internal$Style$classes.fH + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.h3 + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.d$ + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.dK)))));
...
var $mdgriffith$elm_ui$Internal$Model$createElement = F3(
	function (context, children, rendered) {
					...
					case 1:
						...
						return _Utils_eq(context, $mdgriffith$elm_ui$Internal$Model$asParagraph) ? _Utils_Tuple2(
							A2(
								...
								htmls),
							$elm$core$List$isEmpty(existingStyles) ? styled.bP : _Utils_ap(styled.bP, existingStyles)) : _Utils_Tuple2(
							A2(
								$elm$core$List$cons,
								_Utils_Tuple2(
									key,
									A2(styled.gM, $mdgriffith$elm_ui$Internal$Model$NoStyleSheet, context)),
								htmls),
							$elm$core$List$isEmpty(existingStyles) ? styled.bP : _Utils_ap(styled.bP, existingStyles));
					case 2:
						var str = child.a;
						return _Utils_Tuple2(
							A2(
		...
		if (children.$ === 1) {
			...
			var keyed = _v1.a;
			var styles = _v1.b;
			var newStyles = $elm$core$List$isEmpty(styles) ? rendered.bP : _Utils_ap(rendered.bP, styles);
			if (!newStyles.b) {
						...
						switch (location) {
							case 0:
								return A2(
									...
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.bz, $mdgriffith$elm_ui$Internal$Style$classes.hR, $mdgriffith$elm_ui$Internal$Style$classes.ft]));
							case 1:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.bz, $mdgriffith$elm_ui$Internal$Style$classes.hR, $mdgriffith$elm_ui$Internal$Style$classes.fL]));
							case 2:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.bz, $mdgriffith$elm_ui$Internal$Style$classes.hR, $mdgriffith$elm_ui$Internal$Style$classes.hj]));
							case 3:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.bz, $mdgriffith$elm_ui$Internal$Style$classes.hR, $mdgriffith$elm_ui$Internal$Style$classes.hi]));
							case 4:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.bz, $mdgriffith$elm_ui$Internal$Style$classes.hR, $mdgriffith$elm_ui$Internal$Style$classes.gQ]));
							default:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.bz, $mdgriffith$elm_ui$Internal$Style$classes.hR, $mdgriffith$elm_ui$Internal$Style$classes.fK]));
						}
					}())
				]),
			_List_fromArray(
...
var $mdgriffith$elm_ui$Internal$Model$alignXName = function (align) {
	switch (align) {
		case 0:
			return $mdgriffith$elm_ui$Internal$Style$classes.dl + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.d4);
		case 2:
			return $mdgriffith$elm_ui$Internal$Style$classes.dl + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.d5);
		default:
			return $mdgriffith$elm_ui$Internal$Style$classes.dl + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.fx);
	}
};
var $mdgriffith$elm_ui$Internal$Model$alignYName = function (align) {
	switch (align) {
		case 0:
			return $mdgriffith$elm_ui$Internal$Style$classes.dm + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.fD);
		case 2:
			return $mdgriffith$elm_ui$Internal$Style$classes.dm + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.fw);
		default:
			return $mdgriffith$elm_ui$Internal$Style$classes.dm + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.fy);
	}
};
			...
			return (portion === 1) ? _Utils_Tuple3(
				...
				_List_fromArray(
					[
						...
						$mdgriffith$elm_ui$Internal$Style$classes.fH + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.z + (' > ' + $mdgriffith$elm_ui$Internal$Style$dot(
...
var $mdgriffith$elm_ui$Internal$Model$renderWidth = function (w) {
	switch (w.$) {
		case 0:
			...
			return _Utils_Tuple3(
				$mdgriffith$elm_ui$Internal$Flag$none,
				$mdgriffith$elm_ui$Internal$Style$classes.fo + (' width-px-' + $elm$core$String$fromInt(px)),
				_List_fromArray(
					[
						A3(
						$mdgriffith$elm_ui$Internal$Model$Single,
		...
		case 2:
			...
			return (portion === 1) ? _Utils_Tuple3(
				...
				_List_Nil) : _Utils_Tuple3(
				A2($mdgriffith$elm_ui$Internal$Flag$add, $mdgriffith$elm_ui$Internal$Flag$widthFill, $mdgriffith$elm_ui$Internal$Flag$none),
				$mdgriffith$elm_ui$Internal$Style$classes.fp + (' width-fill-' + $elm$core$String$fromInt(portion)),
				_List_fromArray(
					[
						A3(
						$mdgriffith$elm_ui$Internal$Model$Single,
						$mdgriffith$elm_ui$Internal$Style$classes.fH + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.dU + (' > ' + $mdgriffith$elm_ui$Internal$Style$dot(
					...
					case 7:
						...
						if (A2($mdgriffith$elm_ui$Internal$Flag$present, $mdgriffith$elm_ui$Internal$Flag$width, has)) {
							...
							switch (width.$) {
								case 0:
									var px = width.a;
									var $temp$classes = ($mdgriffith$elm_ui$Internal$Style$classes.fo + (' width-px-' + $elm$core$String$fromInt(px))) + (' ' + classes),
										$temp$node = node,
								...
								case 2:
									...
									if (portion === 1) {
										...
										var $temp$classes = classes + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.fp + (' width-fill-' + $elm$core$String$fromInt(portion)))),
											$temp$node = node,
											$temp$has = A2(
											$mdgriffith$elm_ui$Internal$Flag$add,
											$mdgriffith$elm_ui$Internal$Flag$widthFill,
					...
					case 9:
						...
						var newStyles = function () {
							switch (elem.$) {
								...
								default:
									var styled = elem.a;
									return _Utils_ap(styles, styled.bP);
							}
						}();
						var $temp$classes = classes,
							$temp$node = node,
...
var $mdgriffith$elm_ui$Internal$Model$focusDefaultStyle = {
	...
	hO: $elm$core$Maybe$Just(
		{
			fP: 0,
			f6: A4($mdgriffith$elm_ui$Internal$Model$Rgba, 155 / 255, 203 / 255, 1, 1),
...
var $mdgriffith$elm_ui$Internal$Model$optionsToRecord = function (options) {
	...
	return andFinally(
		A3(
			$elm$core$List$foldr,
			combine,
			{gC: $elm$core$Maybe$Nothing, gL: $elm$core$Maybe$Nothing, cZ: $elm$core$Maybe$Nothing},
			options));
};
			...
			A2(
				...
				$mdgriffith$elm_ui$Internal$Model$htmlClass(
					A2(
						...
						' ',
						_List_fromArray(
							[$mdgriffith$elm_ui$Internal$Style$classes.hG, $mdgriffith$elm_ui$Internal$Style$classes.fH, $mdgriffith$elm_ui$Internal$Style$classes.hR]))),
...
var $mdgriffith$elm_ui$Element$column = F2(
	function (attrs, children) {
		return A4(
			...
			A2(
				$elm$core$List$cons,
				$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.ga + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.b0)),
				A2(
					$elm$core$List$cons,
		...
		return A4(
			...
			A2(
				...
				A2(
					...
					A2(
						$elm$core$List$cons,
						$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.cJ + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.aR + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.hL + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.eR)))))),
						A2(
							$elm$core$List$cons,
...
var $author$project$Main$clearTextButton = A2(
	...
	$author$project$Main$buttonStyle2,
	{
		...
		a8: $elm$core$Maybe$Just($author$project$Main$ClearText)
	});
...
var $author$project$Main$getNotesButton = A2(
	...
	$author$project$Main$buttonStyle2,
	{
		...
		a8: $elm$core$Maybe$Just($author$project$Main$GetNotes)
	});
...
var $author$project$Main$getTestButton = A2(
	...
	$author$project$Main$buttonStyle2,
	{
		...
		a8: $elm$core$Maybe$Just($author$project$Main$GetTest)
	});
...
var $author$project$Main$getTextButton = A2(
	...
	$author$project$Main$buttonStyle2,
	{
		...
		a8: $elm$core$Maybe$Just($author$project$Main$GetText)
	});
...
var $mdgriffith$elm_ui$Element$clip = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$overflow, $mdgriffith$elm_ui$Internal$Style$classes.f2);
...
var $mdgriffith$elm_ui$Element$Input$negateBox = function (box) {
	return {bY: -box.bY, cd: -box.cd, cn: -box.cn, cu: -box.cu};
};
					...
					case 5:
						...
						return _Utils_update(
							els,
							{
								...
								ao: A2($elm$core$List$cons, attr, els.ao),
								g: A2($elm$core$List$cons, attr, els.g),
								bU: A2($elm$core$List$cons, attr, els.bU)
							});
					case 7:
						var cls = attr.a;
						var _v2 = attr.b;
	...
	function (isMultiline, stacked, attrs) {
		return function (redist) {
			return {
				...
				bU: $elm$core$List$reverse(redist.bU)
			};
		}(
			A3(
				$elm$core$List$foldl,
				A2($mdgriffith$elm_ui$Element$Input$redistributeOver, isMultiline, stacked),
				{ab: _List_Nil, p: _List_Nil, ao: _List_Nil, g: _List_Nil, bU: _List_Nil},
				attrs));
	});
				...
				_Utils_ap(
					_List_fromArray(
						[
							...
							$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.eR + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.hu)),
...
var $mdgriffith$elm_ui$Element$scrollbarY = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$overflow, $mdgriffith$elm_ui$Internal$Style$classes.hK);
...
var $mdgriffith$elm_ui$Element$Input$textHelper = F3(
	function (textInput, attrs, textOptions) {
		...
		var redistributed = A3(
			...
			$mdgriffith$elm_ui$Element$Input$isStacked(textOptions.aT),
			withDefaults);
		...
		var inputElement = A4(
			...
			_Utils_ap(
				...
				_Utils_ap(
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$Input$value(textOptions.h3),
							$mdgriffith$elm_ui$Internal$Model$Attr(
							$elm$html$Html$Events$onInput(textOptions.hh)),
							$mdgriffith$elm_ui$Element$Input$hiddenLabelAttribute(textOptions.aT),
									...
									function () {
										if (textOptions.h3 === '') {
											...
											if (_v1.$ === 1) {
												...
												return _List_fromArray(
													[
														A3($mdgriffith$elm_ui$Element$Input$renderPlaceholder, place, _List_Nil, textOptions.h3 === '')
													]);
											}
										} else {
											return _List_fromArray(
												[
													...
													A2(
														...
														_List_fromArray(
															[
																$elm$html$Html$Attributes$class($mdgriffith$elm_ui$Internal$Style$classes.gU)
															]),
														_List_fromArray(
															[
																$elm$html$Html$text(textOptions.h3 + '\u00A0')
															])))
												]);
										}
									}()))
										...
										if (_v2.$ === 1) {
											...
											return _List_fromArray(
												[
													...
													A3($mdgriffith$elm_ui$Element$Input$renderPlaceholder, place, redistributed.ab, textOptions.h3 === ''))
												]);
										}
									}()
									])))),
		...
		return A3(
			...
			A2(
				...
				A2(
					$elm$core$List$cons,
					$mdgriffith$elm_ui$Element$Input$isHiddenLabel(textOptions.aT) ? $mdgriffith$elm_ui$Internal$Model$NoAttribute : $mdgriffith$elm_ui$Element$spacing(5),
...
var $mdgriffith$elm_ui$Element$Input$multiline = F2(
	function (attrs, multi) {
		return A3(
			...
			{S: $elm$core$Maybe$Nothing, Z: multi.hV, D: $mdgriffith$elm_ui$Element$Input$TextArea},
			attrs,
			{aT: multi.aT, hh: multi.hh, hw: multi.hw, h3: multi.h3});
	});
...
var $author$project$Main$inputText = function (model) {
	return A2(
		...
		{
			aT: $mdgriffith$elm_ui$Element$Input$labelHidden('Enter source text here'),
...
var $mdgriffith$elm_ui$Element$row = F2(
	function (attrs, children) {
		return A4(
			...
			A2(
				$elm$core$List$cons,
				$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.b0 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.aR)),
				A2(
					$elm$core$List$cons,
					$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$shrink),
					A2(
...
var $folkertdev$elm_paragraph$Paragraph$stepr = F3(
	function (options, w, state) {
		var tot_width = (w + 1) + state.is;
		var width_hd = function (p) {
			return (tot_width - p.is) - 1;
		};
		var waste = function (p) {
			return $folkertdev$elm_paragraph$Paragraph$single(p) ? 0 : (p.cy + A2(
				$elm$core$Basics$pow,
				options.eX - width_hd(p),
				2));
		};
		var tot_len = 1 + state.g4;
		var old_width_hd = function (p) {
			return (state.is - p.is) - 1;
		};
		var _new = function (p) {
			return $folkertdev$elm_paragraph$Paragraph$single(p) ? {g4: state.g4, cy: 0, is: state.is} : {
				g4: state.g4,
				cy: p.is + A2(
					$elm$core$Basics$pow,
					options.eX - old_width_hd(p),
					2),
				is: state.is
			};
		};
		var k = F2(
			function (p, q) {
				var wq0 = width_hd(q);
				var wp0 = width_hd(p);
				var rq0 = (options.eN - wq0) + 1;
				return ($folkertdev$elm_paragraph$Paragraph$single(q) && (!p.is)) ? A2($elm$core$Basics$min, options.eX - wp0, rq0) : ($folkertdev$elm_paragraph$Paragraph$single(q) ? rq0 : A2(
					$elm$core$Basics$min,
					A2(
			...
			while (true) {
				...
				if (_v0.$ === 1) {
					...
					if (_v2.$ === 1) {
						return (_Utils_cmp(
							width_hd(q),
							options.eN) > 0) ? $folkertdev$elm_paragraph$SymmetricList$empty : ps_pq;
					} else {
						var p = _v2.a;
						if ((_Utils_cmp(
							waste(p),
		...
		if (_v6.$ === 1) {
			...
			return {bi: newCandidates, g4: tot_len, is: tot_width};
		}
	});
...
var $folkertdev$elm_paragraph$Paragraph$paragraph = F2(
	function (options, words) {
		var zs = A3(
			...
			A2($elm$core$List$map, options.fh, words));
		if (!zs.b) {
			return _List_Nil;
		} else {
			var first = zs.a;
...
var $author$project$Main$paragraphFormat = {eN: 80, eX: 70, fh: $elm$core$String$length};
var $author$project$Main$CYTMsg = function (a) {
	return {$: 7, a: a};
};
var $author$project$Main$initStateWithData = F2(
	function (k, data) {
		return {fN: 0, ca: k, ht: data, hM: '', is: 300};
	});
...
var $jxxcarlson$elm_graph$SimpleGraph$buildSVGTransformString = function (ga) {
	...
	var translateX = function () {
		...
		if (!_v2) {
			...
			return $elm$core$String$fromFloat((-ga.dE) + 60);
		}
	}();
	...
	var translateY = function () {
		...
		if (!_v1) {
			...
			return $elm$core$String$fromFloat(-ga.dD);
		}
	}();
...
var $jxxcarlson$elm_graph$SimpleGraph$bxTickmarks = function (ga) {
	...
	var n = $elm$core$Basics$round(ga.dE / dx);
	return A2(
		$elm$svg$Svg$g,
		_List_Nil,
		A2(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					$elm$svg$Svg$Attributes$height(
					$elm$core$String$fromFloat(ga.dD + 40)),
					$elm$svg$Svg$Attributes$width(
					$elm$core$String$fromFloat(ga.dE + 40)),
					$elm$svg$Svg$Attributes$viewBox(
					'-60 -20 ' + ($elm$core$String$fromFloat(ga.dE + 40) + (' ' + $elm$core$String$fromFloat(ga.dD + 20))))
				]),
			_List_fromArray(
				[
...
var $author$project$Widget$Data$bargraph = F5(
	function (renderArgs, name, args, body, sm) {
		...
		var barGraphAttributes = {dD: graphHeight, dE: graphWidth, hn: options};
		return A2(
			$mdgriffith$elm_ui$Element$column,
			_List_Nil,
			_List_fromArray(
...
var $author$project$Render$Elm$expandMacro = F2(
	function (macroForm, body) {
		return A4($author$project$Parser$Element$Element, macroForm.c_, macroForm.d6, body, $elm$core$Maybe$Nothing);
	});
...
var $author$project$Render$Elm$indentPadding = $mdgriffith$elm_ui$Element$paddingEach(
	{bY: 0, cd: 24, cn: 0, cu: 0});
var $mdgriffith$elm_ui$Element$Font$italic = $mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.g$);
var $jxxcarlson$elm_graph$SimpleGraph$getDataWindow = function (pointList) {
	...
	return {as: xMax, t: xMin, at: yMax, E: yMin};
};
var $jxxcarlson$elm_graph$SimpleGraph$boundingBox = F2(
	function (options, dw) {
		...
		if ((!_v0.a) && (!_v0.b)) {
			...
			return _List_fromArray(
				[
					_Utils_Tuple2(dw.t, dw.E),
					_Utils_Tuple2(dw.as, dw.E),
...
var $jxxcarlson$elm_graph$SimpleGraph$getScaleFactor = F2(
	function (dataWindow, gA) {
		var ky = gA.dD / (dataWindow.at - dataWindow.E);
		var kx = gA.dE / (dataWindow.as - dataWindow.t);
...
var $jxxcarlson$elm_graph$SimpleGraph$makeXTickMark = F3(
	function (ky, dw, x) {
		return _List_fromArray(
			[
				_Utils_Tuple2(x, dw.E),
				_Utils_Tuple2(x, dw.E - ($jxxcarlson$elm_graph$SimpleGraph$tickMarkLength / ky))
			]);
	});
...
var $jxxcarlson$elm_graph$SimpleGraph$makeYLabel = F3(
	function (_v0, dw, y) {
		...
		var label = $elm$core$String$fromFloat(
			A2($jxxcarlson$elm_graph$SimpleGraph$roundTo, 1, y));
		var dy = $elm$core$String$fromFloat((ky * (y - dw.E)) - 3);
		return A2(
			$elm$svg$Svg$text_,
			_List_fromArray(
				[
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					$elm$core$String$fromFloat(ga.dD + 40)),
					$elm$svg$Svg$Attributes$width(
					$elm$core$String$fromFloat(ga.dE + 50)),
					$elm$svg$Svg$Attributes$viewBox(
					'-40 -20 ' + ($elm$core$String$fromFloat(ga.dE + 50) + (' ' + $elm$core$String$fromFloat(ga.dD + 40))))
				]),
			_List_fromArray(
				[
...
var $author$project$Widget$Data$linegraph = F5(
	function (renderArgs, name, args, body, sm) {
		...
		var lineGraphAttributes = {dD: graphHeight, dE: graphWidth, hn: options};
		return A2(
			$mdgriffith$elm_ui$Element$column,
			_List_Nil,
			_List_fromArray(
					...
					A2(
						...
						A2(
							...
							A2(
								...
								A2(
									$elm$core$List$cons,
									$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.cJ + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.aR + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.eK)))),
									attrs)))))),
			$mdgriffith$elm_ui$Internal$Model$Unkeyed(
				_List_fromArray(
					[label])));
		...
		return $mdgriffith$elm_ui$Element$html(
			A3(
				...
				_List_fromArray(
					[
						_Utils_Tuple2(
						$elm$core$String$fromInt(renderArgs.ca),
						A4($author$project$Render$Elm$mathText_, displayMode, renderArgs.hM, content, meta))
					])));
	});
...
var $jxxcarlson$elm_graph$SimpleGraph$scatterPlotAsSVG = F2(
	function (ga, data) {
		...
		var xScaleFactor = ga.dE / (dw.as - dw.t);
		var yScaleFactor = ga.dD / (dw.at - dw.E);
		var rescaledData = A2(
			$elm$core$List$map,
			function (_v1) {
				var x = _v1.a;
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					$elm$core$String$fromFloat(ga.dE + 50)),
					$elm$svg$Svg$Attributes$viewBox(
					'0 0' + ($elm$core$String$fromFloat(ga.dE + 50) + (' ' + $elm$core$String$fromFloat(ga.dD + 50))))
				]),
			_List_fromArray(
				[
...
var $author$project$Widget$Data$scatterplot = F5(
	function (renderArgs, name, args, body, sm) {
		...
		var scatterPlotAttributes = {dD: graphHeight, dE: graphWidth, hn: options};
		return A2(
			$mdgriffith$elm_ui$Element$column,
			_List_Nil,
			_List_fromArray(
...
var $author$project$Render$Elm$renderTocItem = function (tocItem) {
	return A2(
		...
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$Font$color($author$project$Render$Elm$linkColor),
				$author$project$Render$Elm$tocPadding(tocItem.eI)
			]),
		{
			aT: $mdgriffith$elm_ui$Element$text(tocItem.aT + (' ' + tocItem.c_)),
			dh: '#' + $author$project$Render$Utility$slug(tocItem.c_)
		});
};
		...
		return A2(
			...
			A2(
				...
				A2(
					...
					$elm$core$List$reverse(renderArgs.ht.bR))));
	});
	...
	function (renderArgs, name, args, body, meta) {
		...
		if (_v1.$ === 1) {
			if (A2($elm$core$List$member, name, $author$project$Render$Elm$theoremLikeElements)) {
				...
				var _v2 = A2($elm$core$Dict$get, name, renderArgs.ht.cV);
				if (!_v2.$) {
					var macroForm = _v2.a;
					return A2(
...
var $author$project$Parser$Data$defaultConfig = {ea: '#00c', ex: '#fAA', e8: '#a00'};
var $author$project$Vector$init = function (k) {
	return {
		dr: A2($elm$core$List$repeat, k, 0),
		bM: k
	};
};
...
var $author$project$Parser$Metadata$dummy = {fN: 0, ca: 0, aT: '', g4: 0, aA: 0};
var $author$project$Parser$RecoveryData$problemWithElement = {
	...
	hr: A4(
		...
		A2(
			...
			$elm$core$Maybe$Nothing),
		$elm$core$Maybe$Nothing),
	hB: $author$project$Parser$Error$ExpectingRightBracket,
	ig: 1
};
		...
		return A2(
			...
			function (r) {
				return _Utils_update(
					r,
					{
						hr: A2($author$project$Parser$RecoveryData$setSourceMap, newSourceMap, r.hr)
					});
			},
...
var $author$project$Parser$Driver$handleLeftBracketError = F4(
	function (tc_, mFirstError, errorColumn, mRecoveryData) {
		var textLines = $elm$core$String$lines(tc_.h3);
		var name = A2(
			$elm$core$Maybe$withDefault,
			'NAME',
			$elm$core$List$head(
				$elm$core$String$words(
					A3($elm$core$String$replace, '[', '', tc_.d9))));
		var replacementText = '[highlightRGB |255, 130, 130| missing right bracket in] [highlightRGB |186, 205, 255| ' + ($author$project$Parser$Driver$fakeLeftBracket + (' ' + (name + (' ' + (tc_.d9 + (' ' + ($author$project$Parser$Driver$fakeRightBracket + ']')))))));
		var errorRow = A2(
			$elm$core$Maybe$withDefault,
			0,
			A2(
		...
		return {
			...
			F: tc_.F,
			gh: tc_.gh,
			b8: {b2: newTextLines, cp: 3},
			ca: tc_.ca,
			aA: A3($author$project$Parser$Driver$newOffset, tc_, errorColumn, mRecoveryData),
			hq: $elm$core$Maybe$Nothing,
			dP: A2($elm$core$List$drop, 1, tc_.dP),
			a$: _List_Nil,
			h3: newText
		};
	});
...
var $author$project$Parser$Driver$handlePipeError = F4(
	function (tc_, mFirstError, errorColumn, mRecoveryData) {
		...
		return {
			...
			F: tc_.F,
			gh: tc_.gh,
			b8: {b2: newTextLines, cp: 1},
			ca: tc_.ca,
			aA: A3($author$project$Parser$Driver$newOffset, tc_, errorColumn, mRecoveryData),
			hq: $elm$core$Maybe$Nothing,
			dP: $author$project$Parser$Driver$parse__(
...
var $author$project$Parser$Driver$makeNewText = F3(
	function (tc_, errorColumn_, mRecoveryData) {
		if (!mRecoveryData.$) {
			...
			return A2($elm$core$String$dropLeft, rd.ig, tc_.h3);
		} else {
			return A2($elm$core$String$dropLeft, errorColumn_, tc_.h3);
		}
	});
var $author$project$Parser$Driver$newParsed = F3(
	function (tc_, lxError_, mRecoveryData) {
		if (!mRecoveryData.$) {
			var rd = mRecoveryData.a;
			return A2($elm$core$List$cons, rd.hr, tc_.dP);
		} else {
			return A2($elm$core$List$cons, lxError_, tc_.dP);
		}
	});
var $author$project$Parser$Driver$newStack = F3(
	function (tc_, errorText_, mRecoveryData) {
		if (!mRecoveryData.$) {
			return _Utils_eq(
				$elm$core$List$head(tc_.a$),
				$elm$core$Maybe$Just('highlight')) ? tc_.a$ : A2($elm$core$List$cons, 'highlight', tc_.a$);
		} else {
			return A2(
				$elm$core$List$cons,
				errorText_,
				A2($elm$core$List$cons, 'highlight', tc_.a$));
		}
	});
var $author$project$Parser$Driver$unhandledError = F6(
	function (tc_, mFirstError, errorColumn, mRecoveryData, lxError, errorText) {
		return {
			...
			F: tc_.F,
			gh: tc_.gh,
			b8: {b2: _List_Nil, cp: 4},
			ca: tc_.ca,
			aA: A3($author$project$Parser$Driver$newOffset, tc_, errorColumn, mRecoveryData),
			hq: $elm$core$Maybe$Nothing,
			dP: A3($author$project$Parser$Driver$newParsed, tc_, lxError, mRecoveryData),
			a$: A3($author$project$Parser$Driver$newStack, tc_, errorText, mRecoveryData),
			h3: A3($author$project$Parser$Driver$makeNewText, tc_, errorColumn, mRecoveryData)
		};
	});
	...
	function (tc_, e) {
		...
		var errorColumn = A2(
			...
			A2(
				...
				mFirstError));
		var errorText = A2($elm$core$String$left, errorColumn, tc_.h3);
		var lxError = A4(
			$author$project$Parser$Element$Element,
			'Error',
			_List_Nil,
			...
			$elm$core$Maybe$Just(
				{fN: tc_.aJ, ca: tc_.ca, aT: '', g4: errorColumn, aA: tc_.aA + errorColumn}));
		switch (problem.$) {
			case 2:
...
var $author$project$Parser$Driver$packet = {
	gF: $author$project$Parser$Getters$getSource,
	gH: $elm$core$Maybe$Just($author$project$Parser$Driver$handleError),
	gK: $elm$core$Maybe$Nothing,
	gR: $author$project$Parser$Driver$incrementOffset,
	hs: $author$project$Parser$Element$parser
};
...
var $author$project$Parser$Data$sectionLabel = function (data) {
	return A2(
		...
		A2(
			...
			A2($elm$core$Dict$get, 'section', data.cx)));
};
...
var $author$project$Parser$Loop$newExpr = F3(
	function (packet, tc_, expr) {
		var _v0 = $elm$core$List$head(tc_.a$);
		if ((!_v0.$) && (_v0.a === 'highlight')) {
			var _v1 = packet.gK;
			if (_v1.$ === 1) {
				return A2(packet.gR, tc_.aA, expr);
			} else {
				var hl = _v1.a;
				return A2(
					packet.gR,
...
var $author$project$Parser$Data$handleMacro = F3(
	function (str, element, data) {
		return _Utils_update(
			data,
			{
				cV: A3($author$project$Parser$Data$handleMacro_, str, element, data.cV)
			});
	});
...
var $author$project$Vector$get = F2(
	function (k, v) {
		return A2(
			$elm$core$Maybe$withDefault,
			0,
			A2($elm_community$list_extra$List$Extra$getAt, k, v.dr));
	});
var $author$project$Vector$resetFrom = F2(
	function (k, v) {
		var suffix = A2($elm$core$List$repeat, v.bM - k, 0);
		var prefix = A2($elm$core$List$take, k, v.dr);
		return {
			dr: _Utils_ap(prefix, suffix),
			bM: v.bM
		};
	});
...
var $author$project$Vector$set = F3(
	function (k, a, v) {
		return _Utils_update(
			v,
			{
				dr: A3($elm_community$list_extra$List$Extra$setAt, k, a, v.dr)
			});
	});
var $author$project$Vector$increment = F2(
	function (k, v) {
		return ((k < 0) || (_Utils_cmp(k, v.bM) > -1)) ? v : A2(
...
var $author$project$Parser$Data$handleSection = F3(
	function (name, element, data) {
		...
		if (level_.$ === 1) {
			...
			var newVectorCounters = A3($elm$core$Dict$update, 'section', maybeInc, data.cx);
			var newData = _Utils_update(
				data,
				{cx: newVectorCounters});
			var tocItem = {
				aT: $author$project$Parser$Data$sectionLabel(newData),
				eI: level - 1,
				c_: $author$project$Parser$Data$getText(element)
			};
			return _Utils_update(
				newData,
				{
					bR: A2($elm$core$List$cons, tocItem, data.bR)
				});
		}
	});
		...
		if ((tc.h3 === '') || (tc.F > 100)) {
			return $author$project$Parser$Tool$Done(
				_Utils_update(
					tc,
					{
						dP: $elm$core$List$reverse(tc.dP)
					}));
		} else {
			var _v0 = A2(
				$elm$parser$Parser$Advanced$run,
				A2(packet.hs, tc.ca, tc.aJ),
				tc.h3);
			if (!_v0.$) {
				var expr = _v0.a;
				...
				return $author$project$Parser$Tool$Loop(
					_Utils_update(
						tc,
						{
							d9: _Utils_ap(
								tc.d9,
								A2($elm$core$String$left, sourceMapLength, tc.h3)),
							F: tc.F + 1,
							gh: data,
							aA: tc.aA + sourceMapLength,
							hq: $elm$core$Maybe$Just(parsand),
							dP: A2(
								$elm$core$List$cons,
								A2($author$project$Parser$Data$labelElement, data, parsand),
								tc.dP),
							h3: A2($elm$core$String$dropLeft, sourceMapLength, tc.h3)
						}));
			} else {
				var e = _v0.a;
				var _v1 = packet.gH;
...
var $author$project$Parser$Document$pushBlock_ = F2(
	function (line, state) {
		...
		var tc = A4($author$project$Parser$Driver$parseLoop, state.ca, state.ay, state.gh, str);
		return _Utils_update(
			state,
			{
				o: _List_Nil,
				...
				ay: state.ay + $author$project$Parser$Document$countLines(state.o),
				M: A2($elm$core$List$cons, tc, state.M)
			});
	});
var $author$project$Parser$Document$addToBlockContents = F2(
	function (currentLine_, state) {
		...
		var newBlockLevel = A2($elm$core$Basics$max, 0, state.y + deltaBlockLevel);
...
var $elm$parser$Parser$DeadEnd = F3(
	function (row, col, problem) {
		return {f5: col, hB: problem, dU: row};
	});
var $elm$parser$Parser$problemToDeadEnd = function (p) {
	return A3($elm$parser$Parser$DeadEnd, p.dU, p.f5, p.hB);
};
...
var $author$project$Parser$Document$flush = function (state) {
	...
	var newState = function () {
		if (input === '') {
			...
			var tc_ = A4($author$project$Parser$Driver$parseLoop, state.ca, state.ay, state.gh, input);
	...
	if ($author$project$Parser$Document$noError(newState)) {
		...
		if ((!_v0.$) && (_v0.a === 2)) {
			...
			var correctedState = _Utils_update(
				state,
				{o: _List_Nil, y: 0, T: 0, ao: correctedText});
...
var $author$project$Parser$Document$handleError = function (state) {
	if (_Utils_eq(state.ao, _List_Nil)) {
...
var $author$project$Parser$Document$popBlockStack = F2(
	function (currentLine_, state) {
		var newBlockLevel = A2(
			$elm$core$Basics$max,
			0,
			state.y + $author$project$Parser$Document$differentialBlockLevel(currentLine_));
		if (!newBlockLevel) {
			var input_ = A2(
				$elm$core$String$join,
				'\n',
			...
			var tc_ = A4($author$project$Parser$Driver$parseLoop, state.ca, state.ay, state.gh, input_);
			var tc = _Utils_update(
				tc_,
				{h3: input_});
			return _Utils_update(
				state,
				{
					...
					gh: $author$project$Parser$Document$updateData(tc),
					Q: $elm$core$Maybe$Just(tc),
					ay: state.ay + (2 + $elm$core$List$length(state.o)),
					M: A2($elm$core$List$cons, tc, state.M)
				});
		} else {
			return _Utils_update(
...
var $author$project$Main$outputDisplay_ = function (model) {
	return A2(
		...
		(model.cZ === 1) ? _List_fromArray(
			[
				A2($author$project$Main$render, model.F, model.ao)
			]) : A2(
			$elm$core$List$map,
			$mdgriffith$elm_ui$Element$text,
			A2($folkertdev$elm_paragraph$Paragraph$lines, $author$project$Main$paragraphFormat, model.aY)));
};
			...
			[
				...
				_List_fromArray(
					[
						...
						$mdgriffith$elm_ui$Element$text(
						'generation: ' + $elm$core$String$fromInt(model.F)),
...
var $author$project$Main$noFocus = {fJ: $elm$core$Maybe$Nothing, fR: $elm$core$Maybe$Nothing, hO: $elm$core$Maybe$Nothing};
...
var $author$project$Main$main = $elm$browser$Browser$element(
	{gS: $author$project$Main$init, h0: $author$project$Main$subscriptions, iq: $author$project$Main$update, ir: $author$project$Main$view});
